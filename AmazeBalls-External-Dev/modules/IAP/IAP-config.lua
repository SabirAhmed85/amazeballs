...
local IAPToolItemsScript = require("modules.IAP.IAP-tools-item-data")
local IAPToolsItemArray = IAPToolItemsScript.IAPToolItemsArray
t.IAPToolsItemArray = IAPToolsItemArray

local IAPShapeItemsScript = require("modules.IAP.IAP-shapes-item-data")
...
local IAPFunctionsScript = require("modules.IAP.IAP-functions")
