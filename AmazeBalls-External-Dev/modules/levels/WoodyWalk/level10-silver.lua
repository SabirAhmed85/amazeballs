...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle3_1_1", "slide", {}, {{1,1,3,2},{1,1,3,3}})
    ...
    newTransition("simple1_2_1", "slide", {}, {{2,1,1,1},{2,1,1,4},{2,1,1,5}})

    newShape("shape", "triangle2_2_1", {2, 1, 3, 5}, "triangleTopLeftShape", {1, 15})

    newShape("simple", "simple2_2_1", {2, 1, 5, 5})
    newTransition("simple2_2_1", "slide", {}, {{2,1,5,4},{2,1,5,5}})
