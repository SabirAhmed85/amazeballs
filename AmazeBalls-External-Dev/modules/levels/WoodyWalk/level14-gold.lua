...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("simple1_1_1", "slide", {"lightBlue"}, {{1,1,5,1},{1,1,5,4}})
    newShape("shape","triangle1_1_1", {1, 1, 2, 2}, "triangleBottomRightShape")
    newTransition("triangle1_1_1", "slide", {"green"}, {{1,1,2,2},{1,1,2,1,"*"},{1,1,4,1}})
    ...
    newTransition("simple2_1_1", "slide", {"lightBlue"}, {{1,1,4,2},{1,1,4,3},{1,1,4,4}})
    newShape("shape","bar2_1_1", {1, 1, 1, 4}, "bar", {"horz", 4})
    newShape("shape","triangle3_1_1", {1, 1, 1, 5}, "triangleTopRightShape", {1, 1})
    newTransition("triangle3_1_1", "slide", {"green"}, {{1,1,1,5},{1,1,2,5},{1,1,7,1}})
