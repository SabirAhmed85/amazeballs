...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("simple1_1_1", "slide", {"lightBlue"}, {{1,1,4,2},{1,1,5,2},{1,1,5,1},{1,1,6,3}})
    ...
    newTransition("simple2_1_1", "slide", {"lightBlue"}, {{1,1,3,5},{1,1,7,4},{1,1,7,2}})
    ...
    newTransition("simple1_1_2", "slide", {"lightBlue"}, {{1,2,3,2},{1,2,3,3}})
