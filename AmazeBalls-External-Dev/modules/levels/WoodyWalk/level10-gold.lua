...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 3, 3, "triangleTopRightShape"})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle2_1_2", 1, 2, 4, 1, "triangleBottomLeftShape"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 1, 2, 5, 1, "triangleBottomRightShape"})
    table.insert(shapeArrayParameters,{"door","door1_1_2", 1, 2, 6, 1, "up"})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_2", 1, 2, 7, 1, "triangleBottomLeftShape"})
    table.insert(shapeArrayParameters,{"item","map", 1, 2, 1, 2})
    table.insert(shapeArrayParameters,{"simple","simple1_1_2", 1, 2, 1, 3})
    ...
    table.insert(shapeArrayParameters,{"shape","bar2_1_2", 1, 2, 2, 3, "bar", "vert", 4})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar2_1_2"},{"slide"},{"brown"},{1},{1},{1,2,2,3},{2},{1,2,4,3}})
    table.insert(shapeArrayParameters,{"item","map", 1, 2, 4, 3})
    table.insert(shapeArrayParameters,{"shape","bar3_1_2", 1, 2, 5, 4, "bar", "vert", 2})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle7_1_2", 1, 2, 6, 4, "triangleTopLeftShape"})
    table.insert(shapeArrayParameters,{"shape","triangle8_1_2", 1, 2, 4, 5, "triangleTopRightShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle9_1_2", 1, 2, 5, 5, "triangleTopLeftShape"})
    table.insert(shapeArrayParameters,{"door","door2_1_2", 1, 2, 7, 5, "down"})

    --SCREEN 1-3
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_1_3", 1, 3, 1, 3} )
    table.insert(shapeArrayParameters,{"shape","bar1_1_3", 1, 3, 2, 3, "bar", "horz", 3})
    table.insert(shapeArrayParameters,{"shape","bar2_1_3", 1, 3, 6, 3, "bar", "horz", 3})
    ...
    table.insert(shapeArrayParameters,{"shape","bar3_1_3", 1, 3, 3, 4, "bar", "horz"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar3_1_3"},{"slide"},{"brown"},{2},{1},{1,3,3,3},{2},{1,3,3,4}})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_3", 1, 3, 7, 3, "triangleTopLeftShape"})
    ...
    table.insert(shapeArrayParameters,{"gem","redCoin", 1, 2, 7, 5, "redCoin"})
    table.insert(shapeArrayParameters,{"gem","blueCoin", 1, 2, 3, 4, "blueCoin"})
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 1, 1, 3, 4, "purpleCoin"})

    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 1, 3, 375}) 
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 7, 3, 55}) 
    table.insert(shapeArrayParameters,{"item","coins", 1, 3, 2, 3, 140}) 
    table.insert(shapeArrayParameters,{"item", "small-present", 1, 1, 6, 1, "present1_6_1", {
		{"item","clock", _, _, _, _, _, 5, 1},
		{"item","clock", _, _, _, _, _, 5, 1}
	} })
	table.insert(shapeArrayParameters,  {"item","big-present", 1, 2, 6, 2, "present2_6_2", { 
        {"triangle", "triangleTopRightShape"},
		{"triangle", "triangleTopLeftShape"},
