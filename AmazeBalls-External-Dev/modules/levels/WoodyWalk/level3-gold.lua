...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle1_1_1"},{"slide"},{"green"},{1},{1},{1,1,1,2},{2},{1,1,3,2}})
    addToShapeArray(sp, "shape","triangle2_1_1", {1, 1, 2, 3}, "triangleTopAndBottomShape", {1})
    addToTransitionArray(ta,{{"triangle2_1_1"},{"slide"},{"green"},{1},{1},{1,1,2,3},{2},{1,1,4,3}})
    addToShapeArray(sp, "door","door1_1_1", {1, 1, 7, 2}, "right")

    -- SCREEN 2-1
    addToShapeArray(sp, "shape","triangle1_2_1", {2, 1, 3, 1}, "triangleBottomLeftShape")
    addToTransitionArray(ta,{{"triangle1_2_1"},{"slide"},{"green"},{2},{1},{2,1,2,2},{2},{2,1,3,1}})
    addToShapeArray(sp, "shape","triangle2_2_1", {2, 1, 6, 1}, "triangleTopRightShape")
    addToTransitionArray(ta,{{"triangle2_2_1"},{"slide"},{"green"},{2},{1},{2,1,5,3},{2},{2,1,6,1}})
    ...
    addToTransitionArray(ta,{{"triangle3_2_1"},{"slide"},{"green"},{2},{1},{2,1,2,4},{2},{2,1,3,5}})
    addToShapeArray(sp, "shape","triangle4_2_1", {2, 1, 6, 5}, "triangleBottomLeftShape")
    addToTransitionArray(ta,{{"triangle4_2_1"},{"slide"},{"green"},{2},{1},{2,1,5,4},{2},{2,1,6,5}})
