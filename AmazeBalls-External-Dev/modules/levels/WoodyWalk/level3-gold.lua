...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 2, 3, "triangleTopAndBottomShape", 1})
    ...
    -- SCREEN 2-1
    table.insert(shapeArrayParameters,{"shape","triangle1_2_1", 2, 1, 3, 1, "triangleBottomLeftShape"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_2_1"},{"slide"},{"green"},{2},{1},{2,1,2,2},{2},{2,1,3,1}})
    table.insert(shapeArrayParameters,{"shape","triangle2_2_1", 2, 1, 6, 1, "triangleTopRightShape"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle2_2_1"},{"slide"},{"green"},{2},{1},{2,1,5,3},{2},{2,1,6,1}})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_2_1", 2, 1, 7, 1, "down"} )
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_2_1", 2, 1, 7, 3} )
    table.insert(shapeArrayParameters,{"shape","bar1_2_1", 2, 1, 8, 4, "bar", "horz", 4} )
    table.insert(shapeArrayParameters,{"shape","triangle3_2_1", 2, 1, 3, 5, "triangleTopRightShape"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle3_2_1"},{"slide"},{"green"},{2},{1},{2,1,2,4},{2},{2,1,3,5}})
    table.insert(shapeArrayParameters,{"shape","triangle4_2_1", 2, 1, 6, 5, "triangleBottomLeftShape"})
    ...
    table.insert(shapeArrayParameters,{"gem","blueCoin", 2, 1, 3, 3, "blueCoin"})
    ...
    table.insert(shapeArrayParameters,{"item","small-present", 1, 1, 7, 3, "present1_7_3", {} })
