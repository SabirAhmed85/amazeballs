...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle2_1_1", "slide", {"green"}, {{1,1,2,3},{1,1,4,3}})
    newShape("door","door1_1_1", {1, 1, 7, 2}, "right")

    -- SCREEN 2-1
    newShape("shape","triangle1_2_1", {2, 1, 3, 1}, "triangleBottomLeftShape")
    newTransition("triangle1_2_1", "slide", {"green"}, {{2,1,2,2},{2,1,3,1}})
    newShape("shape","triangle2_2_1", {2, 1, 6, 1}, "triangleTopRightShape")
    newTransition("triangle2_2_1", "slide", {"green"}, {{2,1,5,3},{2,1,6,1}})
    ...
    newTransition("triangle3_2_1", "slide", {"green"}, {{2,1,2,4},{2,1,3,5}})
    newShape("shape","triangle4_2_1", {2, 1, 6, 5}, "triangleBottomLeftShape")
    newTransition("triangle4_2_1", "slide", {"green"}, {{2,1,5,4},{2,1,6,5}})
