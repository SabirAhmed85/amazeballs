...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","bar1_1_1", {1, 1, 1, 6}, "bar", {"vert", 2}))
    table.insert(shapeArrayParameters, getShapeArray("door","door1_1_1", {1, 1, 2, 5, "down", "enabled"}))

    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan1_1_1", {1, 1, 3, 5}, "down"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_1_1", {1, 1, 6, 5}, "left"))

    table.insert(shapeArrayParameters, getShapeArray("shape","bar2_1_1", {1, 1, 3, 6}, "bar", {"vert"}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","bar2_1_2", {1, 2, 1, 3}, "bar", {"vert", 4}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle4_1_2", {1, 2, 2, 4}, "triangleTopRightShape", {1, _, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle5_1_2", {1, 2, 5, 4}, "triangleTopLeftShape", {1, _, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","bar3_1_2", {1, 2, 6, 5}, "bar", {"vert", 2}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar3_1_2"},{"slide"},{"brown"},{1},{1},{1,2,6,5},{2},{1,2,7,5}})
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle6_1_2", {1, 2, 1, 5}, "triangleTopRightShape", {1}))
    table.insert(shapeArrayParameters, getShapeArray("door","door1_1_2", {1, 2, 2, 5}, "down"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle7_1_2", {1, 2, 6, 5}, "triangleTopLeftShape", {1}))
    table.insert(shapeArrayParameters, getShapeArray("endPoint","endPoint1_1_2", {1, 2, 7, 5}))

    -- 1-3
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_1_3", {1, 3, 1, 1}, "triangleBottomLeftShape", {1, _, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_1_3", {1, 3, 3, 1}, "triangleBottomLeftShape", {1, 2, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("door","door1_1_3", {1, 3, 5, 1}, "up"))
    table.insert(shapeArrayParameters, getShapeArray("spitter","spitter1_1_3", {1, 3, 7, 1, "none", "right", "none"}, "left"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_1_3", {1, 3, 4, 2}, "triangleTopLeftShape", {1}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle4_1_3", {1, 3, 4, 3}, "triangleBottomRightShape", {1, 9, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan1_1_3", {1, 3, 3, 4}, "right"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle5_1_3", {1, 3, 6, 4}, "triangleBottomRightShape", {1, 14, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle6_1_3", {1, 3, 7, 4}, "triangleTopLeftShape", {1, _, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("backFire","backFire1_1_3", {1, 3, 4, 5}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"backFire1_1_3"},{"slide"},{"green"},{2},{1},{1,3,1,3},{"*"},{1,3,1,5},{2},{1,3,4,5}})
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle7_1_3", {1, 3, 5, 5}, "triangleTopLeftShape", {1, 6}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle7_1_3"},{"slide"},{"green"},{3},{1},{1,3,5,3},{2},{1,3,5,4},{3},{1,3,5,5}})
    table.insert(shapeArrayParameters, getShapeArray("shape","bar1_1_3", {1, 3, 7, 5}, "bar", {"horz"}))
