...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("simple1_1_1", "slide", {"lightBlue"}, {{1,1,1,1},{1,1,4,1},{1,1,7,1}})
    ...
    newTransition("simple2_1_1", "slide", {"lightBlue"}, {{1,1,2,4},{1,1,7,4},{1,1,7,3}})
    ...
    newTransition("simple1_1_2", "slide", {"lightBlue"}, {{1,2,2,2},{1,2,6,2}})
    newShape("shape","bar2_1_2", {1, 2, 1, 3}, "bar", {"vert", 4})
    newShape("backFire","backFire1_1_2", {1, 2, 3, 3})
    newTransition("backFire1_1_2", "slide", {"lightBlue"}, {{1,2,3,1},{1,2,3,3},{1,2,3,5}})
    ...
    newTransition("backFire1_1_3", "slide", {"green"}, {{1,3,1,3},{1,3,1,5,"*"},{1,3,4,5}})
    newShape("shape","triangle7_1_3", {1, 3, 5, 5}, "triangleTopLeftShape", {1, 6})
    newTransition("triangle7_1_3", "slide", {"green"}, {{1,3,5,3},{1,3,5,4},{1,3,5,5}})
