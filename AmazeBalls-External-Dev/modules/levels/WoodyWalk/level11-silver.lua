...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle1_1_1", "slide", {"green"}, {{1,1,3,1},{1,1,3,2}})

    newShape("shape","triangle2_1_1", {1, 1, 6, 1}, "triangleBottomRightShape", {1})
    newTransition("triangle2_1_1", "slide", {"green"}, {{1,1,5,2},{1,1,5,1},{1,1,6,1}})

    newShape("shape","triangle3_1_1", {1, 1, 3, 4}, "triangleTopLeftShape", {1, 11})
    newTransition("triangle3_1_1", "slide", {"green"}, {{1,1,3,3},{1,1,3,4},{1,1,3,5}})

    newShape("shape","triangle4_1_1", {1, 1, 5, 4}, "triangleTopLeftShape", {1})
    newTransition("triangle4_1_1", "slide", {"green"}, {{1,1,5,3},{1,1,5,4}})

    newShape("shape","triangle5_1_1", {1, 1, 7, 4}, "triangleTopLeftShape", {1})
    newTransition("triangle5_1_1", "slide", {"green"}, {{1,1,7,3},{1,1,7,4}})
    ...
    newTransition("simple1_2_1", "slide", {"lightBlue"}, {{2,1,2,1},{2,1,3,1},{2,1,5,1}})
    ...
    newTransition("simple2_2_1", "slide", {"lightBlue"}, {{2,1,1,4},{2,1,2,4},{2,1,4,4}})
