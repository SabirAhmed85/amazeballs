...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle1_1_1"},{"slide"},{"green"},{1},{1},{1,1,3,1},{2},{1,1,3,2}})

    addToShapeArray(sp, "shape","triangle2_1_1", {1, 1, 6, 1}, "triangleBottomRightShape", {1})
    addToTransitionArray(ta,{{"triangle2_1_1"},{"slide"},{"green"},{3},{1},{1,1,5,2},{2},{1,1,5,1},{3},{1,1,6,1}})

    addToShapeArray(sp, "shape","triangle3_1_1", {1, 1, 3, 4}, "triangleTopLeftShape", {1, 11})
    addToTransitionArray(ta,{{"triangle3_1_1"},{"slide"},{"green"},{2},{1},{1,1,3,3},{2},{1,1,3,4},{3},{1,1,3,5}})

    addToShapeArray(sp, "shape","triangle4_1_1", {1, 1, 5, 4}, "triangleTopLeftShape", {1})
    addToTransitionArray(ta,{{"triangle4_1_1"},{"slide"},{"green"},{2},{1},{1,1,5,3},{2},{1,1,5,4}})

    addToShapeArray(sp, "shape","triangle5_1_1", {1, 1, 7, 4}, "triangleTopLeftShape", {1})
    addToTransitionArray(ta,{{"triangle5_1_1"},{"slide"},{"green"},{2},{1},{1,1,7,3},{2},{1,1,7,4}})
    ...
    addToTransitionArray(ta,{{"simple1_2_1"},{"slide"},{"lightBlue"},{2},{1},{2,1,2,1},{2},{2,1,3,1},{3},{2,1,5,1}})
    ...
    addToTransitionArray(ta,{{"bar2_2_1"},{"slide"},{"brown"},{1},{1},{2,1,6,3},{2},{2,1,6,4}})
    ...
    addToTransitionArray(ta,{{"simple2_2_1"},{"slide"},{"lightBlue"},{3},{1},{2,1,1,4},{2},{2,1,2,4},{3},{2,1,4,4}})
