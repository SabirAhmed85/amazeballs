...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 5, 2, "triangleTopAndBottomShape", 1})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 3, 3, "triangleBottomRightShape", 1, 9})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle2_1_1"},{"slide"},{"green"},{3},{1},{1,1,1,1},{2},{1,1,2,1},{3},{1,1,3,3}})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_1", 1, 1, 7, 3, "triangleTopRightShape", 1})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle3_1_1"},{"slide"},{"green"},{2},{1},{1,1,6,1},{2},{1,1,7,3}})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_1", 1, 1, 5, 4, "triangleTopAndBottomShape", 2})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 1, 2, 5, 1, "triangleBottomRightShape"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_1_2"},{"slide"},{"green"},{2},{1},{1,2,4,2},{2},{1,2,5,1}})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_2", 1, 2, 2, 4, "triangleTopRightShape"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle2_1_2"},{"slide"},{"green"},{1},{1},{1,2,2,4},{2},{1,2,3,4},{3},{1,2,4,4}})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 1, 2, 6, 4, "triangleTopLeftShape", 1, 6})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle3_1_2"},{"slide"},{"green"},{3},{1},{1,2,1,2},{2},{1,2,3,3},{3},{1,2,6,4}})

    --SCREEN 2-1
    table.insert(shapeArrayParameters,{"shape","triangle1_2_1", 2, 1, 1, 1, "triangleBottomLeftShape"})
    table.insert(shapeArrayParameters,{"shape","triangle2_2_1", 2, 1, 6, 1, "triangleBottomRightShape"})
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_2_1", 2, 1, 1, 2})
    table.insert(shapeArrayParameters,{"shape","triangle3_2_1", 2, 1, 2, 2, "triangleBottomRightShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"shape","bar1_2_1", 2, 1, 7, 2, "bar", "vert", 3})
    table.insert(shapeArrayParameters,{"shape","triangle4_2_1", 2, 1, 2, 3, "triangleTopRightShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"shape","triangle5_2_1", 2, 1, 4, 3, "triangleBottomLeftShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"simple","simple1_2_1", 2, 1, 6, 3})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"simple1_2_1"},{"slide"},{"green"},{1},{1},{2,1,6,3},{2},{2,1,7,3}})
    table.insert(shapeArrayParameters,{"shape","bar2_2_1", 2, 1, 7, 3, "bar", "vert", 3})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar2_2_1"},{"slide"},{"green"},{2},{1},{2,1,6,3},{2},{2,1,7,3}})
    table.insert(shapeArrayParameters,{"shape","triangle6_2_1", 2, 1, 2, 4, "triangleBottomLeftShape"})
    table.insert(shapeArrayParameters,{"shape","triangle7_2_1", 2, 1, 6, 4, "triangleBottomRightShape"})
    table.insert(shapeArrayParameters,{"shape","triangle8_2_1", 2, 1, 7, 4, "triangleTopLeftShape"})
    table.insert(shapeArrayParameters,{"shape","triangle9_2_1", 2, 1, 2, 5, "triangleTopRightShape"})
    table.insert(shapeArrayParameters,{"simple","simple2_2_1", 2, 1, 3, 5})
    table.insert(shapeArrayParameters,{"shape","bar3_2_1", 2, 1, 5, 5, "bar", "horz", 2})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar3_2_1"},{"slide"},{"green"},{2},{1},{2,1,5,4},{2},{2,1,5,5}})
    table.insert(shapeArrayParameters,{"shape","triangle10_2_1", 2, 1, 6, 5, "triangleTopLeftShape"})

    --SWITCHES    
    table.insert(shapeArrayParameters,{"switch","switch1_1_2", 1, 2, 3, 1, { {"door-open","door1_1_1"} }, "one-way" })
    ...
    table.insert(shapeArrayParameters,{"gem","blueCoin", 2, 1, 7, 2, "blueCoin"})
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 2, 1, 3, 2, "purpleCoin"})

    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 2, 4, 95}) 
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 5, 1, 75})
    table.insert(shapeArrayParameters,{"item","coins", 2, 1, 4, 1, 300}) 
    table.insert(shapeArrayParameters,{"item","small-present", 1, 2, 7, 1, "present1_1_2", {} })
    table.insert(shapeArrayParameters,{"item","big-present", 2, 1, 3, 3, "present2_2_1", {} })
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 7, 4, 105}) 
