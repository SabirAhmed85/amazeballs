...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle2_1_1", "slide", {"green"}, {{1,1,1,1},{1,1,2,1},{1,1,3,3}})
    newShape("shape","triangle3_1_1", {1, 1, 7, 3}, "triangleTopRightShape", {1})
    newTransition("triangle3_1_1", "slide", {"green"}, {{1,1,6,1},{1,1,7,3}})
    ...
    newTransition("triangle1_1_2", "slide", {"green"}, {{1,2,4,2},{1,2,5,1}})
    newShape("shape","triangle2_1_2", {1, 2, 2, 4}, "triangleTopRightShape")
    newTransition("triangle2_1_2", "slide", {"green"}, {{1,2,2,4},{1,2,3,4},{1,2,4,4}})
    newShape("shape","triangle3_1_2", {1, 2, 6, 4}, "triangleTopLeftShape", {1, 6})
    newTransition("triangle3_1_2", "slide", {"green"}, {{1,2,1,2},{1,2,3,3},{1,2,6,4}})
    ...
    newTransition("simple1_2_1", "slide", {"green"}, {{2,1,6,3},{2,1,7,3}})
    newShape("shape","bar2_2_1", {2, 1, 7, 3}, "bar", {"vert", 3})
    newTransition("bar2_2_1", "slide", {"green"}, {{2,1,6,3},{2,1,7,3}})
    ...
    newTransition("bar3_2_1", "slide", {"green"}, {{2,1,5,4},{2,1,5,5}})
