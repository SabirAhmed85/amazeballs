...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle1_1_1"},{"slide"},{"green"},{1},{1},{1,1,1,2},{2},{1,1,2,1}})
    ...
    addToTransitionArray(ta,{{"simple1_1_1"},{"slide"},{"lightBlue"},{2},{1},{1,1,2,4},{2},{1,1,2,3},{3},{1,1,4,3}})

    addToShapeArray(sp, "backFire","backFire1_1_1", {1, 1, 5, 2})
    addToTransitionArray(ta,{{"backFire1_1_1"},{"slide"},{"lightDarkBlue"},{1},{1},{1,1,5,2},{2},{1,1,6,3}})
    ...
    addToTransitionArray(ta,{{"simple2_1_1"},{"slide"},{"lightBlue"},{1},{1},{1,1,4,4},{2},{1,1,5,4},{3},{1,1,7,4}})
    ...
    addToTransitionArray(ta,{{"triangle2_1_2"},{"slide"},{"green"},{1},{1},{1,2,2,2},{2},{1,2,2,3}})

    addToShapeArray(sp, "shape","triangle3_1_2", {1, 2, 7, 3}, "triangleBottomLeftShape", {1})
    addToTransitionArray(ta,{{"triangle3_1_2"},{"slide"},{"green"},{2},{1},{1,2,6,3},{2},{1,2,7,3}})

    addToShapeArray(sp, "shape","triangle4_1_2", {1, 2, 6, 5}, "triangleTopLeftShape", {1})
    addToTransitionArray(ta,{{"triangle4_1_2"},{"slide"},{"green"},{2},{1},{1,2,6,4},{2},{1,2,6,5}})
