...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle1_1_1", "slide", {"green"}, {{1,1,1,2},{1,1,2,1}})
    
    newShape("shape","triangle3_1_1", {1, 1, 4, 1}, "triangleBottomRightShape", {1, 14})

    newShape("simple","simple1_1_1", {1, 1, 2, 3})
    newTransition("simple1_1_1", "slide", {"lightBlue"}, {{1,1,2,4},{1,1,2,3},{1,1,4,3}})
    ...
    newTransition("simple2_1_1", "slide", {"lightBlue"}, {{1,1,4,4},{1,1,5,4},{1,1,7,4}})
    ...
    newTransition("triangle2_1_2", "slide", {"green"}, {{1,2,2,2},{1,2,2,3}})

    newShape("shape","triangle3_1_2", {1, 2, 7, 3}, "triangleBottomLeftShape", {1})
    newTransition("triangle3_1_2", "slide", {"green"}, {{1,2,6,3},{1,2,7,3}})

    newShape("shape","triangle4_1_2", {1, 2, 6, 5}, "triangleTopLeftShape", {1})
    newTransition("triangle4_1_2", "slide", {"green"}, {{1,2,6,4},{1,2,6,5}})
