...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters, getShapeArray("gem","purple2", 1, 1, 2, 5, "purple"} )

    table.insert(shapeArrayParameters, getShapeArray("gem","purpleCoin1", 1, 1, 5, 1, "purpleCoin"} )

    table.insert(shapeArrayParameters, getShapeArray("gem","blueCoin1", 1, 1, 4, 1, "blueCoin"} )
    
    table.insert(shapeArrayParameters, getShapeArray("gem","red", 1, 1, 3, 1, "red"} )
