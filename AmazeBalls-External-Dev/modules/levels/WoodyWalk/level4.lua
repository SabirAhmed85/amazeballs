...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --table.insert(shapeArrayParameters,{"tunnel","tunnel1", 1, 1, 7, 3, 7, 4, "right", "left"} )

    table.insert(shapeArrayParameters,{"item","mystery-block", 1, 1, 5, 2} )

    table.insert(shapeArrayParameters,{"item","fullMap", 1, 1, 3, 2} )

    table.insert(shapeArrayParameters,{"item","partialMap", 1, 1, 5, 2} )
    ...
    table.insert(shapeArrayParameters,{"item","hook-shot", 1, 1, 6, 1, "hookshot2_1_1", "down", 2, 3} )
    ...
    --table.insert(shapeArrayParameters,{"item","jet-pack", 1, 1, 7, 1, "jetpack1_1_1", "down", 3} )
    ...
    table.insert(shapeArrayParameters,{"gem","purple2", 1, 1, 2, 5, "purple"} )

    table.insert(shapeArrayParameters,{"gem","purpleCoin1", 1, 1, 5, 1, "purpleCoin"} )

    table.insert(shapeArrayParameters,{"gem","blueCoin1", 1, 1, 4, 1, "blueCoin"} )
    
    table.insert(shapeArrayParameters,{"gem","red", 1, 1, 3, 1, "red"} )
