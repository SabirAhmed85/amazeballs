...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("simple2_1_1", "slide", {"lightBlue"}, {{1,1,4,4},{1,1,4,5}})
    ...
    newTransition("simple2_2_1", "slide", {"lightBlue"}, {{2,1,4,2},{2,1,6,2}})

    newShape("shape","triangle1_2_1", {2, 1, 3, 3}, "triangleBottomRightShape", {1, _, "breakable"})

    newShape("simple","simple3_2_1", {2, 1, 5, 3})
    newTransition("simple3_2_1", "slide", {"lightBlue"}, {{2,1,5,3},{2,1,6,3},{2,1,7,3}})

    newShape("simple","simple4_2_1", {2, 1, 4, 4})
    newTransition("simple4_2_1", "slide", {"lightBlue"}, {{2,1,1,4},{2,1,2,4},{2,1,4,4}})
    ...
    newTransition("simple1_3_1", "slide", {"lightBlue"}, {{3,1,2,1},{3,1,2,3},{3,1,2,5}})
    ...
    newTransition("triangle9_4_1", "slide", {"green"}, {{4,1,5,4},{4,1,5,5}})
    ...
    newTransition("simple1_2_2", "slide", {"lightBlue"}, {{2,2,2,2},{2,2,2,1,"*"},{2,2,5,1}})
    ...
    newTransition("triangle6_2_2", "slide", {"green"}, {{2,2,5,4},{2,2,6,4}})
    ...
    newTransition("triangle8_3_2", "slide", {"green"}, {{3,2,6,3},{3,2,7,2}})
