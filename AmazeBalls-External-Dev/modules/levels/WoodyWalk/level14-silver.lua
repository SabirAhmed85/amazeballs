...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"item","small-present", 2, 2, 7, 2, {} })
    table.insert(shapeArrayParameters,{"item","big-present", 3, 2, 5, 3, {} })
    table.insert(shapeArrayParameters,{"item","big-present", 2, 2, 4, 3, {} })
    table.insert(shapeArrayParameters,{"item","big-present", 3, 1, 7, 4, {} })
