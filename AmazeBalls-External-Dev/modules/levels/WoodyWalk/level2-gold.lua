...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle1_1_1", "slide", {"green"}, {{1,1,2,1},{1,1,3,4}})
    newShape("shape","triangle2_1_1", {1, 1, 5, 4}, "triangleBottomLeftShape")
    newTransition("triangle2_1_1", "slide", {"green"}, {{1,1,5,4},{1,1,6,1}})
    newShape("shape","triangle3_1_1", {1, 1, 3, 5}, "triangleTopRightShape")
    newTransition("triangle3_1_1", "slide", {"green"}, {{1,1,3,5},{1,1,4,5}})
    newShape("shape","triangle4_1_1", {1, 1, 6, 5}, "triangleTopLeftShape")

    -- SCREEN 1-2
    newShape("shape","triangle1_1_2", {1, 2, 6, 1}, "triangleTopLeftShape")
    newTransition("triangle1_1_2", "slide", {"green"}, {{1,2,3,4},{1,2,3,3,"*"},{1,2,4,3},{1,2,4,2,"*"},{1,2,6,2},{1,2,6,1}})
    ...
    newTransition("triangle4_1_2", "slide", {"green"}, {{1,2,1,5},{1,2,2,5}})
    newShape("shape","triangle5_1_2", {1, 2, 6, 5}, "triangleBottomRightShape")
    newTransition("triangle5_1_2", "slide", {"green"}, {{1,2,3,5},{1,2,6,5}})
