...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
   ...
   --1-1
    ...
    newTransition("triangle1_1_1", "slide", {"green"}, {{1,1,1,1},{1,1,3,2},{1,1,4,3}})
    ...
    newTransition("simple1_1_1", "slide", {"green"}, {{1,1,2,2},{1,1,2,3},{1,1,2,5}})
    ...
    newTransition("simple1_1_2", "slide", {"lightBlue"}, {{1,2,4,3},{1,2,4,2},{1,2,6,2}})
