...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle2_1_1", "slide", {"green"}, {{1,1,5,2},{1,1,5,3}})
    ...
    newTransition("triangle4_1_1", "slide", {"green"}, {{1,1,2,3},{1,1,3,3}})
    ...
    newTransition("triangle1_1_2", "slide", {"green"}, {{1,2,4,2},{1,2,5,2},{1,2,6,2}})
    newShape("shape","triangle2_1_2", {1, 2, 2, 3}, "triangleTopAndBottomShape", {2})
    newTransition("triangle2_1_2", "slide", {"green"}, {{1,2,2,3},{1,2,4,3}})
    newShape("shape","triangle3_1_2", {1, 2, 1, 4}, "triangleTopAndBottomShape", {1})
    newTransition("triangle3_1_2", "slide", {"green"}, {{1,2,1,4},{1,2,2,4},{1,2,3,4}})
