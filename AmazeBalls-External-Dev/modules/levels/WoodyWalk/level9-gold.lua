...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle2_1_1"},{"slide"},{"green"},{1},{1},{1,1,5,2},{2},{1,1,5,3}})
    ...
    addToTransitionArray(ta,{{"triangle4_1_1"},{"slide"},{"green"},{2},{1},{1,1,2,3},{2},{1,1,3,3}})
    ...
    addToTransitionArray(ta,{{"triangle1_1_2"},{"slide"},{"green"},{1},{1},{1,2,4,2},{2},{1,2,5,2},{3},{1,2,6,2}})
    addToShapeArray(sp, "shape","triangle2_1_2", {1, 2, 2, 3}, "triangleTopAndBottomShape", {2})
    addToTransitionArray(ta,{{"triangle2_1_2"},{"slide"},{"green"},{1},{1},{1,2,2,3},{2},{1,2,4,3}})
    addToShapeArray(sp, "shape","triangle3_1_2", {1, 2, 1, 4}, "triangleTopAndBottomShape", {1})
    addToTransitionArray(ta,{{"triangle3_1_2"},{"slide"},{"green"},{1},{1},{1,2,1,4},{2},{1,2,2,4},{3},{1,2,3,4}})
