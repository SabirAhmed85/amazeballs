...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle1_1_1", "slide", {"green"}, {{1,1,1,1},{1,1,1,3}})
    ...
    newTransition("triangle3_1_1", "slide", {"green"}, {{1,1,5,3},{1,1,7,3},{1,1,6,4}})
    newShape("shape","triangle4_1_1", {1, 1, 4, 5}, "triangleTopAndBottomShape", {1})
    newTransition("triangle4_1_1", "slide", {"green"}, {{1,1,4,5},{1,1,5,5}})

    --SCREEN 2-1
    newShape("door","door1_2_1", {2, 1, 1, 1}, "left")
    newShape("shape","triangle1_2_1", {2, 1, 2, 1}, "triangleBottomLeftShape")
    newTransition("triangle1_2_1", "slide", {"green"}, {{2,1,1,1},{2,1,2,1}})
    newShape("shape","triangle2_2_1", {2, 1, 3, 1}, "triangleBottomRightShape")
    newTransition("triangle2_2_1", "slide", {"green"}, {{2,1,3,1},{2,1,4,2}})
    newShape("shape","triangle3_2_1", {2, 1, 3, 3}, "triangleTopRightShape")
    newTransition("triangle3_2_1", "slide", {"green"}, {{2,1,1,4},{2,1,2,3},{2,1,3,3}})
    newShape("shape","triangle4_2_1", {2, 1, 7, 5}, "triangleTopLeftShape")
    newTransition("triangle4_2_1", "slide", {"green"}, {{2,1,4,3},{2,1,4,4},{2,1,6,4},{2,1,7,5}})
