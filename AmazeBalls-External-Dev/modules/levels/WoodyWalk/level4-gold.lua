...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToShapeArray(sp, "gem","purpleCoin", {1, 1, 6, 4}, "purpleCoin")

    --ITEMS
    addToShapeArray(sp, "item","coins", {1, 1, 2, 1}, 85)
    addToShapeArray(sp, "item","coins", {1, 2, 2, 5}, 150)
    addToShapeArray(sp, "item","coins", {1, 2, 6, 5}, 50)
    addToShapeArray(sp, "item","small-present", {1, 1, 3, 4}, {})

    addToShapeArray(sp, "item","clock", {1, 1, 1, 3 })
    addToShapeArray(sp, "item","clock", {1, 2, 7, 1 })
