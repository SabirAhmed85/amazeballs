...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle1_1_1", "slide", {}, {{1,1,2,2},{1,1,3,2}})
    newShape("shape", "triangle2_1_1", {1, 1, 5, 2}, "triangleLeftAndRightShape", {2})
    newTransition("triangle2_1_1", "slide", {}, {{1,1,5,2},{1,1,6,2}})
    ...
    newTransition("triangle1_1_2", "slide", {}, {{1,2,1,4},{1,2,2,4}})
    newShape("shape", "triangle2_1_2", {1, 2, 6, 4}, "triangleTopAndBottomShape", {1})
    newTransition("triangle2_1_2", "slide", {}, {{1,2,5,4},{1,2,6,4}})
