...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 3, 2, "triangleLeftAndRightShape", 1})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_1_1"},{"slide"},{"green"},{2},{1},{1,1,2,2},{2},{1,1,3,2}})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 5, 2, "triangleLeftAndRightShape", 2})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 1, 2, 2, 4, "triangleTopAndBottomShape", 1})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_1_2"},{"slide"},{"green"},{2},{1},{1,2,1,4},{2},{1,2,2,4}})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_2", 1, 2, 6, 4, "triangleTopAndBottomShape", 1})
    ...
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 1, 1, 6, 4, "purpleCoin"})

    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 2, 1, 85})
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 2, 5, 150})
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 6, 5, 50})
    table.insert(shapeArrayParameters,{"item","small-present", 1, 1, 3, 4, "present1_1_1", {} })
    table.insert(shapeArrayParameters,{"item","clock", 1, 1, 1, 3 })
    table.insert(shapeArrayParameters,{"item","clock", 1, 2, 7, 1 })
