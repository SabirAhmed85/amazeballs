...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
	...
	-- 1-1
    table.insert(shapeArrayParameters,{"tunnel","tunnel1", 1, 1, 1, 1, 2, 1, 2, 1, "down"} )
    table.insert(shapeArrayParameters,{"shape","bar1_1_1", 1, 1, 2, 1, "bar", "horz"})
    ...
    table.insert(shapeArrayParameters,{"shape","bar2_1_1", 1, 1, 8, 1, "bar", "horz"})

    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 4, 3, "triangleTopRightShape", 1, _, "breakable"})

    table.insert(shapeArrayParameters,{"simple","simple2_1_1", 1, 1, 3, 4})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle3_1_1", 1, 1, 1, 5, "triangleTopRightShape"})

    table.insert(shapeArrayParameters,{"shape","triangle4_1_1", 1, 1, 4, 5, "triangleTopLeftShape", 1, _, "breakable"})

    -- 2-1
    table.insert(shapeArrayParameters,{"simple","simple1_2_1", 2, 1, 5, 1, "up"} )
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"simple1_2_1"},{"slide"},{"lightBlue"},{2},{1},{2,1,3,1},{2},{2,1,5,1}})
    table.insert(shapeArrayParameters,{"backFire","backFire1_2_1", 2, 1, 6, 2, "up"} )
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"backFire1_2_1"},{"slide"},{"lightDarkBlue"},{2},{1},{2,1,4,2},{2},{2,1,6,2}})
    table.insert(shapeArrayParameters,{"backFire","backFire2_2_1", 2, 1, 2, 3, "up"} )
    ...
    table.insert(shapeArrayParameters,{"simple","simple2_2_1", 2, 1, 5, 3, "up"} )
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"simple2_2_1"},{"slide"},{"lightBlue"},{1},{1},{2,1,5,3},{2},{2,1,7,3}})
    table.insert(shapeArrayParameters,{"shape","triangle1_2_1", 2, 1, 2, 4, "triangleBottomRightShape"})
    table.insert(shapeArrayParameters,{"door","door1_2_1", 2, 1, 1, 5, "left"} )
    table.insert(shapeArrayParameters,{"shape","triangle2_2_1", 2, 1, 2, 5, "triangleTopLeftShape"})
    table.insert(shapeArrayParameters,{"shape","bar1_2_1", 2, 1, 4, 5, "bar", "horz", 3})
    ...
    table.insert(shapeArrayParameters,{"gem","blueCoin", 1, 1, 1, 4, "blueCoin"})
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 2, 1, 4, 5, "purpleCoin"})

    --ITEMS   
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 3, 5, 350}) 
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 2, 1, 90}) 
    table.insert(shapeArrayParameters,{"item","clock", 1, 1, 3, 1, 2, 3 })    
    table.insert(shapeArrayParameters,{"item","small-present", 2, 1, 6, 4, "present1_2_1", {} })
end
