...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("simple2_1_1", "slide", {}, {{1,1,3,3},{1,1,3,4}})
    ...
    newTransition("simple2_2_1", "slide", {}, {{2,1,5,3},{2,1,7,3}})
    ...
    newTransition("triangle3_2_1", "slide", {}, {{2,1,4,4},{2,1,5,5},{2,1,6,5}})
