...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 2, 1, "triangleBottomLeftShape", 1})

    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 4, 2, "triangleBottomLeftShape", 1})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle4_1_1", 1, 1, 4, 3, "triangleTopRightShape", 1})

    table.insert(shapeArrayParameters,{"shape","triangle5_1_1", 1, 1, 3, 4, "triangleTopRightShape", 1})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle6_1_1", 1, 1, 6, 5, "triangleBottomLeftShape", 1})
