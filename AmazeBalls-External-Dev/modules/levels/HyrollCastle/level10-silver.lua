...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","bar2_1_1", {1, 1, 5, 1}, "bar", {"horz", 3}))
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan1_1_1", {1, 1, 5, 1}, "right"))
    table.insert(shapeArrayParameters, getShapeArray("shape","bar3_1_1", {1, 1, 6, 2}, "bar", {"vert"}))
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan2_1_1", {1, 1, 7, 1}, "down"))
    ...
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_1_1"},{"slide"},{},{1},{1},{1,1,1,2},{2},{1,1,2,2}})
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_1_1", {1, 1, 4, 2}, "triangleBottomLeftShape"))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle2_1_1"},{"slide"},{},{2},{1},{1,1,3,2},{2},{1,1,4,2}})
    table.insert(shapeArrayParameters, getShapeArray("shape","bar4_1_1", {1, 1, 5, 3}, "bar", {"horz", 4}))
    table.insert(shapeArrayParameters, getShapeArray("endPoint","endPoint1_1_1", {1, 1, 3, 4}))
    table.insert(shapeArrayParameters, getShapeArray("shape","bar5_1_1", {1, 1, 7, 4}, "bar", {"vert", 2}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_1_1", {1, 1, 2, 5}, "triangleTopLeftShape"))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle3_1_1"},{"slide"},{},{2},{1},{1,1,2,3},{2},{1,1,2,5}})
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_1_1", {1, 1, 5, 5}, "right"))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"autoFan1_1_1"},{"slide"},{},{1},{1},{1,1,5,5},{2},{1,1,5,2},{3},{1,1,7,3}})
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle4_1_1", {1, 1, 6, 5}, "triangleTopLeftShape", {1, _, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","bar6_1_1", {1, 1, 7, 5}, "bar", {"horz"}))
    table.insert(shapeArrayParameters, getShapeArray("backFire","backFire1_1_1", {1, 1, 7, 5}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_2_1", {2, 1, 2, 1}, "triangleTopRightShape", {1, 13}))
    table.insert(shapeArrayParameters, getShapeArray("simple","simple2_2_1", {2, 1, 4, 1}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"simple2_2_1"},{"slide"},{},{1},{1},{2,1,4,1},{2},{2,1,4,2}})
    ...
    --table.insert(shapeArrayParameters, getShapeArray("gem","redCoin", {2, 1, 3, 4}, "redCoin"))
    ...
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle2_2_1"},{"slide"},{},{1},{1},{2,1,3,5},{2},{2,1,5,5}})

    -- ALL SWITCHES
    table.insert(shapeArrayParameters, getShapeArray("switch","switch2_2_1", {2, 1, 3, 3}, { {"flip-vertical", "triangle1_2_1"} }))
    ...
    table.insert(shapeArrayParameters, getShapeArray("gem","blueCoin", {1, 1, 6, 4}, "blueCoin"))
    table.insert(shapeArrayParameters, getShapeArray("gem","purpleCoin", {1, 1, 4, 4}, "purpleCoin"))

    --ITEMS
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {2, 1, 2, 5}, 90))
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {2, 1, 5, 3}, 180))
    table.insert(shapeArrayParameters, getShapeArray("item","small-present", {2, 1, 2, 3}, {}))
