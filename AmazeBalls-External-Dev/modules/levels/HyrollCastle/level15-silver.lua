...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("bar1_2_1", "slide", {"orange"}, {{2,1,1,2},{2,1,3,2}})
    ...
    newTransition("bar2_2_1", "slide", {"orange"}, {{2,1,1,4},{2,1,4,5}})
    newShape("shape","bar3_2_1", {2, 1, 6, 4}, "bar", {"vert", 4})
    newTransition("bar3_2_1", "slide", {"orange"}, {{2,1,1,3},{2,1,6,4}})
