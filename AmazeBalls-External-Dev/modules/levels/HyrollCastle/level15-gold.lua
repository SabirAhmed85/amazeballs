...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle1_1_1"},{"switchSlide"},{},{1},{1},{1,2,4,2},{2},{1,2,4,3},{3},{1,2,4,4}})
    ...
    addToTransitionArray(ta,{{"autoFan2_1_1"},{"slide"},{},{2},{1},{1,2,3,2},{2},{1,2,3,3}})
    ...
    addToTransitionArray(ta,{{"triangle5_1_1"},{"switchSlide"},{},{1},{1},{1,2,4,5},{2},{1,2,6,5},{3},{1,2,7,5}})
    addToShapeArray(sp, "shape","bar3_1_2", {1, 2, 6, 6}, "bar", {"vert"})
    addToTransitionArray(ta,{{"bar3_1_1"},{"switchSlide"},{},{2},{1},{1,2,5,6},{2},{1,2,6,6}})
    ...
    addToTransitionArray(ta,{{"triangle5_2_1"},{"slide"},{},{1},{1},{2,2,2,3},{2},{2,2,3,3}})
    addToShapeArray(sp, "shape","triangle6_2_2", {2, 2, 6, 3}, "triangleBottomLeftShape")
    addToTransitionArray(ta,{{"triangle6_2_1"},{"slide"},{},{2},{1},{2,2,5,3},{2},{2,2,6,3}})
    ...
    addToTransitionArray(ta,{{"triangle8_2_1"},{"switchSlide"},{},{2},{1},{2,2,3,4},{2},{2,2,3,5}})
