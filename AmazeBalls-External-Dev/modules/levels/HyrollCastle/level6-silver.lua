...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle1_1_2", "slide", {"green"}, {{1,2,1,1},{1,2,1,3}})
    ...
    newTransition("triangle2_1_2", "slide", {"green"}, {{1,2,2,2},{1,2,3,2}})
    newShape("shape","triangle3_1_2", {1, 2, 5, 2}, "triangleBottomLeftShape", {1, 4})
    newTransition("triangle3_1_2", "slide", {"green"}, {{1,2,4,2},{1,2,5,2}})
    ...
    newTransition("simple1_1_2", "slide", {"lightBlue"}, {{1,2,2,4},{1,2,2,5}})
    ...
    newTransition("triangle5_1_2", "slide", {"green"}, {{1,2,3,4},{1,2,3,5}})
