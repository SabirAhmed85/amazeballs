...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle1_1_1"},{"slide"},{},{1},{1},{1,1,5,1},{2},{1,1,6,2}})
    addToShapeArray(sp, "shape","triangle2_1_1", {1, 1, 1, 2}, "triangleBottomRightShape")
    addToTransitionArray(ta,{{"triangle2_1_1"},{"slide"},{},{2},{1},{1,1,1,1},{2},{1,1,1,2}})
    ...
    addToTransitionArray(ta,{{"triangle3_1_1"},{"slide"},{},{2},{1},{1,1,1,3},{2},{1,1,1,4}})
    addToShapeArray(sp, "manualFan","manualFan1_1_1", {1, 1, 2, 4}, "up")
    addToTransitionArray(ta,{{"manualFan1_1_1"},{"slide"},{},{3},{1},{1,1,2,2},{2},{1,1,3,2},{3},{1,1,2,4}})
    ...
    addToTransitionArray(ta,{{"backFire1_1_1"},{"slide"},{},{1},{1},{1,1,3,5},{2},{1,1,5,5}})
    addToShapeArray(sp, "shape","triangle4_1_1", {1, 1, 7, 5}, "triangleTopLeftShape")
    addToTransitionArray(ta,{{"triangle4_1_1"},{"slide"},{},{3},{1},{1,1,4,3},{2},{1,1,7,3},{3},{1,1,7,5}})
    ...
    addToTransitionArray(ta,{{"autoFan1_1_2"},{"slide"},{},{1},{1},{1,2,7,1},{2},{1,2,7,2}})
    addToShapeArray(sp, "autoFan","autoFan2_1_2", {1, 2, 3, 2}, "right")
    addToTransitionArray(ta,{{"autoFan2_1_2"},{"slide"},{},{3},{1},{1,2,2,3},{2},{1,2,3,3},{3},{1,2,3,2}})
    addToShapeArray(sp, "shape","bar1_1_2", {1, 2, 6, 2}, "bar", {"horz", 2})
    addToShapeArray(sp, "backFire","backFire1_1_2", {1, 2, 1, 4})
    addToTransitionArray(ta,{{"backFire1_1_2"},{"slide"},{},{2},{1},{1,2,1,1},{2},{1,2,1,4}})
    addToShapeArray(sp, "shape","bar2_1_2", {1, 2, 4, 4}, "bar", {"horz", 2})
    addToShapeArray(sp, "backFire","backFire2_1_2", {1, 2, 6, 4})
    addToTransitionArray(ta,{{"backFire2_1_2"},{"slide"},{},{2},{1},{1,2,5,3},{2},{1,2,6,3},{3},{1,2,6,4},{4},{1,2,7,4}})
    addToShapeArray(sp, "backFire","backFire3_1_2", {1, 2, 4, 5})
    addToTransitionArray(ta,{{"backFire3_1_2"},{"slide"},{},{2},{1},{1,2,4,4},{2},{1,2,4,5}})
    addToShapeArray(sp, "shape","bar3_1_2", {1, 2, 6, 5}, "bar", {"horz", 2})
    addToShapeArray(sp, "manualFan","manualFan1_1_2", {1, 2, 6, 5}, "right")
    addToTransitionArray(ta,{{"manualFan1_1_2"},{"slide"},{},{1},{1},{1,2,6,5},{2},{1,2,7,5}})
    ...
    addToTransitionArray(ta,{{"autoFan1_2_2"},{"slide"},{},{1},{1},{2,2,2,5},{2},{2,2,3,5},{3},{2,2,4,5},{4},{2,2,5,5}})
