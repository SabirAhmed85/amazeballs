...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 5, 1, "triangleBottomLeftShape"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_1_1"},{"slide"},{},{1},{1},{1,1,5,1},{2},{1,1,6,2}})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 1, 2, "triangleBottomRightShape"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle2_1_1"},{"slide"},{},{2},{1},{1,1,1,1},{2},{1,1,1,2}})
    table.insert(shapeArrayParameters,{"shape","bar2_1_1", 1, 1, 2, 2, "bar", "horz", 3})
    table.insert(shapeArrayParameters,{"shape","bar3_1_1", 1, 1, 1, 3, "bar", "horz", 3})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_1", 1, 1, 1, 4, "triangleTopRightShape"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle3_1_1"},{"slide"},{},{2},{1},{1,1,1,3},{2},{1,1,1,4}})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_1", 1, 1, 2, 4, "up"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"manualFan1_1_1"},{"slide"},{},{3},{1},{1,1,2,2},{2},{1,1,3,2},{3},{1,1,2,4}})
    table.insert(shapeArrayParameters,{"shape","bar4_1_1", 1, 1, 3, 4, "bar", "horz", 2})
    table.insert(shapeArrayParameters,{"shape","bar5_1_1", 1, 1, 5, 4, "bar", "horz", 2})
    table.insert(shapeArrayParameters,{"door","door1_1_1", 1, 1, 2, 5, "down"})
    table.insert(shapeArrayParameters,{"backFire","backFire1_1_1", 1, 1, 3, 5})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"backFire1_1_1"},{"slide"},{},{1},{1},{1,1,3,5},{2},{1,1,5,5}})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_1", 1, 1, 7, 5, "triangleTopLeftShape"})
    ...
    table.insert(shapeArrayParameters,{"autoFan","autoFan2_1_2", 1, 2, 3, 2, "right"})
    ...
    table.insert(shapeArrayParameters,{"backFire","backFire1_1_2", 1, 2, 1, 4})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"backFire1_1_2"},{"slide"},{},{2},{1},{1,2,1,1},{2},{1,2,1,4}})
    table.insert(shapeArrayParameters,{"shape","bar2_1_2", 1, 2, 4, 4, "bar", "horz", 2})
    table.insert(shapeArrayParameters,{"backFire","backFire2_1_2", 1, 2, 6, 4})
    ...
    table.insert(shapeArrayParameters,{"backFire","backFire3_1_2", 1, 2, 4, 5})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"backFire3_1_2"},{"slide"},{},{2},{1},{1,2,4,4},{2},{1,2,4,5}})
    table.insert(shapeArrayParameters,{"shape","bar3_1_2", 1, 2, 6, 5, "bar", "horz", 2})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_2", 1, 2, 6, 5, "right"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"manualFan1_1_2"},{"slide"},{},{1},{1},{1,2,6,5},{2},{1,2,7,5}})
    table.insert(shapeArrayParameters,{"shape","bar4_1_2", 1, 2, 7, 5, "bar", "vert", 2})
    table.insert(shapeArrayParameters,{"door","door1_1_2", 1, 2, 7, 5, "right"})


    --SCREEN 2-2
    table.insert(shapeArrayParameters,{"shape","triangle1_2_2", 2, 2, 4, 1, "triangleBottomRightShape", 1, 9})
    table.insert(shapeArrayParameters,{"shape","bar1_2_2", 2, 2, 7, 1, "bar", "vert", 3})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_2_2", 2, 2, 7, 1, "left"})
    ...
    table.insert(shapeArrayParameters,{"manualFan","manualFan2_2_2", 2, 2, 7, 2, "down"})
    table.insert(shapeArrayParameters,{"shape","triangle3_2_2", 2, 2, 3, 3, "triangleBottomRightShape", 1, 9})
    table.insert(shapeArrayParameters,{"manualFan","manualFan3_2_2", 2, 2, 7, 3, "right"})
    table.insert(shapeArrayParameters,{"shape","triangle4_2_2", 2, 2, 5, 4, "triangleBottomRightShape"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan4_2_2", 2, 2, 7, 4, "up"})
    table.insert(shapeArrayParameters,{"backFire","backFire1_2_2", 2, 2, 1, 5})
    ...
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_2_2", 2, 2, 7, 5})
    ...
    table.insert(shapeArrayParameters,{"gem","blueCoin", 1, 2, 3, 5, "blueCoin"})
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 2, 2, 5, 3, "purpleCoin"})

    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 2, 2, 5, 1, 225})
    table.insert(shapeArrayParameters,{"item","coins", 2, 2, 2, 3, 145})
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 4, 1, 130})
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 7, 1, 80})
    table.insert(shapeArrayParameters,{"item","clock", 1, 2, 4, 2, "clock1_1_1", 10, 1})
    table.insert(shapeArrayParameters,{"item","big-present", 2, 2, 6, 4, {}})
    table.insert(shapeArrayParameters,{"item","small-present", 1, 1, 7, 2, {}})
    table.insert(shapeArrayParameters,{"item","small-present", 2, 2, 3, 2, {}})
