...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("autoFan2_1_1", "slide", {}, {{1,1,1,4},{1,1,2,4}})
    ...
    newTransition("simple1_2_1", "slide", {}, {{2,1,1,4},{2,1,1,5}})
    ...
    newTransition("autoFan2_2_1", "slide", {}, {{2,1,6,4},{2,1,7,3}})
    ...
    newTransition("triangle1_1_2", "slide", {}, {{1,2,1,4},{1,2,1,5}})
