...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"shape","bar2_1_1", 1, 1, 7, 1, "bar", "vert", 4})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 1, 2, "triangleBottomLeftShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 2, 2, "triangleBottomRightShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"simple","simple1_1_1", 1, 1, 3, 3, "right"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"simple1_1_1"},{"slide"},{},{1},{1},{1,1,3,3},{2},{1,1,4,3},{3},{1,1,5,3}})
    table.insert(shapeArrayParameters,{"shape","bar3_1_1", 1, 1, 3, 3, "bar", "vert", 2})
    table.insert(shapeArrayParameters,{"shape","bar4_1_1", 1, 1, 4, 3, "bar", "vert", 2})
    table.insert(shapeArrayParameters,{"shape","bar5_1_1", 1, 1, 5, 5, "bar", "vert", 2})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_1", 1, 1, 5, 5, "triangleBottomLeftShape"})

    --SCREEN 1-2
    table.insert(shapeArrayParameters,{"backFire","backFire1_1_2", 1, 2, 5, 1})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 1, 2, 2, 2, "triangleBottomRightShape"})
    ...
    table.insert(shapeArrayParameters,{"shape","bar2_1_2", 1, 2, 7, 2, "bar", "horz"})
    table.insert(shapeArrayParameters,{"shape","bar3_1_2", 1, 2, 4, 3, "bar", "vert", 2})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 1, 2, 4, 3, "triangleBottomLeftShape", 1, _, "breakable"})
    ...
    table.insert(shapeArrayParameters,{"shape","bar4_1_2", 1, 2, 7, 6, "bar", "vert", 2})

    --SWITCHES
    table.insert(shapeArrayParameters,{"switch","switch1_1_2", 1, 2, 4, 1, { {"slide", "bar1_1_2"} }, "one-way", "not-labelled" })
    ...
    table.insert(shapeArrayParameters,{"gem","redCoin", 1, 1, 5, 4, "redCoin"})
    table.insert(shapeArrayParameters,{"gem","blueCoin", 1, 2, 4, 2, "blueCoin"})
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 1, 1, 1, 1, "purpleCoin"})

    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 3, 5, 90})
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 4, 4, 150})
    table.insert(shapeArrayParameters,{"item","small-present", 1, 1, 1, 5, {} })
end
