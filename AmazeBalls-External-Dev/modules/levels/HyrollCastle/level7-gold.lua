...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle3_1_1"},{"slide"},{},{2},{1},{1,1,2,2},{2},{1,1,3,2}})
    addToShapeArray(sp, "item","compass", {1, 1, 4, 2})
    addToShapeArray(sp, "simple","simple1_1_1", {1, 1, 5, 2})
    addToTransitionArray(ta,{{"simple1_1_1"},{"slide"},{},{2},{1},{1,1,5,3},{2},{1,1,5,2},{3},{1,1,6,2}})
    ...
    addToTransitionArray(ta,{{"simple2_1_1"},{"slide"},{},{1},{1},{1,1,1,4},{2},{1,1,2,4}})
    addToShapeArray(sp, "autoFan","autoFan1_1_1", {1, 1, 3, 4}, "up")
    addToTransitionArray(ta,{{"autoFan1_1_1"},{"slide"},{},{1},{1},{1,1,3,4},{2},{1,1,3,5},{3},{1,1,4,5}})
    ...
    addToTransitionArray(ta,{{"backFire1_2_1"},{"slide"},{},{1},{1},{2,1,1,1},{2},{2,1,1,2}})
    ...
    addToTransitionArray(ta,{{"backFire2_2_1"},{"slide"},{},{1},{1},{2,1,7,2},{2},{2,1,7,4}})
    addToShapeArray(sp, "shape","bar2_2_1", {2, 1, 2, 3}, "bar", {"horz", 3})
    addToShapeArray(sp, "simple","simple1_2_1", {2, 1, 4, 3})
    addToTransitionArray(ta,{{"simple1_2_1"},{"slide"},{},{3},{1},{2,1,3,1},{2},{2,1,3,3},{3},{2,1,4,3}})
    ...
    addToTransitionArray(ta,{{"autoFan1_2_1"},{"slide"},{},{2},{1},{2,1,4,4},{2},{2,1,5,4},{3},{2,1,5,3}})
    ...
    addToTransitionArray(ta,{{"bar5_2_1"},{"slide"},{},{2},{1},{2,1,3,4},{2},{2,1,3,5}})
