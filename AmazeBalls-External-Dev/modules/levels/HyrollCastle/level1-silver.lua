...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("simple1_1_1", "slide", {}, {{1,1,1,1},{1,1,2,1},{1,1,5,1}})
    ...
    newTransition("autoFan2_1_1", "slide", {}, {{1,1,1,5},{1,1,3,5},{1,1,4,5},{1,1,5,5}})
    ...
    newTransition("simple1_1_2", "slide", {}, {{1,2,5,2},{1,2,5,3}})
    newShape("shape", "triangle1_1_2", {1, 2, 7, 3}, "triangleLeftAndRightShape", {2})
    newTransition("triangle1_1_2", "slide", {}, {{1,2,7,2},{1,2,7,3}})
