...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle1_1_1"},{"slide"},{"orange"},{1},{1},{1,1,3,2},{2},{1,1,4,2},{3},{1,1,5,2}})
    addToShapeArray(sp, "shape","triangle2_1_1", {1, 1, 2, 3}, "triangleTopAndBottomShape", {2})
    addToTransitionArray(ta,{{"triangle2_1_1"},{"slide"},{"orange"},{1},{1},{1,1,2,3},{2},{1,1,3,3},{3},{1,1,3,3}})
    addToShapeArray(sp, "shape","triangle3_1_1", {1, 1, 1, 5}, "triangleTopAndBottomShape", {1})
    addToTransitionArray(ta,{{"triangle3_1_1"},{"slide"},{"orange"},{1},{1},{1,1,1,5},{2},{1,1,2,5},{3},{1,1,3,5}})
