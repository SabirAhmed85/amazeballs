...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle1_1_1", "slide", {}, {{1,1,3,2},{1,1,4,2},{1,1,5,2}})
    newShape("shape", "triangle2_1_1", {1, 1, 2, 3}, "triangleTopAndBottomShape", {2})
    newTransition("triangle2_1_1", "slide", {}, {{1,1,2,3},{1,1,3,3},{1,1,3,3}})
    newShape("shape", "triangle3_1_1", {1, 1, 1, 5}, "triangleTopAndBottomShape", {1})
    newTransition("triangle3_1_1", "slide", {}, {{1,1,1,5},{1,1,2,5},{1,1,3,5}})
