...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_1", 1, 1, 6, 1, "up"})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle3_1_1", 1, 1, 2, 4, "triangleTopRightShape"})
    ...
    table.insert(shapeArrayParameters,{"shape","bar2_1_1", 1, 1, 3, 6, "bar", "vert", 2})

    --SCREEN 2-1
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_2_1", 2, 1, 1, 2})
    table.insert(shapeArrayParameters,{"shape","bar1_2_1", 2, 1, 3, 2, "bar", "vert", 2})
    table.insert(shapeArrayParameters,{"shape","bar2_2_1", 2, 1, 6, 2, "bar", "vert", 3})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_2_1", 2, 1, 2, 3, "down"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan2_2_1", 2, 1, 3, 3, "down"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan3_2_1", 2, 1, 4, 3, "up"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan4_2_1", 2, 1, 6, 3, "up"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"manualFan4_2_1"},{"slide"},{},{1},{1},{2,1,6,3},{2},{2,1,6,4}})
    table.insert(shapeArrayParameters,{"manualFan","manualFan5_2_1", 2, 1, 7, 3, "left"})
    ...
    table.insert(shapeArrayParameters,{"shape","bar3_2_1", 2, 1, 8, 3, "bar", "horz", 2})
    table.insert(shapeArrayParameters,{"shape","triangle1_2_1", 2, 1, 4, 4, "triangleTopLeftShape", 1, 6})
    ...
    --SWITCHES
    table.insert(shapeArrayParameters,{"switch","switch1_1_1", 1, 1, 3, 4, { {"slide", "autoFan2_1_1"} }, "one-way", "not-labelled" })
    ...
    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 6, 4, 80})
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 6, 2, 80})
    table.insert(shapeArrayParameters,{"item","coins", 2, 1, 3, 2, 120})
