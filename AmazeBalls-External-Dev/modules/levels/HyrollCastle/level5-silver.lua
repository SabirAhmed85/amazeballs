...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"gem","blueCoin", 1, 2, 1, 2, "blueCoin"})
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 1, 3, 1, 5, "purpleCoin"})

    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 2, 4, 70})
    table.insert(shapeArrayParameters,{"item","coins", 1, 3, 7, 1, 340})
    table.insert(shapeArrayParameters,{"item","bomb", 1, 3, 4, 2, "bomb2_1_1", {3, "right", "left", "up"}, 3})
    table.insert(shapeArrayParameters,{"item","clock", 1, 2, 1, 4, "clock1_1_1", 10, 1})
    table.insert(shapeArrayParameters,{"item","big-present", 1, 1, 3, 2, {}})
    table.insert(shapeArrayParameters,{"item","big-present", 1, 3, 3, 3, {}})
    table.insert(shapeArrayParameters,{"item","small-present", 1, 3, 6, 1, {}})
