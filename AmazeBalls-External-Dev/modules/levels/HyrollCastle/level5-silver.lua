...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle1_1_1", "slide", {"green"}, {{1,1,4,1},{1,1,7,2}})
    ...
    newTransition("triangle2_1_1", "slide", {"green"}, {{1,1,6,4},{1,1,7,4}})
    ...
    newTransition("simple1_1_2", "slide", {"green"}, {{1,2,2,1},{1,2,3,1},{1,2,3,2},{1,2,3,3}})
    newShape("characterChangePoint","characterChangePoint1_1_2", {1, 2, 4, 1})
    newShape("simple","simple2_1_2", {1, 2, 6, 1})
    newTransition("simple2_1_2", "slide", {"green"}, {{1,2,6,1},{1,2,6,3},{1,2,6,4}})
    ...
    newTransition("triangle3_1_2", "slide", {"green"}, {{1,2,5,3},{1,2,5,5,"*"},{1,2,6,5}})
    newShape("autoFan","autoFan2_1_2", {1, 2, 7, 3}, "right")
    newShape("shape","triangle4_1_2", {1, 2, 3, 4}, "triangleTopRightShape", {1, 1})
    newTransition("triangle4_1_2", "slide", {"green"}, {{1,2,1,5},{1,2,2,5},{1,2,3,4}})
    ...
    newTransition("simple1_1_3", "slide", {"lightBlue"}, {{1,3,4,3},{1,3,5,3}})
    ...
    newTransition("triangle4_1_3", "slide", {"green"}, {{1,3,2,5},{1,3,3,5},{1,3,4,5}})
