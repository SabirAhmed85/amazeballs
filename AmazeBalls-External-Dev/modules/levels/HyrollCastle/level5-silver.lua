...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"manualFan1_1_1"},{"slide"},{"silver"},{2},{1},{1,1,1,2},{2},{1,1,2,1}})
    ...
    addToTransitionArray(ta,{{"triangle1_1_1"},{"slide"},{"green"},{1},{1},{1,1,4,1},{2},{1,1,7,2}})
    addToShapeArray(sp, "manualFan","manualFan2_1_1", {1, 1, 4, 2}, "down")
    addToTransitionArray(ta,{{"manualFan2_1_1"},{"slide"},{"silver"},{1},{1},{1,1,4,2},{2},{1,1,5,3},{3},{1,1,4,4}})
    ...
    addToTransitionArray(ta,{{"triangle2_1_1"},{"slide"},{"green"},{1},{1},{1,1,6,4},{2},{1,1,7,4}})
    ...
    addToTransitionArray(ta,{{"simple1_1_2"},{"slide"},{"green"},{2},{1},{1,2,2,1},{2},{1,2,3,1},{3},{1,2,3,2},{4},{1,2,3,3}})
    addToShapeArray(sp, "characterChangePoint","characterChangePoint1_1_2", {1, 2, 4, 1})
    addToShapeArray(sp, "simple","simple2_1_2", {1, 2, 6, 1})
    addToTransitionArray(ta,{{"simple2_1_2"},{"slide"},{"green"},{1},{1},{1,2,6,1},{2},{1,2,6,3},{3},{1,2,6,4}})
    ...
    addToTransitionArray(ta,{{"triangle3_1_2"},{"slide"},{"green"},{1},{1},{1,2,5,3},{"*"},{1,2,5,5},{2},{1,2,6,5}})
    ...
    addToTransitionArray(ta,{{"triangle4_1_2"},{"slide"},{"green"},{3},{1},{1,2,1,5},{2},{1,2,2,5},{3},{1,2,3,4}})
    ...
    addToTransitionArray(ta,{{"simple1_1_3"},{"slide"},{"lightBlue"},{1},{1},{1,3,4,3},{2},{1,3,5,3}})
    ...
    addToTransitionArray(ta,{{"manualFan1_1_3"},{"slide"},{"silver"},{3},{1},{1,3,2,2},{2},{1,3,1,4},{3},{1,3,2,4}})
    ...
    addToTransitionArray(ta,{{"triangle4_1_3"},{"slide"},{"green"},{2},{1},{1,3,2,5},{2},{1,3,3,5},{3},{1,3,4,5}})
