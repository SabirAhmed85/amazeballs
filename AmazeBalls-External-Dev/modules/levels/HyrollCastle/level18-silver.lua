...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle4_1_1", {1, 1, 3, 4}, "triangleTopRightShape", {1, 10})
    ...
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {1, 2, 3, 3, 200})
