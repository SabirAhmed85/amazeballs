...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    local ta = mainFunc.allLevelSettings.transitionArrayIndex;    --SCREEN 1-1
    addToShapeArray(sp, "shape","triangle1_1_1", {1, 1, 7, 1}, "triangleBottomLeftShape")
    addToTransitionArray(ta,{{"triangle1_1_1"},{"slide"},{},{3},{1},{1,1,5,1},{2},{1,1,6,1},{3},{1,1,7,1}})
    ...
    addToTransitionArray(ta,{{"manualFan1_2_1"},{"slide"},{},{1},{1},{2,1,5,2},{2},{2,1,6,3}})
