...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle1_1_1"},{"slide"},{},{1},{1},{1,1,7,2},{2},{1,1,7,3}})
    addToShapeArray(sp, "autoFan","autoFan1_1_1", {1, 1, 3, 3}, "up")
    addToShapeArray(sp, "shape","bar1_1_1", {1, 1, 8, 3}, "bar", {"horz", 3})
    addToTransitionArray(ta,{{"bar1_1_1"},{"slide"},{},{1},{1},{1,1,8,3},{2},{1,1,8,5}})
    ...
    addToTransitionArray(ta,{{"triangle2_2_1"},{"slide"},{},{1},{1},{2,1,3,2},{2},{2,1,5,2},{3},{2,1,7,2}})
    ...
    addToTransitionArray(ta,{{"autoFan1_2_1"},{"slide"},{},{1},{1},{2,1,4,5},{2},{2,1,5,5}})
    addToShapeArray(sp, "shape","triangle4_2_1", {2, 1, 6, 5}, "triangleBottomRightShape", {1, 3})
    addToTransitionArray(ta,{{"triangle4_2_1"},{"slide"},{},{3},{1},{2,1,5,3},{2},{2,1,6,3},{3},{2,1,6,5}})
    ...
    addToTransitionArray(ta,{{"triangle2_1_2"},{"slide"},{},{1},{1},{1,2,5,3},{2},{1,2,5,4},{3},{1,2,5,5}})
    addToShapeArray(sp, "shape","triangle3_1_2", {1, 2, 1, 4}, "triangleTopRightShape")
    addToShapeArray(sp, "autoFan","autoFan2_1_2", {1, 2, 3, 4}, "left")
    addToTransitionArray(ta,{{"autoFan2_1_2"},{"slide"},{},{2},{1},{1,2,2,4},{2},{1,2,3,4}})
    addToShapeArray(sp, "simple","simple1_1_2", {1, 2, 6, 4})
    addToTransitionArray(ta,{{"simple1_1_2"},{"slide"},{},{3},{1},{1,2,6,1},{2},{1,2,6,2},{3},{1,2,6,4}})
    ...
    addToTransitionArray(ta,{{"triangle2_2_2"},{"slide"},{},{2},{1},{2,2,4,1},{2},{2,2,4,2}})
    ...
    addToTransitionArray(ta,{{"triangle5_2_2"},{"slide"},{},{1},{1},{2,2,4,4},{2},{2,2,4,5}})
