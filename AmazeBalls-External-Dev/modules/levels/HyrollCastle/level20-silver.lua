...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 3, 1, "triangleBottomLeftShape"})
    table.insert(shapeArrayParameters,{"shape","bar1_1_1", 1, 1, 6, 1, "bar", "horz"})
    table.insert(shapeArrayParameters,{"simple","simple1_1_1", 1, 1, 7, 1})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_1", 1, 1, 2, 2, "left"})
    ...
    table.insert(shapeArrayParameters,{"autoFan","autoFan2_1_1", 1, 1, 7, 2, "right"})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle3_1_1", 1, 1, 3, 4, "triangleTopRightShape"})
    table.insert(shapeArrayParameters,{"item","compass", 1, 1, 6, 4})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_1", 1, 1, 7, 4, "triangleTopLeftShape"})
    table.insert(shapeArrayParameters,{"shape","triangle5_1_1", 1, 1, 2, 5, "triangleTopLeftShape", 1, 6})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle6_1_1", 1, 1, 6, 5, "triangleTopLeftShape", 1, 11, "breakable"})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle1_2_1", 2, 1, 5, 1, "triangleTopAndBottomShape"})
    table.insert(shapeArrayParameters,{"shape","triangle2_2_1", 2, 1, 2, 2, "triangleBottomLeftShape"})
    ...
    table.insert(shapeArrayParameters,{"shape","bar2_2_1", 2, 1, 4, 2, "bar", "horz"})
    table.insert(shapeArrayParameters,{"simple","simple1_2_1", 2, 1, 5, 2})
    table.insert(shapeArrayParameters,{"shape","triangle3_2_1", 2, 1, 1, 3, "triangleTopLeftShape", 1, 11, "breakable"})
    table.insert(shapeArrayParameters,{"simple","simple1_2_1", 2, 1, 4, 3})
    table.insert(shapeArrayParameters,{"shape","triangle4_2_1", 2, 1, 5, 3, "triangleBottomLeftShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"door","door1_2_1", 2, 1, 1, 5, "left"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_2_1", 2, 1, 1, 5, "left"})
    table.insert(shapeArrayParameters,{"shape","triangle5_2_1", 2, 1, 2, 5, "triangleTopRightShape"})
    table.insert(shapeArrayParameters,{"shape","triangle6_2_1", 2, 1, 5, 5, "triangleTopLeftShape"})
    ...
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 2, 1, 6, 5, "purpleCoin"})

    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 2, 4, 150})
    table.insert(shapeArrayParameters,{"item","coins", 2, 1, 6, 3, 200})
