...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"backFire1_1_1"},{"slide"},{},{1},{1},{1,1,5,2},{2},{1,1,5,5}})
    ...
    addToTransitionArray(ta,{{"simple2_1_1"},{"slide"},{},{2},{1},{1,1,4,4},{2},{1,1,4,5}})
    ...
    addToTransitionArray(ta,{{"autoFan1_2_1"},{"slide"},{},{2},{1},{2,1,1,1},{2},{2,1,3,2}})
