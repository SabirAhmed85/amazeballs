...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle2_1_1"},{"slide"},{},{1},{1},{1,1,1,2},{2},{1,1,3,2}})
    ...
    addToTransitionArray(ta,{{"triangle4_2_1"},{"slide"},{},{2},{1},{2,1,3,3},{2},{2,1,4,3}})
    addToShapeArray(sp, "autoFan","autoFan1_2_1", {2, 1, 6, 3}, "down")
    addToTransitionArray(ta,{{"autoFan1_2_1"},{"slide"},{},{1},{1},{2,1,6,3},{2},{2,1,6,5}})
    ...
    addToTransitionArray(ta,{{"simple2_2_1"},{"slide"},{},{2},{1},{2,1,3,4},{2},{2,1,3,5},{3},{2,1,4,5}})
