...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --table.insert(shapeArrayParameters,{"gem","purpleCoin1", 1, 1, 2, 5, "purpleCoin"} )

    table.insert(shapeArrayParameters,{"gem","blueCoin1", 1, 1, 3, 1, "blueCoin"} )
    
    table.insert(shapeArrayParameters,{"gem","red", 1, 1, 5, 1, "redCoin"} )
