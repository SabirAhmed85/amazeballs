...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters,{"backFire","backFire1_1_1", 1, 1, 2, 1})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"backFire1_1_1"},{"slide"},{},{2},{1},{1,1,1,1},{2},{1,1,2,1},{3},{1,1,3,1}})
    table.insert(shapeArrayParameters,{"shape","bar1_1_1", 1, 1, 7, 1, "bar", "vert", 4})
    table.insert(shapeArrayParameters,{"backFire","backFire2_1_1", 1, 1, 7, 1})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"backFire2_1_1"},{"slide"},{},{2},{1},{1,1,5,1},{2},{1,1,7,1}})
    table.insert(shapeArrayParameters,{"shape","bar2_1_1", 1, 1, 6, 1, "bar", "vert", 2})
    ...
    table.insert(shapeArrayParameters,{"simple","simple2_1_1", 1, 1, 6, 4})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"simple2_1_1"},{"slide"},{},{2},{1},{1,1,3,4},{2},{1,1,6,4}})
    table.insert(shapeArrayParameters,{"shape","bar3_1_1", 1, 1, 6, 4, "bar", "vert", 4})
    table.insert(shapeArrayParameters,{"shape","bar4_1_1", 1, 1, 3, 5, "bar", "vert", 4})
    table.insert(shapeArrayParameters,{"door","door1_1_1", 1, 1, 1, 5, "down"})
    table.insert(shapeArrayParameters,{"backFire","backFire3_1_1", 1, 1, 4, 5})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"backFire3_1_1"},{"slide"},{},{2},{1},{1,1,3,5},{2},{1,1,4,5},{3},{1,1,6,5}})

    --SCREEN 1-2
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_2", 1, 2, 1, 1, "right"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan2_1_2", 1, 2, 2, 1, "down"})
    table.insert(shapeArrayParameters,{"shape","bar1_1_2", 1, 2, 6, 1, "bar", "vert", 4})
    ...
    table.insert(shapeArrayParameters,{"manualFan","manualFan2_1_2", 1, 2, 6, 2, "right"})
    table.insert(shapeArrayParameters,{"simple","simple1_1_2", 1, 2, 3, 3})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"simple1_1_2"},{"slide"},{},{2},{1},{1,2,2,3},{2},{1,2,3,3}})
    table.insert(shapeArrayParameters,{"manualFan","manualFan3_1_2", 1, 2, 6, 3, "right"})
    table.insert(shapeArrayParameters,{"shape","bar2_1_2", 1, 2, 2, 4, "bar", "vert", 4})
    table.insert(shapeArrayParameters,{"backFire","backFire1_1_2", 1, 2, 3, 4})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"backFire1_1_2"},{"slide"},{},{2},{1},{1,2,2,4},{2},{1,2,3,4}})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 1, 2, 4, 4, "triangleTopRightShape"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_1_2"},{"slide"},{},{3},{1},{1,2,2,5},{2},{1,2,4,5},{3},{1,2,4,4}})
    table.insert(shapeArrayParameters,{"autoFan","autoFan3_1_2", 1, 2, 6, 5, "up"})
    ...
    table.insert(shapeArrayParameters,{"gem","redCoin", 1, 1, 6, 2, "redCoin"})
    ...
    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 4, 1, 125})
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 3, 2, 75})
    table.insert(shapeArrayParameters,{"item","clock", 1, 1, 2, 4, "clock1_1_1", 10, 1})
