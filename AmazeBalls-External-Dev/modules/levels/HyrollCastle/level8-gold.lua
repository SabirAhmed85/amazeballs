...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"bar1_1_1"},{"autoSlide"},{timePerSquare = 480, pauseTime = 0, labelled = false},{1},{1},{1,1,7,3},{2},{1,1,7,5}})
    ...
    addToTransitionArray(ta,{{"autoFan2_2_1"},{"slide"},{},{1},{1},{2,1,4,2},{"*"},{2,1,4,3},{2},{2,1,5,3},{3},{2,1,5,4}})
    ...
    addToTransitionArray(ta,{{"triangle1_2_1"},{"slide"},{},{2},{1},{2,1,2,4},{2},{2,1,3,4},{3},{2,1,3,3}})
    addToShapeArray(sp, "autoFan","autoFan3_2_1", {2, 1, 4, 4}, "up")
    addToTransitionArray(ta,{{"autoFan3_2_1"},{"slide"},{},{1},{1},{2,1,4,4},{2},{2,1,4,5}})
    addToShapeArray(sp, "autoFan","autoFan4_2_1", {2, 1, 6, 4}, "up")
    addToTransitionArray(ta,{{"autoFan4_2_1"},{"slide"},{},{2},{1},{2,1,5,2},{2},{2,1,6,4}})
    addToShapeArray(sp, "shape","triangle2_2_1", {2, 1, 7, 4}, "triangleBottomLeftShape", {1, 2})
    addToTransitionArray(ta,{{"triangle2_2_1"},{"slide"},{},{2},{1},{2,1,6,5},{2},{2,1,7,4}})
