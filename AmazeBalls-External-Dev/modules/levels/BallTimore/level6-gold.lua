...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 5, 2, "triangleTopLeftShape"})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 7, 4, "triangleTopLeftShape"})
    ...
    --SCREEN 2-1
    table.insert(shapeArrayParameters,{"gun","gun1_2_1", 2, 1, 5, 1, "down"})
    ...
    table.insert(shapeArrayParameters,{"backFire","backFire1_2_1", 2, 1, 2, 4})
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_2_1", 2, 1, 4, 4})
