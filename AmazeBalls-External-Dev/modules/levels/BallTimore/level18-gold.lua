...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"manualFan1_1_1"},{"slide"},{},{1},{1},{1,1,2,3},{2},{1,1,4,2},{3},{1,1,5,2},{"*"},{1,1,5,3},{4},{1,1,7,3}})
    addToShapeArray(sp, "autoFan","autoFan1_1_1", {1, 1, 1, 4}, "right")
    addToTransitionArray(ta,{{"autoFan1_1_1"},{"switchSlide"},{},{2},{1},{1,1,1,3},{2},{1,1,1,4}})
    ...
    addToTransitionArray(ta,{{"bar3_1_1"},{"switchSlide"},{},{2},{1},{1,1,8,3},{2},{1,1,8,4}})
    ...
    addToTransitionArray(ta,{{"triangle7_1_1"},{"switchSlide"},{},{1},{1},{1,1,5,5},{2},{1,1,6,5}})
    ...
    addToTransitionArray(ta,{{"bar1_1_2"},{"slide"},{},{1},{1},{1,2,1,2},{2},{1,2,1,3}})
    ...
    addToTransitionArray(ta,{{"triangle2_1_2"},{"flip-vertical"}})
    ...
    addToTransitionArray(ta,{{"triangle2_1_3"},{"slide"},{},{1},{1},{1,3,7,1},{2},{1,3,7,2}})
    ...
    addToTransitionArray(ta,{{"triangle3_1_3"},{"flip-horizontal"}})
    ...
    addToTransitionArray(ta,{{"triangle4_1_3"},{"flip-vertical"}})
    addToShapeArray(sp, "shape","triangle5_1_3", {1, 3, 7, 5}, "triangleTopLeftShape")
    addToTransitionArray(ta,{{"triangle5_1_3"},{"slide"},{},{2},{1},{1,3,7,4},{2},{1,3,7,5}})
    ...
    addToTransitionArray(ta,{{"bar1_2_3"},{"slide"},{},{2},{1},{2,3,3,3},{2},{2,3,3,5}})
