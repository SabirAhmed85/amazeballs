...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters,{"gun","gun1_1_1", 1, 1, 3, 2, "down"})
    ...
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_1", 1, 1, 6, 3, "left"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_1", 1, 1, 1, 5, "left"})
    table.insert(shapeArrayParameters,{"door","door1_1_1", 1, 1, 5, 5, "down"})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 6, 5, "triangleTopRightShape", 1, _, "fire"})

    --SCREEN 1-2
    table.insert(shapeArrayParameters,{"spitter","spitter1_1_2", 1, 2, 5, 1, "none","right","down","none"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"spitter1_1_2"},{"slide"},{},{2},{1},{1,2,1,1},{2},{1,2,5,1},{3},{1,2,6,1}})
    table.insert(shapeArrayParameters,{"gun","gun1_1_2", 1, 2, 2, 2, "right"})
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_1_2", 1, 2, 4, 3})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 1, 2, 1, 4, "triangleTopRightShape", 1, _, "fire"})
    ...
    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 2, 4, 110})
    table.insert(shapeArrayParameters,{"item","small-present", 1, 2, 6, 4, {} })
