...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"spitter2_1_1"},{"slide"},{},{1},{1},{1,1,6,2},{2},{1,1,6,3}})
    ...
    addToTransitionArray(ta,{{"autoFan2_1_1"},{"slide"},{},{1},{1},{1,1,5,5},{2},{1,1,5,4},{3},{1,1,6,4}})
    ...
    addToTransitionArray(ta,{{"autoFan1_2_1"},{"slide"},{},{2},{1},{2,1,5,2},{2},{2,1,6,1}})
    ...
    addToTransitionArray(ta,{{"triangle1_2_1"},{"slide"},{},{1},{1},{2,1,6,4},{2},{2,1,7,4}})
    --addToShapeArray(sp, "timeOut","timeOut1_2_1", {2, 1, 1, 5})
    addToShapeArray(sp, "shape","bar1_2_1", {2, 1, 2, 5}, "bar", {"horz", 2})
    addToTransitionArray(ta,{{"bar1_2_1"},{"slide"},{},{1},{1},{2,1,2,2},{2},{2,1,2,5}})
    ...
    addToTransitionArray(ta,{{"triangle3_2_1"},{"slide"},{},{1},{1},{2,1,4,4},{"*"},{2,1,4,5},{2},{2,1,5,5}})
