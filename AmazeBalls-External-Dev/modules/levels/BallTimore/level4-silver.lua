...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle3_2_1"},{"flip-horizontal"}})
    addToShapeArray(sp, "shape","bar1_2_1", {2, 1, 8, 3}, "bar", {"horz"})
    addToTransitionArray(ta,{{"bar1_2_1"},{"switchSlide"},{},{1},{1},{2,1,8,3},{2},{2,1,8,4}})
    ...
    addToTransitionArray(ta,{{"manualFan2_3_1"},{"slide"},{},{1},{1},{3,1,6,3},{2},{3,1,7,3},{3},{3,1,7,2}})
    ...
    addToTransitionArray(ta,{{"triangle1_3_1"},{"slide"},{},{1},{1},{3,1,2,4},{2},{3,1,4,4}})
    addToShapeArray(sp, "shape","bar2_3_1", {3, 1, 7, 4}, "bar", {"vert", 3})
    addToTransitionArray(ta,{{"bar2_3_1"},{"slide"},{},{2},{1},{3,1,6,4},{2},{3,1,7,4}})
