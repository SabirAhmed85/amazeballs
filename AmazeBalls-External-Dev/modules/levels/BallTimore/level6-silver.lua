...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 3, 2, "triangleBottomLeftShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 4, 2, "triangleBottomRightShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"simple","simple1_1_1", 1, 1, 5, 2})
    table.insert(shapeArrayParameters,{"gun","gun1_1_1", 1, 1, 2, 3, "right"})
    table.insert(shapeArrayParameters,{"spitter","spitter1_1_1", 1, 1, 3, 5, "up","none","none","none"})
    ...
    table.insert(shapeArrayParameters,{"autoFan","autoFan3_1_2", 1, 2, 7, 2, "left"})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 1, 2, 1, 3, "triangleTopAndBottomShape", 1})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_2", 1, 2, 5, 3, "triangleBottomLeftShape", 1, 4, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 1, 2, 6, 3, "triangleTopRightShape", 1, 24, "breakable"})
    table.insert(shapeArrayParameters,{"shape","bar1_1_2", 1, 2, 2, 4, "bar", "vert", 3})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_2", 1, 2, 4, 5, "triangleTopRightShape"})
    table.insert(shapeArrayParameters,{"shape","triangle5_1_2", 1, 2, 7, 5, "triangleTopLeftShape"})
    ...
    table.insert(shapeArrayParameters,{"gem","redCoin", 1, 2, 1, 1, "redCoin"})
    ...
    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 1, 1, 85})
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 6, 1, 130})
end
