...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"tunnel","tunnel1_1_1", 1, 1, 1, 2, 1, 2, 2, 1, "down"})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 2, 2, "triangleTopRightShape"})
    ...
    table.insert(shapeArrayParameters,{"gun","gun2_1_1", 1, 1, 1, 3, "right"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_1", 1, 1, 6, 4, "right"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"autoFan1_1_1"},{"switchSlide"},{},{2},{1},{1,1,6,1},{2},{1,1,6,4}})
    table.insert(shapeArrayParameters,{"shape","bar1_1_1", 1, 1, 7, 5, "bar", "vert"})
    ...
    table.insert(shapeArrayParameters,{"gun","gun1_2_1", 2, 1, 4, 3, "left"})
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_2_1", 2, 1, 5, 3})
    table.insert(shapeArrayParameters,{"shape","triangle1_2_1", 2, 1, 2, 5, "triangleTopRightShape"})
    table.insert(shapeArrayParameters,{"shape","triangle1_2_1", 2, 1, 5, 5, "triangleTopLeftShape"})

    --SCREEN 1-2
    table.insert(shapeArrayParameters,{"item","compass", 1, 2, 4, 1})
    table.insert(shapeArrayParameters,{"door","door1_1_2", 1, 2, 6, 1, "up"})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 1, 2, 1, 2, "triangleTopLeftShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_2", 1, 2, 5, 2, "triangleTopRightShape", 1, 13, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 1, 2, 6, 3, "triangleTopLeftShape", 1, 5, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_2", 1, 2, 1, 4, "triangleBottomLeftShape", 1, 22, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle5_1_2", 1, 2, 4, 5, "triangleBottomLeftShape", 1, 25, "breakable"})

    --SWITCHES
    table.insert(shapeArrayParameters,{"switch","switch1_1_2", 1, 2, 3, 4, { {"door-open","door1_1_1"} } })
    ...
    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 2, 1, 60})
    table.insert(shapeArrayParameters,{"item","coins", 2, 1, 4, 1, 110})
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 5, 4, 220})
