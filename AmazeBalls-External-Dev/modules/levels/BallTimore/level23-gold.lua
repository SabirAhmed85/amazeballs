...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"backFire1_1_1"},{"slide"},{},{1},{1},{1,1,3,1},{2},{1,1,4,1}})
    addToShapeArray(sp, "gun","gun1_1_1", {1, 1, 5, 1}, "down")
    addToShapeArray(sp, "shape","triangle1_1_1", {1, 1, 3, 2}, "triangleTopLeftShape")
    addToTransitionArray(ta,{{"triangle1_1_1"},{"slide"},{},{1},{1},{1,1,3,2},{2},{1,1,4,2}})
    ...
    addToTransitionArray(ta,{{"triangle1_2_1"},{"slide"},{},{1},{1},{2,1,6,1},{2},{2,1,7,1}})
    addToShapeArray(sp, "autoFan","autoFan1_2_1", {2, 1, 3, 2}, "down")
    addToTransitionArray(ta,{{"autoFan1_2_1"},{"slide"},{},{1},{2},{2,1,3,1},{2},{2,1,3,2}})
    addToShapeArray(sp, "shape","triangle2_2_1", {2, 1, 7, 2}, "triangleTopLeftShape")
    addToTransitionArray(ta,{{"triangle2_2_1"},{"switchSlide"},{},{1},{1},{2,1,7,2},{2},{2,1,7,4}})
    ...
    addToTransitionArray(ta,{{"manualFan1_2_1"},{"switchSlide"},{},{2},{1},{2,1,1,3},{2},{2,1,1,4}})
    addToShapeArray(sp, "shape","triangle4_2_1", {2, 1, 3, 4}, "triangleTopRightShape")
    addToTransitionArray(ta,{{"triangle4_2_1"},{"switchSlide"},{},{1},{1},{2,1,3,4},{2},{2,1,4,4}})
    ...
    addToTransitionArray(ta,{{"manualFan1_1_2"},{"slide"},{},{2},{1},{1,2,2,1},{2},{1,2,3,1}})
    ...
    addToTransitionArray(ta,{{"backFire1_1_2"},{"slide"},{},{1},{1},{1,2,1,2},{2},{1,2,3,2},{3},{1,2,5,2}})
    ...
    addToTransitionArray(ta,{{"spitter1_1_2"},{"slide"},{},{2},{1},{1,2,2,3},{2},{1,2,5,3},{3},{1,2,6,3}})
    ...
    addToTransitionArray(ta,{{"spitter2_1_2"},{"slide"},{},{2},{1},{1,2,3,4},{2},{1,2,6,4}})
    ...
    addToTransitionArray(ta,{{"spitter3_1_2"},{"slide"},{},{2},{1},{1,2,4,5},{2},{1,2,5,5},{3},{1,2,6,5}})
    ...
    addToTransitionArray(ta,{{"autoFan1_2_3"},{"slide"},{},{2},{1},{2,3,5,3},{2},{2,3,5,4}})
    ...
    addToTransitionArray(ta,{{"triangle6_2_3"},{"slide"},{},{2},{1},{2,3,5,5},{2},{2,3,6,5}})
