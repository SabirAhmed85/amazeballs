...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"autoFan4_1_1"},{"slide"},{},{3},{1},{1,1,4,3},{2},{1,1,5,3},{3},{1,1,5,2}})
    ...
    addToTransitionArray(ta,{{"triangle6_1_1"},{"slide"},{},{2},{1},{1,1,4,5},{2},{1,1,6,5}})
    ...
    addToTransitionArray(ta,{{"triangle1_1_2"},{"slide"},{},{4},{1},{1,2,5,2},{2},{1,2,5,1},{3},{1,2,6,1},{3},{1,2,7,1}})
