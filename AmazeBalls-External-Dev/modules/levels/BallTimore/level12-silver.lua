...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 5, 1, "triangleBottomLeftShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_1", 1, 1, 1, 2, "triangleTopRightShape", 1, 1, "icy"})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_1", 1, 1, 3, 2, "triangleBottomLeftShape"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle4_1_1"},{"flip-horizontal"}})
    table.insert(shapeArrayParameters,{"shape","triangle5_1_1", 1, 1, 5, 2, "triangleTopLeftShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"shape","bar1_1_1", 1, 1, 2, 3, "bar", "horz"})
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_1_2", 1, 1, 2, 3})
    table.insert(shapeArrayParameters,{"backFire","backFire1_1_1", 1, 1, 1, 4})
    ...
    table.insert(shapeArrayParameters,{"shape","bar2_1_1", 1, 1, 3, 6, "bar", "vert", 3})
    table.insert(shapeArrayParameters,{"shape","bar3_1_1", 1, 1, 4, 6, "bar", "vert", 4})
    table.insert(shapeArrayParameters,{"shape","bar4_1_1", 1, 1, 7, 6, "bar", "vert", 2})

    --SCREEN 2-1
    table.insert(shapeArrayParameters,{"door","door1_1_2", 1, 2, 2, 1, "up", "disabled"})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 1, 2, 6, 1, "triangleBottomLeftShape", 1, 4, "breakable"})
    table.insert(shapeArrayParameters,{"gun","gun1_1_2", 1, 2, 3, 2, "down"})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_2", 1, 2, 2, 4, "triangleTopLeftShape", 1, 5, "breakable"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_2", 1, 2, 6, 4, "right"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 1, 2, 3, 5, "triangleTopRightShape", 1, _, "icy"})

    --SWITCHES
    table.insert(shapeArrayParameters,{"switch","switch1_1_2", 1, 2, 4, 1, { {"door-open","door1_1_2"} } })
    ...
    table.insert(shapeArrayParameters,{"gem","redCoin", 1, 1, 4, 5, "redCoin"})
    ...
    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 3, 1, 90})
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 2, 1, 70})
    table.insert(shapeArrayParameters,{"item","small-present", 1, 2, 1, 4, {} })
    table.insert(shapeArrayParameters,{"item","hook", 1, 2, 6, 3, {} })
end
