...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"autoFan1_1_1"},{"slide"},{},{1},{1},{1,1,1,2},{2},{1,1,2,2},{"*"},{1,1,2,1},{3},{1,1,3,1}})
    addToShapeArray(sp, "shape","triangle2_1_1", {1, 1, 3, 2}, "triangleBottomLeftShape")
    addToTransitionArray(ta,{{"triangle2_1_1"},{"slide"},{},{1},{1},{1,1,3,2},{2},{1,1,4,2}})
    ...
    addToTransitionArray(ta,{{"triangle3_1_1"},{"slide"},{},{1},{1},{1,1,4,3},{2},{1,1,4,5}})
    ...
    addToTransitionArray(ta,{{"autoFan3_1_1"},{"slide"},{},{1},{1},{1,1,1,4},{"*"},{1,1,1,3},{2},{1,1,2,3}})
