...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 7, 1, "triangleBottomRightShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_1", 1, 1, 1, 2, "left"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"autoFan1_1_1"},{"slide"},{},{1},{1},{1,1,1,2},{2},{1,1,2,2},{"*"},{1,1,2,1},{3},{1,1,3,1}})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 3, 2, "triangleBottomLeftShape"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle2_1_1"},{"slide"},{},{1},{1},{1,1,3,2},{2},{1,1,4,2}})
    table.insert(shapeArrayParameters,{"autoFan","autoFan2_1_1", 1, 1, 5, 2, "right"})
    table.insert(shapeArrayParameters,{"shape","bar1_1_1", 1, 1, 1, 3, "bar", "horz"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan2_1_1", 1, 1, 3, 3, "left"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_1", 1, 1, 4, 3, "triangleTopLeftShape"})
    ...
    table.insert(shapeArrayParameters,{"autoFan","autoFan3_1_1", 1, 1, 1, 4, "down"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"autoFan3_1_1"},{"slide"},{},{1},{1},{1,1,1,4},{"*"},{1,1,1,3},{2},{1,1,2,3}})
    table.insert(shapeArrayParameters,{"tunnel","tunnel1_1_1", 1, 1, 2, 4, 1, 1, 6, 2, "none"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan4_1_1", 1, 1, 3, 4, "up"})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_1", 1, 1, 6, 4, "triangleTopRightShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan5_1_1", 1, 1, 5, 5, "down"})

    --SCREEN 2-1
    table.insert(shapeArrayParameters,{"shape","triangle1_2_1", 2, 1, 2, 1, "triangleBottomRightShape", 1, 3, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle2_2_1", 2, 1, 6, 1, "triangleBottomLeftShape", 1, 7, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle3_2_1", 2, 1, 3, 2, "triangleBottomRightShape", 1, 8, "breakable"})
    table.insert(shapeArrayParameters,{"shape","bar1_2_1", 2, 1, 3, 3, "bar", "horz"})
    table.insert(shapeArrayParameters,{"shape","triangle4_2_1", 2, 1, 4, 3, "triangleBottomLeftShape", 1, 4, "breakable"})
    table.insert(shapeArrayParameters,{"shape","bar2_2_1", 2, 1, 6, 3, "bar", "horz"})
    table.insert(shapeArrayParameters,{"shape","triangle5_2_1", 2, 1, 3, 4, "triangleTopRightShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle6_2_1", 2, 1, 5, 4, "triangleTopLeftShape", 1, _, "breakable"})
    ...
    table.insert(shapeArrayParameters,{"gem","blueCoin", 2, 1, 2, 5, "blueCoin"})
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 1, 1, 5, 3, "purpleCoin"})

    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 5, 1, 160})
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 5, 4, 180})
end
