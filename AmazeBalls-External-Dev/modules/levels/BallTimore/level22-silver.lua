...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"bar4_1_1"},{"slide"},{},{2},{1},{1,1,2,2},{2},{1,1,2,4}})
    ...
    addToTransitionArray(ta,{{"spitter1_1_1"},{"slide"},{},{3},{1},{1,1,4,5},{2},{1,1,5,5},{3},{1,1,6,5},{4},{1,1,7,5}})
    ...
    addToTransitionArray(ta,{{"triangle1_2_1"},{"slide"},{},{2},{1},{2,1,5,1},{2},{2,1,5,2}})
    ...
    addToTransitionArray(ta,{{"autoFan1_2_1"},{"slide"},{},{1},{1},{2,1,3,5},{2},{2,1,5,5}})
    ...
    addToTransitionArray(ta,{{"manualFan1_2_2"},{"slide"},{},{1},{1},{2,2,1,4},{2},{2,2,1,5}})
    addToShapeArray(sp, "autoFan","autoFan1_2_2", {2, 2, 2, 5}, "left")
    addToTransitionArray(ta,{{"autoFan1_2_2"},{"slide"},{},{1},{1},{2,2,2,5},{2},{2,2,4,5},{3},{2,2,5,5}})
    ...
    addToTransitionArray(ta,{{"triangle4_2_3"},{"flip-vertical"}})
    ...
    addToTransitionArray(ta,{{"triangle7_2_3"},{"flip-vertical"}})
    ...
    addToTransitionArray(ta,{{"simple2_2_4"},{"slide"},{},{2},{1},{2,4,1,5},{2},{2,4,3,5}})
