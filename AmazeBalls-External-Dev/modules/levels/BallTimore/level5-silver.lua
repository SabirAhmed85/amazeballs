...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"autoFan2_1_1"},{"slide"},{},{1},{1},{1,1,3,2},{2},{1,1,4,2},{3},{1,1,5,2}})
    ...
    addToTransitionArray(ta,{{"backFire1_1_2"},{"slide"},{},{2},{1},{1,2,3,2},{2},{1,2,3,1},{3},{1,2,4,1}})
    addToShapeArray(sp, "backFire","backFire2_1_2", {1, 2, 5, 1})
    addToTransitionArray(ta,{{"backFire2_1_2"},{"slide"},{},{3},{1},{1,2,5,3},{2},{1,2,5,2},{3},{1,2,5,1},{4},{1,2,6,1}})
    addToShapeArray(sp, "shape","triangle1_1_2", {1, 2, 7, 2}, "triangleBottomLeftShape", {1, 4})
    addToTransitionArray(ta,{{"triangle1_1_2"},{"slide"},{},{3},{1},{1,2,6,4},{2},{1,2,7,4},{3},{1,2,7,2}})
    addToShapeArray(sp, "autoFan","autoFan1_1_2", {1, 2, 1, 4}, "up")
    addToTransitionArray(ta,{{"autoFan1_1_2"},{"slide"},{},{1},{1},{1,2,1,4},{2},{1,2,3,4}})
    ...
    addToTransitionArray(ta,{{"autoFan2_1_2"},{"slide"},{},{2},{1},{1,2,4,3},{2},{1,2,4,5},{3},{1,2,6,5}})
    ...
    addToTransitionArray(ta,{{"simple1_1_3"},{"slide"},{},{2},{1},{1,3,1,3},{2},{1,3,1,5}})
