...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 6, 1, "triangleTopAndBottomShape", 1})
    ...
    table.insert(shapeArrayParameters,{"gun","gun1_1_1", 1, 1, 3, 4, "right"})
    table.insert(shapeArrayParameters,{"shape","bar1_1_1", 1, 1, 1, 5, "bar", "vert", 2})
    table.insert(shapeArrayParameters,{"tunnel","tunnel1_1_1", 1, 1, 1, 5, 1, 2, 7, 5, "none"})
    ...
    table.insert(shapeArrayParameters,{"shape","bar2_1_1", 1, 1, 1, 6, "bar", "vert", 2})
    ...
    table.insert(shapeArrayParameters,{"spitter","spitter1_1_2", 1, 2, 4, 1, "none","none","down","none"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"spitter1_1_2"},{"slide"},{},{3},{1},{1,2,2,1},{2},{1,2,3,1},{3},{1,2,4,1}})
    table.insert(shapeArrayParameters,{"gun","gun1_1_2", 1, 2, 3, 2, "right"})
    table.insert(shapeArrayParameters,{"shape","bar1_1_2", 1, 2, 2, 3, "bar", "horz", 4})
    ...
    table.insert(shapeArrayParameters,{"tunnel","tunnel2_1_2", 1, 2, 6, 3, 1, 2, 3, 5, "right"})
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_1_2", 1, 2, 7, 3})
    table.insert(shapeArrayParameters,{"shape","bar2_1_2", 1, 2, 1, 5, "bar", "vert"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar2_1_2"},{"slide"},{},{1},{1},{1,2,1,5},{2},{1,2,2,5}})
    table.insert(shapeArrayParameters,{"manualFan","manualFan2_1_2", 1, 2, 4, 5, "up"})
    table.insert(shapeArrayParameters,{"tunnel","tunnel3_1_2", 1, 2, 5, 5, 1, 2, 4, 3, "none"})
    table.insert(shapeArrayParameters,{"shape","bar3_1_2", 1, 2, 2, 6, "bar", "vert", 2})

    --SWITCHES
    table.insert(shapeArrayParameters,{"switch","switch1_1_1", 1, 1, 2, 3, { {"slide","bar2_1_1"} } })
    ...
    table.insert(shapeArrayParameters,{"gem","blueCoin", 1, 2, 4, 4, "blueCoin"})
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 1, 1, 7, 3, "purpleCoin"})

    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 1, 4, 185})
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 6, 2, 70})
