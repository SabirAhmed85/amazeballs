...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"spitter2_2_1"},{"switchSlide"},{},{1},{1},{2,1,1,3},{2},{2,1,1,4}})
    ...
    addToTransitionArray(ta,{{"spitter2_2_1"},{"switchSlide"},{},{1},{1},{2,1,7,4},{2},{2,1,7,5}})
    ...
    addToTransitionArray(ta,{{"autoFan1_2_2"},{"switchSlide"},{},{1},{1},{2,2,7,1},{2},{2,2,7,2}})
    --addToShapeArray(sp, "timeOut","timeOut1_2_1", {2, 1, 1, 2, 3})
    addToShapeArray(sp, "autoFan","autoFan2_2_2", {2, 2, 5, 2}, "down")
    addToTransitionArray(ta,{{"autoFan2_2_2"},{"slide"},{},{1},{1},{2,2,5,2},{2},{2,2,5,3}})
    addToShapeArray(sp, "autoFan","autoFan3_2_2", {2, 2, 6, 3}, "up")
    addToTransitionArray(ta,{{"autoFan3_2_2"},{"slide"},{},{2},{1},{2,2,6,2},{2},{2,2,6,3}})
    addToShapeArray(sp, "autoFan","autoFan4_2_2", {2, 2, 2, 4}, "right")
    addToTransitionArray(ta,{{"autoFan4_2_2"},{"switchSlide"},{},{1},{1},{2,2,2,4},{2},{2,2,2,5}})
    addToShapeArray(sp, "autoFan","autoFan5_2_2", {2, 2, 3, 4}, "down")
    addToTransitionArray(ta,{{"autoFan5_2_2"},{"switchSlide"},{},{1},{1},{2,2,3,4},{2},{2,2,3,5}})
    ...
    addToTransitionArray(ta,{{"autoFan1_2_3"},{"switchSlide"},{},{1},{1},{2,3,3,1},{2},{2,3,3,2}})
    ...
    addToTransitionArray(ta,{{"autoFan2_2_3"},{"switchSlide"},{},{2},{1},{2,3,2,1},{2},{2,3,2,2}})
    addToShapeArray(sp, "simple","simple1_2_3", {2, 3, 4, 2})
    addToShapeArray(sp, "shape","triangle4_2_3", {2, 3, 6, 2}, "triangleBottomLeftShape")
    addToTransitionArray(ta,{{"triangle4_2_3"},{"slide"},{},{1},{2},{2,3,5,1},{2},{2,3,6,2}})
    addToShapeArray(sp, "backFire","backFire1_2_3", {2, 3, 5, 3})
    addToTransitionArray(ta,{{"backFire1_2_3"},{"slide"},{},{1},{1},{2,3,5,3},{2},{2,3,6,3}})
    ...
    addToTransitionArray(ta,{{"triangle7_2_3"},{"slide"},{},{1},{1},{2,3,5,4},{2},{2,3,6,5}})
