...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_1_1", {1, 1, 4, 2}, "triangleBottomRightShape", {1, 9, "breakable"}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_1_1", {1, 1, 6, 3}, "triangleTopRightShape", {1, 10, "breakable"}))

    --SCREEN 2-1
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_2_1", {2, 1, 3, 1}, "up"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle6_2_1", {2, 1, 7, 4}, "triangleTopRightShape", {1, 13, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("door","door1_2_1", {2, 1, 7, 4}, "right"))

    --SCREEN 3-1
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_3_1", {3, 1, 4, 1}, "down"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_3_1", {3, 1, 7, 1}, "triangleBottomLeftShape", {1, _, "icy"}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan4_2_2", 3, 1, 5, 5}, "up"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_1_2", {1, 2, 3, 3}, "triangleTopLeftShape", {1, 6, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle4_1_2", {1, 2, 5, 3}, "triangleTopRightShape", {1, 13, "breakable"}))
