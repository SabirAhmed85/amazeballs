...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle1_1_1"},{"slide"},{},{1},{1},{1,1,6,1},{2},{1,1,6,2}})
    ...
    addToTransitionArray(ta,{{"spitter1_1_1"},{"slide"},{},{1},{1},{1,1,4,4},{2},{1,1,4,5}})
    addToShapeArray(sp, "autoFan","autoFan1_1_1", {1, 1, 7, 4}, "up")
    addToTransitionArray(ta,{{"autoFan1_1_1"},{"slide"},{},{1},{1},{1,1,7,4},{2},{1,1,7,5}})
    ...
    addToTransitionArray(ta,{{"triangle2_2_1"},{"slide"},{},{1},{1},{2,1,3,4},{2},{2,1,3,5}})
