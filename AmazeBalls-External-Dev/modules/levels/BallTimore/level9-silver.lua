...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"manualFan5_1_1"},{"slide"},{},{2},{1},{1,1,1,5},{2},{1,1,4,5}})
    ...
    addToTransitionArray(ta,{{"autoFan1_2_1"},{"slide"},{},{1},{1},{2,1,3,1},{2},{2,1,4,1},{3},{2,1,6,1}})
    ...
    addToTransitionArray(ta,{{"spitter2_2_2"},{"autoSlide"},{timePerSquare = 360, pauseTime = 0},{2},{1},{2,2,7,1},{2},{2,2,7,2}})
    addToShapeArray(sp, "spitter","spitter3_2_2", {2, 2, 1, 4}, {"none","right","none","none"})
    addToTransitionArray(ta,{{"spitter3_2_2"},{"autoSlide"},{timePerSquare = 360, pauseTime = 0},{2},{1},{2,2,1,1},{2},{2,2,1,4}})
    ...
    addToTransitionArray(ta,{{"autoFan1_2_2"},{"autoSlide"},{timePerSquare = 600, pauseTime = 0},{1},{1},{2,2,6,3},{2},{2,2,7,3}})
