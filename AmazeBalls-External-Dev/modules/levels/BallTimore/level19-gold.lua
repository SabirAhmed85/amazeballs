...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"autoFan1_1_1"},{"slide"},{},{1},{1},{1,1,2,1},{2},{1,1,3,1}})
    addToShapeArray(sp, "manualFan","manualFan1_1_1", {1, 1, 5, 1}, "left")
    addToTransitionArray(ta,{{"manualFan1_1_1"},{"slide"},{},{1},{1},{1,1,5,1},{2},{1,1,5,2}})
    ...
    addToTransitionArray(ta,{{"bar1_1_1"},{"slide"},{},{1},{1},{1,1,8,1},{2},{1,1,8,3}})
    ...
    addToTransitionArray(ta,{{"autoFan6_1_1"},{"slide"},{},{2},{1},{1,1,6,2},{2},{1,1,6,4}})
    ...
    addToTransitionArray(ta,{{"bar1_2_2"},{"slide"},{},{1},{1},{2,2,3,1},{2},{2,2,3,5}})
    ...
    addToTransitionArray(ta,{{"autoFan1_2_2"},{"slide"},{},{2},{1},{2,2,5,1},{2},{2,2,6,1}})
    ...
    addToTransitionArray(ta,{{"autoFan2_2_2"},{"slide"},{},{2},{1},{2,2,6,2},{2},{2,2,7,2}})
    ...
    addToTransitionArray(ta,{{"spitter1_2_2"},{"slide"},{},{2},{1},{2,2,3,1},{2},{2,2,3,3},{3},{2,2,3,5}})
    ...
    addToTransitionArray(ta,{{"bar2_2_2"},{"slide"},{},{2},{1},{2,2,6,4},{2},{2,2,6,5}})
    ...
    addToTransitionArray(ta,{{"autoFan14_2_3"},{"slide"},{},{1},{1},{2,3,3,5},{2},{2,3,4,4}})
