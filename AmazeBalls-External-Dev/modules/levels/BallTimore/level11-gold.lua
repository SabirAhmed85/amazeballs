...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"spitter1_1_1"},{"slide"},{},{2},{1},{1,1,3,2},{2},{1,1,3,3}})
    addToShapeArray(sp, "spitter","spitter2_1_1", {1, 1, 5, 3}, {"none","none","none","left"})
    addToTransitionArray(ta,{{"spitter2_1_1"},{"slide"},{},{2},{1},{1,1,5,2},{2},{1,1,5,3}})
    ...
    addToTransitionArray(ta,{{"spitter3_1_1"},{"slide"},{},{2},{1},{1,1,4,4},{2},{1,1,4,5}})
    addToShapeArray(sp, "spitter","spitter4_1_1", {1, 1, 5, 5}, {"none","none","none","left"})
    addToTransitionArray(ta,{{"spitter4_1_1"},{"slide"},{},{2},{1},{1,1,5,4},{2},{1,1,5,5}})
    ...
    addToTransitionArray(ta,{{"backFire1_2_1"},{"slide"},{},{2},{1},{2,1,1,2},{2},{2,1,2,2}})
    addToShapeArray(sp, "shape","bar1_2_1", {2, 1, 3, 4}, "bar", {"vert"})
    addToTransitionArray(ta,{{"bar1_2_1"},{"slide"},{},{2},{1},{2,1,2,4},{2},{2,1,3,4}})
    ...
    addToTransitionArray(ta,{{"bar2_2_1"},{"slide"},{},{2},{1},{2,1,6,5},{2},{2,1,7,5}})
    ...
    addToTransitionArray(ta,{{"autoFan5_3_1"},{"slide"},{},{1},{1},{3,1,7,4},{2},{3,1,7,5}})
    ...
    addToTransitionArray(ta,{{"triangle1_4_1"},{"slide"},{},{1},{1},{4,1,2,4},{2},{4,1,4,4}})
    addToShapeArray(sp, "shape","bar1_4_1", {4, 1, 5, 4}, "bar", {"horz", 2})
    addToTransitionArray(ta,{{"bar1_4_1"},{"slide"},{},{1},{1},{4,1,5,4},{2},{4,1,5,5}})
