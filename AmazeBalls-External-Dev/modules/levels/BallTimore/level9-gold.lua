...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"bar1_2_1"},{"slide"},{},{1},{1},{2,1,2,2},{2},{2,1,2,4}})
    ...
    addToTransitionArray(ta,{{"spitter1_2_1"},{"slide"},{},{1},{1},{2,1,2,3},{2},{2,1,3,3},{3},{2,1,4,3},{4},{2,1,5,3},{5},{2,1,6,3}})
    ...
    addToTransitionArray(ta,{{"autoFan1_1_2"},{"slide"},{},{1},{1},{1,2,3,1},{2},{1,2,3,2}})
    addToShapeArray(sp, "shape","triangle2_1_2", {1, 2, 5, 1}, "triangleBottomLeftShape")
    addToShapeArray(sp, "autoFan","autoFan2_1_2", {1, 2, 5, 2}, "up")
    addToTransitionArray(ta,{{"autoFan2_1_2"},{"slide"},{},{1},{1},{1,2,5,2},{2},{1,2,5,3}})
    addToShapeArray(sp, "autoFan","autoFan3_1_2", {1, 2, 1, 3}, "right")
    addToTransitionArray(ta,{{"autoFan3_1_2"},{"slide"},{},{1},{1},{1,2,1,3},{2},{1,2,2,3}})
    ...
    addToTransitionArray(ta,{{"autoFan4_1_2"},{"slide"},{},{1},{1},{1,2,3,4},{2},{1,2,3,5}})
