...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle1_1_1", "slide", {"green"}, {{1,1,1,1},{1,1,3,1}})
    ...
    newTransition("triangle4_1_1", "slide", {"green"}, {{1,1,3,3},{1,1,3,4}})
    newShape("item","map", {1, 1, 4, 3})
    newShape("autoFan","autoFan2_1_1", {1, 1, 1, 4}, "down")
    newTransition("autoFan2_1_1", "slide", {"orange"}, {{1,1,1,4},{1,1,2,2}})
    newShape("autoFan","autoFan3_1_1", {1, 1, 7, 4}, "down")
    newTransition("autoFan3_1_1", "slide", {"orange"}, {{1,1,7,4},{1,1,7,5}})
    newShape("door","door1_1_1", {1, 1, 1, 5}, "down")
    newShape("door","door2_1_1", {1, 1, 2, 5}, "down")
    newShape("simple","simple1_1_1", {1, 1, 4, 5})
    newTransition("simple1_1_1", "slide", {"lightBlue"}, {{1,1,3,5},{1,1,4,5},{1,1,6,5}})
    ...
    newTransition("triangle1_1_2", "slide", {"green"}, {{1,2,1,1},{1,2,2,1}})
    newShape("simple","simple1_1_2", {1, 2, 4, 1})
    newShape("door","door1_1_2", {1, 2, 4, 1}, "up")
    newShape("autoFan","autoFan1_1_2", {1, 2, 6, 3}, "up")
    newTransition("autoFan1_1_2", "slide", {"orange"}, {{1,2,6,1},{1,2,6,3}})
    ...
    newTransition("triangle3_1_2", "slide", {"green"}, {{1,2,3,2},{1,2,5,2}})
