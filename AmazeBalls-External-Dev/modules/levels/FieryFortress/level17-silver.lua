...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 3, 1, "triangleTopRightShape", 1})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_1_1"},{"slide"},{"green"},{2},{1},{1,1,1,1},{2},{1,1,3,1}})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_1", 1, 1, 1, 2, "right"} )
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 5, 2, "triangleBottomLeftShape", 1})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_1", 1, 1, 7, 2, "triangleBottomLeftShape", 1, 2})
    ...
    table.insert(shapeArrayParameters,{"autoFan","autoFan2_1_1", 1, 1, 1, 4, "down"} )
    ...
    --SCREEN 1-2
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 1, 2, 1, 1, "triangleBottomRightShape", 1, 3})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_1_2"},{"slide"},{"green"},{1},{1},{1,2,1,1},{2},{1,2,2,1}})
    table.insert(shapeArrayParameters,{"simple","simple1_1_2", 1, 2, 4, 1} )
    table.insert(shapeArrayParameters,{"door","door1_1_1", 1, 2, 4, 1, "up"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_2", 1, 2, 6, 3, "up"} )
    ...
    table.insert(shapeArrayParameters,{"shape","triangle2_1_2", 1, 2, 2, 2, "triangleBottomLeftShape", 1, 4})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 1, 2, 5, 2, "triangleBottomRightShape", 1})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle4_1_2", 1, 2, 7, 3, "triangleBottomLeftShape", 1})
    table.insert(shapeArrayParameters,{"autoFan","autoFan4_1_2", 1, 2, 4, 4, "up"} )
    table.insert(shapeArrayParameters,{"shape","triangle5_1_2", 1, 2, 5, 4, "triangleTopLeftShape", 1})
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_1_2", 1, 2, 6, 4})    
    table.insert(shapeArrayParameters,{"shape","triangle6_1_2", 1, 2, 7, 4, "triangleTopLeftShape", 1})
    table.insert(shapeArrayParameters,{"shape","triangle7_1_2", 1, 2, 4, 5, "triangleTopLeftShape", 1})
    table.insert(shapeArrayParameters,{"shape","triangle8_1_2", 1, 2, 5, 5, "triangleBottomRightShape", 1})
    ...
    table.insert(shapeArrayParameters,{"gem","redCoin", 1, 2, 3, 5, "redCoin"})
    ...
    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 5, 3, 90})
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 4, 1, 50})
    table.insert(shapeArrayParameters,{"item","small-present", 1, 2, 3, 3, "present1_1_2", {} })
    table.insert(shapeArrayParameters,{"item","big-present", 1, 2, 7, 5, "present2_1_2", {} })
