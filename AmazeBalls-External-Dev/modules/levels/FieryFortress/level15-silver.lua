...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"item","small-present", 2, 1, 7, 2, "present1_7_2", {} })
    table.insert(shapeArrayParameters,{"item","small-present", 2, 1, 2, 2, "present2_2_2", {} })
    table.insert(shapeArrayParameters,{"item","big-present", 1, 1, 5, 3, "present3_5_3", {} })
