...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle1_1_1", "slide", {"green"}, {{1,1,2,1},{1,1,2,2}})
    ...
    newTransition("simple1_1_1", "slide", {"lightBlue"}, {{1,1,2,4},{1,1,3,4},{1,1,4,4}})
    ...
    newTransition("triangle2_2_1", "slide", {"green"}, {{2,1,4,2},{2,1,5,2}})
