...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle1_1_1"},{"slide"},{"green"},{1},{1},{1,1,2,1},{2},{1,1,2,2}})
    ...
    addToTransitionArray(ta,{{"simple1_1_1"},{"slide"},{"lightBlue"},{3},{1},{1,1,2,4},{2},{1,1,3,4},{3},{1,1,4,4}})
    ...
    addToTransitionArray(ta,{{"triangle2_2_1"},{"slide"},{"green"},{2},{1},{2,1,4,2},{2},{2,1,5,2}})
