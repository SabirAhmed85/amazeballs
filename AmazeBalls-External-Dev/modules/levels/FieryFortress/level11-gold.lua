...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("autoFan1_1_1", "slide", {}, {{1,1,6,1},{1,1,7,1}})
    newShape("shape", "triangle1_1_1", {1, 1, 2, 2}, "triangleTopRightShape", {1, _, "fire"})
    newShape("autoFan", "autoFan2_1_1", {1, 1, 3, 2}, "down")
    newTransition("autoFan2_1_1", "slide", {}, {{1,1,3,1},{1,1,3,2}})
    newShape("autoFan", "autoFan3_1_1", {1, 1, 4, 2}, "left")
    newTransition("autoFan3_1_1", "slide", {}, {{1,1,4,2},{1,1,5,2}})
    newShape("autoFan", "autoFan4_1_1", {1, 1, 1, 3}, "down")
    newTransition("autoFan4_1_1", "slide", {}, {{1,1,1,1},{1,1,1,3}})
    newShape("autoFan", "autoFan5_1_1", {1, 1, 3, 3}, "right")
    newTransition("autoFan5_1_1", "slide", {}, {{1,1,2,4},{1,1,2,3,"*"},{1,1,3,3}})
    newShape("autoFan", "autoFan6_1_1", {1, 1, 4, 3}, "up")
    newTransition("autoFan6_1_1", "slide", {}, {{1,1,4,3},{1,1,4,4}})
    ...
    newTransition("autoFan7_1_1", "slide", {}, {{1,1,2,5},{1,1,3,4}})
    ...
    newTransition("triangle6_1_2", "slide", {}, {{1,2,2,3},{1,2,2,4}})
