...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"autoFan1_1_1"},{"slide"},{"orange"},{2},{1},{1,1,6,1},{2},{1,1,7,1}})
    ...
    addToTransitionArray(ta,{{"autoFan2_1_1"},{"slide"},{"orange"},{2},{1},{1,1,3,1},{2},{1,1,3,2}})
    addToShapeArray(sp, "autoFan","autoFan3_1_1", {1, 1, 4, 2}, "left")
    addToTransitionArray(ta,{{"autoFan3_1_1"},{"slide"},{"orange"},{1},{1},{1,1,4,2},{2},{1,1,5,2}})
    addToShapeArray(sp, "autoFan","autoFan4_1_1", {1, 1, 1, 3}, "down")
    addToTransitionArray(ta,{{"autoFan4_1_1"},{"slide"},{"orange"},{2},{1},{1,1,1,1},{2},{1,1,1,3}})
    addToShapeArray(sp, "autoFan","autoFan5_1_1", {1, 1, 3, 3}, "right")
    addToTransitionArray(ta,{{"autoFan5_1_1"},{"slide"},{"orange"},{2},{1},{1,1,2,4},{"*"},{1,1,2,3},{2},{1,1,3,3}})
    addToShapeArray(sp, "autoFan","autoFan6_1_1", {1, 1, 4, 3}, "up")
    addToTransitionArray(ta,{{"autoFan6_1_1"},{"slide"},{"orange"},{1},{1},{1,1,4,3},{2},{1,1,4,4}})
    ...
    addToTransitionArray(ta,{{"autoFan7_1_1"},{"slide"},{"orange"},{1},{1},{1,1,2,5},{2},{1,1,3,4}})
    ...
    addToTransitionArray(ta,{{"autoFan8_1_1"},{"slide"},{"orange"},{2},{1},{1,1,6,3},{2},{1,1,6,5}})
    ...
    addToTransitionArray(ta,{{"triangle1_1_2"},{"slide"},{"green"},{1},{1},{1,2,2,1},{2},{1,2,4,2}})
    addToShapeArray(sp, "shape","triangle2_1_2", {1, 2, 5, 1}, "triangleTopLeftShape")
    addToTransitionArray(ta,{{"triangle2_1_2"},{"slide"},{"green"},{1},{1},{1,2,5,1},{2},{1,2,5,2}})
    ...
    addToTransitionArray(ta,{{"triangle6_1_2"},{"slide"},{"green"},{1},{1},{1,2,2,3},{2},{1,2,2,4}})
    ...
    addToTransitionArray(ta,{{"bar2_1_2"},{"slide"},{"brown"},{1},{1},{1,2,3,4},{2},{1,2,6,4}})
