...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle4_1_1", "slide", {"green"}, {{1,1,6,3},{1,1,6,4}})
    ...
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"simple1_1_1", "slide", {"lightBlue"}, {{1,1,4,4},{1,1,4,5}})
    table.insert(shapeArrayParameters, getShapeArray("simple","simple2_1_1", {1, 1, 6, 5})))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"simple2_1_1", "slide", {"lightBlue"}, {{1,1,5,5},{1,1,6,5}})
    ...
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle4_2_1", "slide", {"green"}, {{2,1,1,4},{2,1,2,4},{2,1,2,5,"*"},{2,1,4,5}})
