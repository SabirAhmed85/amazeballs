...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"autoFan1_1_1"},{"slide"},{"orange"},{1},{1},{1,1,4,1},{2},{1,1,6,1}})
    addToShapeArray(sp, "simple","simple1_1_1", {1, 1, 1, 2})
    addToTransitionArray(ta,{{"simple1_1_1"},{"slide"},{"lightBlue"},{1},{1},{1,1,1,2},{2},{1,1,2,2},{3},{1,1,3,2}})
    addToShapeArray(sp, "autoFan","autoFan2_1_1", {1, 1, 6, 3}, "left")
    addToTransitionArray(ta,{{"autoFan2_1_1"},{"slide"},{"orange"},{1},{1},{1,1,6,3},{2},{1,1,7,3},{3},{1,1,7,4}})
    addToShapeArray(sp, "door","door1_1_1", {1, 1, 1, 5}, "down")
    addToShapeArray(sp, "autoFan","autoFan3_1_1", {1, 1, 4, 5}, "up")
    addToTransitionArray(ta,{{"autoFan3_1_1"},{"slide"},{"orange"},{2},{1},{1,1,4,4},{2},{1,1,4,5},{3},{1,1,5,3}})
    ...
    addToTransitionArray(ta,{{"autoFan2_2_2"},{"slide"},{"orange"},{1},{1},{2,2,6,3},{2},{2,2,7,4}})
    addToShapeArray(sp, "simple","simple1_2_2", {2, 2, 3, 4})
    addToTransitionArray(ta,{{"simple1_2_2"},{"slide"},{"lightBlue"},{2},{1},{2,2,3,5},{2},{2,2,3,4},{3},{2,2,4,2},{4},{2,2,5,1}})
