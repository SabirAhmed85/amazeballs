...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("autoFan1_1_1", "slide", {"orange"}, {{1,1,4,1},{1,1,6,1}})
    newShape("simple","simple1_1_1", {1, 1, 1, 2})
    newTransition("simple1_1_1", "slide", {"lightBlue"}, {{1,1,1,2},{1,1,2,2},{1,1,3,2}})
    newShape("autoFan","autoFan2_1_1", {1, 1, 6, 3}, "left")
    newTransition("autoFan2_1_1", "slide", {"orange"}, {{1,1,6,3},{1,1,7,3},{1,1,7,4}})
    newShape("door","door1_1_1", {1, 1, 1, 5}, "down")
    newShape("autoFan","autoFan3_1_1", {1, 1, 4, 5}, "up")
    newTransition("autoFan3_1_1", "slide", {"orange"}, {{1,1,4,4},{1,1,4,5},{1,1,5,3}})
    ...
    newTransition("autoFan2_2_2", "slide", {"orange"}, {{2,2,6,3},{2,2,7,4}})
    newShape("simple","simple1_2_2", {2, 2, 3, 4})
    newTransition("simple1_2_2", "slide", {"lightBlue"}, {{2,2,3,5},{2,2,3,4},{2,2,4,2},{2,2,5,1}})
