...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle2_1_1", "slide", {"green"}, {{1,1,3,1},{1,1,4,1}})
    ...
    newTransition("triangle3_1_1", "slide", {"green"}, {{1,1,2,3},{1,1,3,3}})
    ...
    newTransition("simple1_1_2", "slide", {"lightBlue"}, {{1,2,2,2},{1,2,4,2},{1,2,6,2},{1,2,7,2}})
    ...
    newTransition("simple2_1_2", "slide", {"lightBlue"}, {{1,2,3,4},{1,2,5,4}})
    ...
    newTransition("autoFan1_1_3", "slide", {"orange"}, {{1,3,1,1},{1,3,1,2}})
    ...
    newTransition("triangle2_1_3", "slide", {"green"}, {{1,3,4,2},{1,3,4,3},{1,3,4,5}})
