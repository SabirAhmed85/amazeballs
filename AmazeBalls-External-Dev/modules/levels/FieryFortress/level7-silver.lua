...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle1_1_1"},{"slide"},{"green"},{2},{1},{1,1,1,2},{2},{1,1,3,2}})
    addToShapeArray(sp, "shape","triangle2_1_1", {1, 1, 5, 2}, "triangleTopLeftShape", {1, 11})
    addToTransitionArray(ta,{{"triangle2_1_1"},{"slide"},{"green"},{1},{1},{1,1,5,2},{2},{1,1,7,2}})
    ...
    addToTransitionArray(ta,{{"autoFan5_1_1"},{"slide"},{"orange"},{2},{1},{1,1,3,3},{2},{1,1,4,4}})
    addToShapeArray(sp, "shape","triangle3_1_1", {1, 1, 6, 4}, "triangleTopLeftShape")
    addToTransitionArray(ta,{{"triangle3_1_1"},{"slide"},{"green"},{2},{1},{1,1,5,4},{2},{1,1,6,4}})
