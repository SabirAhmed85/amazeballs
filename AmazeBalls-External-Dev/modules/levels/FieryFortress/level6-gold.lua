...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("autoFan1_1_1", "slide", {"orange"}, {{1,1,7,3},{1,1,7,4}})
    newShape("door","door1_1_1", {1, 1, 7, 3}, "right")

    -- 2-1
    newShape("simple","simple1_2_1", {2, 1, 1, 1})
    newTransition("simple1_2_1", "slide", {"lightBlue"}, {{2,1,1,1},{2,1,1,2},{2,1,1,3}})
    ...
    newTransition("autoFan1_2_1", "slide", {"orange"}, {{2,1,3,1},{2,1,2,1,"*"},{2,1,2,4}})
    newShape("autoFan","autoFan2_2_1", {2, 1, 5, 3}, "down")
    newTransition("autoFan2_2_1", "slide", {"orange"}, {{2,1,4,3},{2,1,5,3},{2,1,5,5,"*"},{2,1,7,5}})
    ...
    newTransition("autoFan1_2_2", "slide", {"orange"}, {{2,2,2,4},{2,2,4,4},{2,2,5,2}})
