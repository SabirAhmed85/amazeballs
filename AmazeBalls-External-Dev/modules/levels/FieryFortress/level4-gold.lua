...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"bar1_1_1"},{"slide"},{"brown"},{2},{1},{1,1,4,3},{2},{1,1,4,4}})
    addToShapeArray(sp, "shape","triangle7_1_1", {1, 1, 4, 4}, "triangleTopLeftShape")
    addToShapeArray(sp, "autoFan","autoFan3_1_1", {1, 1, 6, 4}, "up")
    addToTransitionArray(ta,{{"autoFan3_1_1"},{"slide"},{"orange"},{1},{1},{1,1,6,4},{"*"},{1,1,6,5},{2},{1,1,7,5}})
    ...
    addToTransitionArray(ta,{{"triangle3_2_1"},{"slide"},{"green"},{1},{1},{2,1,5,2},{2},{2,1,6,2}})
    addToShapeArray(sp, "shape","bar1_2_1", {2, 1, 7, 2}, "bar", {"horz"})
    addToShapeArray(sp, "autoFan","autoFan1_2_1", {2, 1, 1, 3}, "left")
    addToTransitionArray(ta,{{"autoFan1_2_1"},{"slide"},{"orange"},{1},{1},{2,1,1,3},{2},{2,1,2,3}})
    addToShapeArray(sp, "autoFan","autoFan2_2_1", {2, 1, 3, 3}, "left")
    addToTransitionArray(ta,{{"autoFan2_2_1"},{"slide"},{"orange"},{1},{1},{2,1,3,3},{2},{2,1,3,4},{3},{2,1,3,5}})
    ...
    addToTransitionArray(ta,{{"triangle7_2_1"},{"slide"},{"green"},{2},{1},{2,1,5,3},{2},{2,1,5,4}})
