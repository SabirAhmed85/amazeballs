...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("autoFan3_1_1", "slide", {}, {{1,1,6,4},{1,1,6,5,"*"},{1,1,7,5}})
    ...
    newTransition("triangle3_2_1", "slide", {}, {{2,1,5,2},{2,1,6,2}})
    newShape("shape", "bar1_2_1", {2, 1, 7, 2}, "bar", {"horz"})
    newShape("autoFan", "autoFan1_2_1", {2, 1, 1, 3}, "left")
    newTransition("autoFan1_2_1", "slide", {}, {{2,1,1,3},{2,1,2,3}})
    newShape("autoFan", "autoFan2_2_1", {2, 1, 3, 3}, "left")
    newTransition("autoFan2_2_1", "slide", {}, {{2,1,3,3},{2,1,3,4},{2,1,3,5}})
    ...
    newTransition("triangle7_2_1", "slide", {}, {{2,1,5,3},{2,1,5,4}})
