...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle1_2_1", "slide", {}, {{2,1,3,1},{2,1,4,1}})
    ...
    newTransition("triangle3_2_1", "slide", {}, {{2,1,3,3},{2,1,4,3}})
    newShape("simple", "simple1_2_1", {2, 1, 3, 4})
    newTransition("simple1_2_1", "slide", {}, {{2,1,2,1},{2,1,2,3},{2,1,2,4,"*"},{2,1,3,4},{2,1,4,4}})
    ...
    newTransition("autoFan5_2_1", "slide", {}, {{2,1,2,5},{2,1,3,5}})
    ...
    newTransition("triangle1_2_2", "slide", {}, {{2,2,2,2},{2,2,4,1}})
    ...
    newTransition("simple1_1_2", "slide", {}, {{1,2,6,2},{1,2,6,3}})
    ...
    newTransition("simple2_1_2", "slide", {}, {{1,2,2,5},{1,2,3,5},{1,2,5,5}})
