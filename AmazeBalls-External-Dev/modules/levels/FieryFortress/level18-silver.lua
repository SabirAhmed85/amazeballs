...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle1_2_1"},{"slide"},{"green"},{1},{1},{2,1,3,1},{2},{2,1,4,1}})
    ...
    addToTransitionArray(ta,{{"triangle3_2_1"},{"slide"},{"green"},{2},{1},{2,1,3,3},{2},{2,1,4,3}})
    addToShapeArray(sp, "simple","simple1_2_1", {2, 1, 3, 4})
    addToTransitionArray(ta,{{"simple1_2_1"},{"slide"},{"lightBlue"},{3},{1},{2,1,2,1},{2},{2,1,2,3},{"*"},{2,1,2,4},{3},{2,1,3,4},{4},{2,1,4,4}})
    addToShapeArray(sp, "shape","bar1_2_1", {2, 1, 7, 5}, "bar", {"vert", 4})
    addToTransitionArray(ta,{{"bar1_2_1"},{"autoSlide"},{timePerSquare = 600, pauseTime = 0},{2},{1},{2,1,6,5},{2},{2,1,7,5}})
    ...
    addToTransitionArray(ta,{{"autoFan5_2_1"},{"slide"},{"orange"},{1},{1},{2,1,2,5},{2},{2,1,3,5}})
    ...
    addToTransitionArray(ta,{{"triangle1_2_2"},{"slide"},{"green"},{1},{1},{2,2,2,2},{2},{2,2,4,1}})
    ...
    addToTransitionArray(ta,{{"bar2_2_2"},{"slide"},{"brown"},{2},{1},{2,2,4,3},{2},{2,2,7,3}})
    addToTransitionArray(ta,{{"autoFan3_2_2"},{"slide"},{"orange"},{1},{1},{2,2,6,2},{2},{2,2,7,1}})
    addToShapeArray(sp, "door","door3_2_2", {2, 2, 1, 3}, "left")
    addToShapeArray(sp, "shape","triangle2_2_2", {2, 2, 4, 3}, "triangleTopLeftShape", {1})
    addToTransitionArray(ta,{{"triangle2_2_2"},{"slide"},{"green"},{1},{1},{2,2,4,3},{2},{2,2,7,5}})
    addToShapeArray(sp, "shape","triangle3_2_2", {2, 2, 2, 4}, "triangleTopRightShape", {1})
    addToTransitionArray(ta,{{"triangle3_2_2"},{"slide"},{"green"},{1},{1},{2,2,2,4},{2},{2,2,2,5}})
    addToShapeArray(sp, "shape","bar3_2_2", {2, 2, 3, 4}, "bar", {"horz", 4})
    addToTransitionArray(ta,{{"bar3_2_2"},{"slide"},{"brown"},{2},{1},{2,2,3,3},{2},{2,2,3,4}})
    ...
    addToTransitionArray(ta,{{"simple1_1_2"},{"slide"},{"lightBlue"},{2},{1},{1,2,6,2},{2},{1,2,6,3}})
    ...
    addToTransitionArray(ta,{{"simple2_1_2"},{"slide"},{"lightBlue"},{2},{1},{1,2,2,5},{2},{1,2,3,5},{3},{1,2,5,5}})
