...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_2_1", {2, 1, 3, 1, "triangleTopAndBottomShape", 2}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_2_1", {2, 1, 6, 2}, "triangleBottomRightShape"))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan3_2_1", {2, 1, 1, 3}, "right")
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_2_1", {2, 1, 4, 3, "triangleTopAndBottomShape", 1, 12}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","bar1_2_1", {2, 1, 7, 5}, "bar", {"vert", 4} )
    ...
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan4_2_1", {2, 1, 7, 3}, "left")
    table.insert(shapeArrayParameters, getShapeArray("item","compass", {2, 1, 1, 5} )
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan5_2_1", {2, 1, 7, 4}, "down")
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan6_2_1", {2, 1, 2, 5}, "up")
    ...
    table.insert(shapeArrayParameters, getShapeArray("simple","simple2_2_1", {2, 1, 5, 5} )
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle4_2_1", {2, 1, 6, 5, "triangleTopAndBottomShape", 1}))

    --SCREEN 2-2
    table.insert(shapeArrayParameters, getShapeArray("door","door1_2_2", {2, 2, 2, 1}, "up"))
    table.insert(shapeArrayParameters, getShapeArray("simple","simple1_2_2", {2, 2, 2, 1} )
    table.insert(shapeArrayParameters, getShapeArray("door","door2_2_2", {2, 2, 5, 1}, "up"))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_2_2", {2, 2, 6, 1}, "down")
    table.insert(shapeArrayParameters, getShapeArray("shape","bar1_2_2", {2, 2, 2, 2}, "bar", {"vert", 3} )
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_2_2", {2, 2, 2, 2}, "triangleBottomRightShape", {1}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_2_2"},{"slide"},{"green"},{1},{1},{2,2,2,2},{2},{2,2,4,1}})
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan2_2_2", {2, 2, 5, 2}, "up")
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan3_2_2", {2, 2, 6, 2}, "down")
    table.insert(shapeArrayParameters, getShapeArray("shape","bar2_2_2", {2, 2, 7, 3}, "bar", {"vert", 4}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("door","door3_2_2", {2, 2, 1, 3}, "left"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_2_2", {2, 2, 4, 3}, "triangleTopLeftShape", {1}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle2_2_2"},{"slide"},{"green"},{1},{1},{2,2,4,3},{2},{2,2,7,5}})
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_2_2", {2, 2, 2, 4}, "triangleTopRightShape", {1}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle3_2_2"},{"slide"},{"green"},{1},{1},{2,2,2,4},{2},{2,2,2,5}})
    table.insert(shapeArrayParameters, getShapeArray("shape","bar3_2_2", {2, 2, 3, 4}, "bar", {"horz", 4}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar3_2_2"},{"slide"},{"brown"},{2},{1},{2,2,3,3},{2},{2,2,3,4}})
    table.insert(shapeArrayParameters, getShapeArray("shape","bar4_2_2", {2, 2, 4, 4}, "bar", {"horz", 3} )
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan4_2_2", {2, 2, 6, 4}, "left")
    table.insert(shapeArrayParameters, getShapeArray("shape","bar5_2_2", {2, 2, 4, 6}, "bar", {"vert", 2} )

    --SCREEN 1-2
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_1_2", {1, 2, 2, 1}, "triangleTopLeftShape", {1}))
    table.insert(shapeArrayParameters, getShapeArray("endPoint","endPoint1_1_2", {1, 2, 4, 1} )
    table.insert(shapeArrayParameters, getShapeArray("shape","bar1_1_2", {1, 2, 2, 2}, "bar", {"vert", 3} )
    table.insert(shapeArrayParameters, getShapeArray("shape","bar2_1_2", {1, 2, 5, 2}, "bar", {"vert", 2} )
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_1_2", {1, 2, 3, 2}, "up")
    table.insert(shapeArrayParameters, getShapeArray("simple","simple1_1_2", {1, 2, 6, 3} )
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","bar4_1_2", {1, 2, 6, 3}, "bar", {"horz", 3} )
    table.insert(shapeArrayParameters, getShapeArray("shape","bar5_1_2", {1, 2, 4, 5}, "bar", {"vert", 3} )
    table.insert(shapeArrayParameters, getShapeArray("simple","simple2_1_2", {1, 2, 3, 5} )
    ...
    table.insert(shapeArrayParameters, getShapeArray("gem","redCoin", {2, 1, 1, 4}, "redCoin"))
    table.insert(shapeArrayParameters, getShapeArray("gem","blueCoin", {2, 2, 5, 4}, "blueCoin"))
    table.insert(shapeArrayParameters, getShapeArray("gem","purpleCoin", {1, 2, 2, 2}, "purpleCoin"))

    --ITEMS
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {2, 1, 4, 5}, 90))
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {2, 2, 3, 5}, 150))
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {1, 2, 4, 3}, 75))
    table.insert(shapeArrayParameters, getShapeArray("item","small-present", {2, 2, 3, 3, {} })
    table.insert(shapeArrayParameters, getShapeArray("item","small-present", {1, 2, 5, 2, {} })
    table.insert(shapeArrayParameters, getShapeArray("item","big-present", 1, 2, 2, 3, {} })
