...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("simple1_1_1", "slide", {"lightBlue"}, {{1,1,4,1},{1,1,4,2,"*"},{1,1,5,2},{1,1,5,4},{1,1,5,5}})
    ...
    newTransition("triangle2_1_2", "slide", {"green"}, {{2,2,5,1},{2,2,5,3,"*"},{2,2,7,3}})
    newShape("shape","triangle3_2_2", {2, 2, 1, 5}, "triangleTopRightShape", {1})
    newShape("simple","simple1_2_2", {2, 2, 5, 5})
    newTransition("simple1_1_2", "slide", {"lightBlue"}, {{2,2,3,5},{2,2,5,5}})
