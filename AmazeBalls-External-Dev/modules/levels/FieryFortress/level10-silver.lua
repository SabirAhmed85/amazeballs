...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_1", 1, 1, 5, 1, "right"} )
    ...
    table.insert(shapeArrayParameters,{"autoFan","autoFan3_1_1", 1, 1, 2, 2, "down"} )
    table.insert(shapeArrayParameters,{"door","door1_1_1", 1, 1, 7, 2, "right"})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 1, 1, 7, 3, "triangleTopRightShape", 1})
    table.insert(shapeArrayParameters,{"autoFan","autoFan4_1_1", 1, 1, 4, 4, "left"} )
    table.insert(shapeArrayParameters,{"shape","triangle3_1_1", 1, 1, 1, 5, "triangleTopAndBottomShape", 1})
    table.insert(shapeArrayParameters,{"door","door2_1_1", 1, 1, 7, 5, "right", "disabled"})
    ...
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_2_1", 2, 1, 4, 2})
    table.insert(shapeArrayParameters,{"shape","triangle1_2_1", 2, 1, 7, 1, "triangleBottomLeftShape", 1, _, "hyroll"})
    table.insert(shapeArrayParameters,{"shape","triangle2_2_1", 2, 1, 3, 2, "triangleBottomLeftShape", 1})
    table.insert(shapeArrayParameters,{"autoFan","autoFan2_2_1", 2, 1, 3, 3, "right"} )
    table.insert(shapeArrayParameters,{"shape","triangle3_2_1", 2, 1, 6, 3, "triangleBottomLeftShape", 1, 2, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle4_2_1", 2, 1, 7, 3, "triangleTopLeftShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan3_2_1", 2, 1, 1, 4, "up"} )
    table.insert(shapeArrayParameters,{"shape","triangle5_2_1", 2, 1, 2, 4, "triangleTopRightShape", 1, 13, "breakable"})
    table.insert(shapeArrayParameters,{"backFire","backFire1_2_1", 2, 1, 4, 4, "left"} )
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"backFire1_2_1"},{"slide"},{"lightDarkBlue"},{1},{1},{2,1,4,4},{2},{2,1,4,5}})
    table.insert(shapeArrayParameters,{"autoFan","autoFan4_2_1", 2, 1, 3, 5, "down"} )
    table.insert(shapeArrayParameters,{"door","door2_2_1", 2, 1, 3, 5, "down"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan5_2_1", 2, 1, 6, 5, "left"} )


    --SCREEN 2-2
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 2, 2, 1, 1, "triangleBottomRightShape", 1})
    table.insert(shapeArrayParameters,{"door","door1_1_2", 2, 2, 4, 1, "up"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_2", 2, 2, 7, 1, "down"} )
    table.insert(shapeArrayParameters,{"autoFan","autoFan2_1_2", 2, 2, 4, 3, "up"} )
    table.insert(shapeArrayParameters,{"shape","triangle2_1_2", 2, 2, 7, 3, "triangleTopRightShape", 1})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle2_1_2"},{"slide"},{"green"},{2},{1},{2,2,5,1},{"*"},{2,2,5,3},{2},{2,2,7,3}})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 2, 2, 1, 5, "triangleTopRightShape", 1})
    table.insert(shapeArrayParameters,{"simple","simple1_1_2", 2, 2, 5, 5})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"simple1_1_2"},{"slide"},{"lightBlue"},{2},{1},{2,2,3,5},{2},{2,2,5,5}})
    table.insert(shapeArrayParameters,{"autoFan","autoFan3_1_2", 2, 2, 7, 5, "left"} )

    --SWITCHES
    table.insert(shapeArrayParameters,{"switch","switch1_2_1", 2, 1, 4, 1, { {"door-open", "door2_1_1"} }, "one-way", "not-labelled" } )
    table.insert(shapeArrayParameters,{"switch","switch1_2_1", 2, 1, 7, 4, { {"slide", "autoFan1_2_1"} }, "one-way" } )
    ...
    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 1, 4, 70})
    table.insert(shapeArrayParameters,{"item","coins", 2, 1, 1, 3, 85})
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 6, 3, 130})
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 3, 1, 65})
    table.insert(shapeArrayParameters,{"item","coins", 2, 1, 7, 2, 180})
    table.insert(shapeArrayParameters,{"item","coins", 2, 2, 3, 1, 90})
    table.insert(shapeArrayParameters,{"item","big-present", 2, 1, 3, 4, "present1_3_4", {}})
    table.insert(shapeArrayParameters,{"item","small-present", 1, 1, 4, 3, "present2_4_3", {}})
