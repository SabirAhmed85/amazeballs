...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{"simple1_1_2", "slide", {}, {{1,2,2,5},{1,2,4,5},{1,2,5,5},{1,2,6,5}}})
    ...
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{"triangle3_1_3", "slide", {}, {{1,3,2,4},{1,3,2,5}}})
