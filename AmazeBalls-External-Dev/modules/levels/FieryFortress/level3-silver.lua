...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_2_1", 1, 1, 2, 2}, "down")
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan2_2_1", 1, 1, 4, 2}, "right")
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_2_1", 1, 1, 2, 5}, "triangleTopRightShape", {1}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_2_1"},{"slide"},{"green"},{1},{1},{1,1,2,5},{2},{1,1,4,5}})
    table.insert(shapeArrayParameters, getShapeArray("door","door1_2_1", 1, 1, 7, 2}, "right"))

    --SCREEN 2-1
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_3_1", 2, 1, 3, 1}, "down")
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_3_1", 2, 1, 5, 1}, "triangleBottomLeftShape", {1}))
    table.insert(shapeArrayParameters, getShapeArray("endPoint","endPoint1_3_1", 2, 1, 7, 1}))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan2_3_1", 2, 1, 3, 2}, "down")
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan3_3_1", 2, 1, 6, 2}, "down")
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"autoFan3_3_1"},{"slide"},{"orange"},{2},{1},{2,1,5,2},{2},{2,1,6,2}})
    table.insert(shapeArrayParameters, getShapeArray("door","door2_3_1", 2, 1, 1, 3}, "left"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_3_1", 2, 1, 4, 4}, "triangleBottomLeftShape", {1}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle2_3_1"},{"slide"},{"green"},{2},{1},{2,1,3,4},{2},{2,1,4,4}})
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_3_1", 2, 1, 7, 4}, "triangleTopRightShape", {1}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle4_3_1", 2, 1, 3, 5}, "triangleTopLeftShape", {1, 6}))
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan1_3_1", 2, 1, 4, 5}, "down")
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle5_3_1", 2, 1, 5, 5}, "triangleTopRightShape", {1, _, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("simple","simple1_7_5", 2, 1, 7, 5} )
