...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle1_1_2", "slide", {"green"}, {{1,2,5,2},{1,2,6,1}})
    ...
    newTransition("triangle3_1_2", "slide", {"green"}, {{1,2,3,4},{1,2,3,3,"*"},{1,2,4,3}})
    newShape("shape","triangle4_1_2", {1, 2, 5, 3}, "triangleTopLeftShape")
    newTransition("triangle4_1_2", "slide", {"green"}, {{1,2,5,3},{1,2,6,4}})
