...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"bar1_1_1"},{"switchSlide"},{},{2},{1},{1,1,6,3},{2},{1,1,6,5}})
    ...
    addToTransitionArray(ta,{{"triangle1_1_2"},{"slide"},{"green"},{1},{1},{1,2,5,2},{2},{1,2,6,1}})
    ...
    addToTransitionArray(ta,{{"triangle3_1_2"},{"slide"},{"green"},{2},{1},{1,2,3,4},{"*"},{1,2,3,3},{2},{1,2,4,3}})
    addToShapeArray(sp, "shape","triangle4_1_2", {1, 2, 5, 3}, "triangleTopLeftShape")
    addToTransitionArray(ta,{{"triangle4_1_2"},{"slide"},{"green"},{1},{1},{1,2,5,3},{2},{1,2,6,4}})
