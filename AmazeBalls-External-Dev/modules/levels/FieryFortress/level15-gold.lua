...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("autoFan1_1_1", "slide", {"green"}, {{1,1,3,2},{1,1,4,2}})
    ...
    newTransition("autoFan1_1_2", "slide", {"orange"}, {{1,2,3,2},{1,2,3,3}})
    ...
    newTransition("triangle9_1_2", "slide", {"green"}, {{1,2,5,5},{1,2,7,5}})
