...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("autoFan3_1_1", "slide", {"orange"}, {{1,1,2,5},{1,1,3,5}})
    newShape("shape","triangle5_1_1", {1, 1, 5, 5}, "triangleTopLeftShape", {1, _, "breakable"})

    --SCREEN 2-1
    newShape("simple","simple1_1_2", {1, 2, 5, 1})
    newTransition("simple1_1_2", "slide", {"lightBlue"}, {{1,2,3,1},{1,2,5,1}})

    newShape("simple","simple2_1_2", {1, 2, 7, 2})
    newTransition("simple2_1_2", "slide", {"lightBlue"}, {{1,2,5,2},{1,2,7,2}})
    ...
    newTransition("simple3_1_2", "slide", {"lightBlue"}, {{1,2,4,3},{1,2,7,3}})

    newShape("simple","simple4_1_2", {1, 2, 6, 4})
    newTransition("simple4_1_2", "slide", {"lightBlue"}, {{1,2,1,4},{1,2,4,4},{1,2,6,4}})
