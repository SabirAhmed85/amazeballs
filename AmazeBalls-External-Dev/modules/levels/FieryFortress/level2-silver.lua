...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("autoFan2_1_1", "slide", {}, {{1,1,2,2},{1,1,3,2}})
    newShape("simple", "simple1_1_1", {1, 1, 4, 3})
    newTransition("simple1_1_1", "slide", {}, {{1,1,4,3},{1,1,5,3}})
    newShape("shape", "triangle2_1_1", {1, 1, 7, 3}, "triangleTopLeftShape", {1})
    newTransition("triangle2_1_1", "slide", {}, {{1,1,7,2},{1,1,7,3}})
    ...
    newTransition("autoFan1_1_2", "slide", {}, {{1,2,2,2},{1,2,2,3}})
    newShape("autoFan", "autoFan2_1_2", {1, 2, 4, 3}, "up")
    newShape("shape", "triangle2_1_2", {1, 2, 7, 3}, "triangleTopRightShape", {1})
    newTransition("triangle2_1_2", "slide", {}, {{1,2,5,3},{1,2,7,3}})
    newShape("simple", "simple1_1_2", {1, 2, 5, 5})
    newTransition("simple1_1_2", "slide", {}, {{1,2,3,5},{1,2,5,5}})
