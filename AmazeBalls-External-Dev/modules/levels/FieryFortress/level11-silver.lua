...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"simple1_1_1"},{"slide"},{"lightBlue"},{1},{1},{1,1,4,1},{2},{1,1,4,3},{3},{1,1,4,4},{4},{1,1,4,5}})
    ...
    addToTransitionArray(ta,{{"simple1_2_1"},{"slide"},{"lightBlue"},{1},{1},{2,1,3,3},{2},{2,1,4,2}})
    ...
    addToTransitionArray(ta,{{"triangle5_2_1"},{"slide"},{"green"},{2},{1},{2,1,5,5},{2},{2,1,6,5}})
    ...
    addToTransitionArray(ta,{{"autoFan2_3_1"},{"slide"},{"orange"},{2},{1},{3,1,4,2},{2},{3,1,5,2}})
    addToShapeArray(sp, "backFire","backFire1_3_1", {3, 1, 1, 1})
    addToTransitionArray(ta,{{"backFire1_3_1"},{"slide"},{"lightDarkBlue"},{1},{1},{3,1,1,1},{2},{3,1,1,3}})
