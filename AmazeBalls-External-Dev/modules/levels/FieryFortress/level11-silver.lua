...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("simple1_1_1", "slide", {"lightBlue"}, {{1,1,4,1},{1,1,4,3},{1,1,4,4},{1,1,4,5}})
    ...
    newTransition("simple1_2_1", "slide", {"lightBlue"}, {{2,1,3,3},{2,1,4,2}})
    ...
    newTransition("triangle5_2_1", "slide", {"green"}, {{2,1,5,5},{2,1,6,5}})
    ...
    newTransition("autoFan2_3_1", "slide", {"orange"}, {{3,1,4,2},{3,1,5,2}})
