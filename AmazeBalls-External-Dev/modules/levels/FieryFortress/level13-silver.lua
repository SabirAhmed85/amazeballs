...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("triangle3_1_1", "slide", {"green"}, {{1,1,3,3},{1,1,4,4}})
    newShape("shape","triangle4_1_1", {1, 1, 5, 3}, "triangleBottomLeftShape", {1, 2})
    newTransition("triangle4_1_1", "slide", {"green"}, {{1,1,4,1},{1,1,5,3}})
    ...
    newTransition("triangle5_1_1", "slide", {"green"}, {{1,1,7,4},{1,1,7,5}})
    newShape("shape","triangle6_1_1", {1, 1, 2, 5}, "triangleTopRightShape", {1})
    newShape("autoFan","autoFan5_1_1", {1, 1, 5, 5}, "right")
    newTransition("autoFan5_1_1", "slide", {"orange"}, {{1,1,3,5},{1,1,5,5}})
    ...
    newTransition("simple1_1_2", "slide", {"lightBlue"}, {{1,2,1,2},{1,2,3,3},{1,2,4,3},{1,2,5,3},{1,2,5,4,"*"},{1,2,7,4}})
    ...
    newTransition("autoFan2_2_2", "slide", {"orange"}, {{2,2,1,4},{2,2,1,5}})
    newShape("autoFan","autoFan3_2_2", {2, 2, 2, 4}, "up")
    newShape("autoFan","autoFan4_2_2", {2, 2, 4, 4}, "up")
    newTransition("autoFan4_2_2", "slide", {"orange"}, {{2,2,4,4},{2,2,4,5}})
    ...
    newTransition("autoFan1_1_3", "slide", {"orange"}, {{1,3,2,2},{1,3,3,1}})
    ...
    newTransition("autoFan3_1_3", "slide", {"orange"}, {{1,3,3,3},{1,3,4,3}})
    ...
    newTransition("simple1_1_3", "slide", {"lightBlue"}, {{1,3,2,5},{1,3,3,5}})
    newShape("autoFan","autoFan4_1_3", {1, 3, 5, 5}, "up")
    newTransition("autoFan4_1_3", "slide", {"orange"}, {{1,3,5,5},{1,3,6,5},{1,3,7,5}})
