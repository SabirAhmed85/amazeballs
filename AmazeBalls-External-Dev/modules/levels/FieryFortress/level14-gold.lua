...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("autoFan2_1_1", "slide", {}, {{1,1,6,1},{1,1,6,2}})
    ...
    newTransition("triangle1_1_1", "slide", {}, {{1,1,5,5},{1,1,5,4},{1,1,6,4}})
    newShape("simple", "simple1_1_1", {1, 1, 7, 4})
    newTransition("simple1_1_1", "slide", {}, {{1,1,7,2},{1,1,7,3},{1,1,7,4}})
    ...
    newTransition("triangle2_2_1", "slide", {}, {{2,1,3,2},{2,1,4,2}})
    ...
    newTransition("triangle4_2_1", "slide", {}, {{2,1,1,4},{2,1,2,4},{2,1,2,5}})
