...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"item","compass", 1, 1, 1, 2})
    table.insert(shapeArrayParameters,{"shape","bar1_1_1", 1, 1, 4, 2, "bar", "horz", 4})
    ...
    table.insert(shapeArrayParameters,{"shape","bar2_1_1", 1, 1, 7, 2, "bar", "horz", 4})
    ...
    table.insert(shapeArrayParameters,{"shape","bar4_1_1", 1, 1, 4, 3, "bar", "horz", 2})
    table.insert(shapeArrayParameters,{"autoFan","autoFan3_1_1", 1, 1, 6, 3, "right"})
    table.insert(shapeArrayParameters,{"shape","bar5_1_1", 1, 1, 1, 4, "bar", "horz"})
    table.insert(shapeArrayParameters,{"item","map", 1, 1, 1, 4})
    table.insert(shapeArrayParameters,{"shape","bar6_1_1", 1, 1, 4, 4, "bar", "horz", 4})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 6, 4, "triangleBottomRightShape", 1, 8})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 4, 5, "triangleTopRightShape", 1, 13})

    -- 1-2
    table.insert(shapeArrayParameters,{"shape","triangle1_2_1", 2, 1, 7, 1, "triangleBottomLeftShape"})
    table.insert(shapeArrayParameters,{"shape","triangle2_2_1", 2, 1, 4, 2, "triangleTopAndBottomShape", 2})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle2_2_1"},{"slide"},{"green"},{2},{1},{2,1,3,2},{2},{2,1,4,2}})
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_2_1", 2, 1, 6, 2})
    table.insert(shapeArrayParameters,{"shape","triangle3_2_1", 2, 1, 1, 3, "triangleTopRightShape", 1, 16})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_2_1", 2, 1, 2, 3, "right"})
    table.insert(shapeArrayParameters,{"shape","bar1_2_1", 2, 1, 2, 4, "bar", "vert", 3})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar1_2_1"},{"slide"},{"brown"},{1},{1},{2,1,2,4},{2},{2,1,3,4}})
    table.insert(shapeArrayParameters,{"autoFan","autoFan2_2_1", 2, 1, 4, 3, "up"})
    table.insert(shapeArrayParameters,{"shape","triangle4_2_1", 2, 1, 1, 4, "triangleTopLeftShape"})
    ...
    table.insert(shapeArrayParameters,{"autoFan","autoFan3_2_1", 2, 1, 7, 5, "left"})

    --ALL SWITCHES
    table.insert(shapeArrayParameters,{"switch","switch1_1_1", 1, 1, 2, 2, { {"slide","bar2_1_1"} } })
    ...
    --ITEMS
    table.insert(shapeArrayParameters,{"item","small-present", 2, 1, 1, 2, "present1_2_1", {} })
    --table.insert(shapeArrayParameters,{"item","coins", 1, 1, 1, 3, 90})
    --table.insert(shapeArrayParameters,{"item","coins", 2, 1, 7, 3, 90})

    --table.insert(shapeArrayParameters,{"item","something", 1, 1, 5, 2})
    --table.insert(shapeArrayParameters,{"item","something", 1, 2, 4, 3})
end
