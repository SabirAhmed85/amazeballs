...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newTransition("simple1_1_1", "slide", {"lightBlue"}, {{1,1,6,2},{1,1,7,3}})
    newShape("shape","triangle6_1_1", {1, 1, 2, 4}, "triangleTopRightShape")
    newTransition("triangle6_1_1", "slide", {"green"}, {{1,1,2,4},{1,1,4,4},{1,1,6,4}})
    newShape("shape","triangle7_1_1", {1, 1, 7, 4}, "triangleBottomLeftShape")
    newShape("simple","simple2_1_1", {1, 1, 1, 5})
    newTransition("simple2_1_1", "slide", {"lightBlue"}, {{1,1,1,4},{1,1,1,5}})
    ...
    newTransition("autoFan1_2_1", "slide", {"orange"}, {{2,1,3,1},{2,1,3,2}})
    newShape("autoFan","autoFan2_2_1", {2, 1, 5, 2}, "down")
    newTransition("autoFan2_2_1", "slide", {"orange"}, {{2,1,5,2},{2,1,6,2}})
    newShape("shape","bar1_2_1", {2, 1, 7, 2}, "bar", {"horz", 2})
    newShape("shape","triangle3_2_1", {2, 1, 7, 2}, "triangleBottomLeftShape")
    newTransition("triangle3_2_1", "slide", {"green"}, {{2,1,7,1},{2,1,7,2}})
    newShape("shape","bar1_2_1", {2, 1, 6, 3}, "bar", {"horz", 3})
    newShape("autoFan","autoFan3_2_1", {2, 1, 3, 4}, "up")
    newTransition("autoFan3_2_1", "slide", {"orange"}, {{2,1,2,4},{2,1,3,4}})
    newShape("autoFan","autoFan4_2_1", {2, 1, 5, 4}, "left")
    newTransition("autoFan4_2_1", "slide", {"orange"}, {{2,1,5,4},{2,1,5,5}})
