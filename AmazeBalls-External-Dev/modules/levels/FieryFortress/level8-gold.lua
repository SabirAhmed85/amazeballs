...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_1_1", {1, 1, 3, 1}, "triangleBottomRightShape"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_1_1", {1, 1, 6, 1}, "triangleBottomRightShape"))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan2_1_1", {1, 1, 1, 2}, "up"))
    --table.insert(shapeArrayParameters, getShapeArray("timeOut","timeOut1_1_1", {1, 1, 2, 2, 2}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle4_1_1", {1, 1, 4, 2}, "triangleBottomLeftShape"))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan3_1_1", {1, 1, 5, 2}, "up"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle5_1_1", {1, 1, 3, 3}, "triangleTopRightShape"))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan4_1_1", {1, 1, 4, 3}, "up"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle6_1_1", {1, 1, 2, 4}, "triangleTopRightShape"))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle6_1_1"},{"slide"},{"green"},{1},{1},{1,1,2,4},{2},{1,1,4,4},{3},{1,1,6,4}})
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle7_1_1", {1, 1, 7, 4}, "triangleBottomLeftShape"))
    table.insert(shapeArrayParameters, getShapeArray("simple","simple2_1_1", {1, 1, 1, 5}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"simple2_1_1"},{"slide"},{"lightBlue"},{2},{1},{1,1,1,4},{2},{1,1,1,5}})
    table.insert(shapeArrayParameters, getShapeArray("shape","bar2_1_1", {1, 1, 2, 6}, "bar", {"vert", 4}))
    table.insert(shapeArrayParameters, getShapeArray("shape","bar3_1_1", {1, 1, 4, 6}, "bar", {"vert", 2}))
    table.insert(shapeArrayParameters, getShapeArray("shape","bar4_1_1", {1, 1, 6, 6}, "bar", {"vert", 2}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_2_1", {2, 1, 1, 2}, "triangleBottomLeftShape"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan2_2_1", {2, 1, 5, 2}, "down"))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"autoFan2_2_1"},{"slide"},{"orange"},{1},{1},{2,1,5,2},{2},{2,1,6,2}})
    table.insert(shapeArrayParameters, getShapeArray("shape","bar1_2_1", {2, 1, 7, 2}, "bar", {"horz", 2}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_2_1", {2, 1, 7, 2}, "triangleBottomLeftShape"))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle3_2_1"},{"slide"},{"green"},{2},{1},{2,1,7,1},{2},{2,1,7,2}})
    table.insert(shapeArrayParameters, getShapeArray("shape","bar1_2_1", {2, 1, 6, 3}, "bar", {"horz", 3}))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan3_2_1", {2, 1, 3, 4}, "up"))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"autoFan3_2_1"},{"slide"},{"orange"},{2},{1},{2,1,2,4},{2},{2,1,3,4}})
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan4_2_1", {2, 1, 5, 4}, "left"))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"autoFan4_2_1"},{"slide"},{"orange"},{1},{1},{2,1,5,4},{2},{2,1,5,5}})
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle4_2_1", {2, 1, 1, 5}, "triangleTopAndBottomShape", {1}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle5_2_1", {2, 1, 7, 5}, "triangleTopRightShape"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("gem","purpleCoin", {1, 1, 6, 5}, "purpleCoin"))

    table.insert(shapeArrayParameters, getShapeArray("item","coins", {1, 1, 5, 3, 350}) 
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {2, 1, 4, 1}, 50)) 
    table.insert(shapeArrayParameters, getShapeArray("item","small-present", {2, 1, 1, 3}, {}))

    table.insert(shapeArrayParameters, getShapeArray("item","big-present", {2, 1, 6, 3}, {}))

    table.insert(shapeArrayParameters, getShapeArray("item","coins", {2, 1, 7, 4}, 70)) 
