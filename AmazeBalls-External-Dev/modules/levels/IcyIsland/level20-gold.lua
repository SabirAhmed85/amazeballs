...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters,{"shape","bar1_1_1", 1, 1, 5, 1, "bar", "vert", 3})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 2, 4, "triangleTopRightShape"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_1", 1, 1, 3, 4, "triangleTopLeftShape"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan2_1_1", 1, 1, 6, 4, "right"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"autoFan2_1_1"},{"switchSlide"},{},{2},{1},{1,1,5,4},{2},{1,1,6,4}})
    table.insert(shapeArrayParameters,{"manualFan","manualFan2_1_1", 1, 1, 7, 4, "up"})
    table.insert(shapeArrayParameters,{"shape","bar3_1_1", 1, 1, 8, 4, "bar", "horz", 2})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_1", 1, 1, 4, 5, "triangleTopRightShape"})
    table.insert(shapeArrayParameters,{"shape","triangle5_1_1", 1, 1, 6, 5, "triangleTopRightShape", 1, 13})
    ...
    table.insert(shapeArrayParameters,{"shape","bar3_1_2", 1, 2, 4, 3, "bar", "vert"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 1, 2, 5, 3, "triangleBottomRightShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_2", 1, 2, 6, 3, "left"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"autoFan1_1_2"},{"switchSlide"},{},{1},{1},{1,2,6,3},{2},{1,2,7,4}})
    table.insert(shapeArrayParameters,{"door","door1_1_2", 1, 2, 4, 5, "down"})

    --SCREEN 1-3
    table.insert(shapeArrayParameters,{"shape","bar1_1_3", 1, 3, 1, 1, "bar", "vert", 3})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_3", 1, 3, 2, 1, "triangleBottomRightShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_3", 1, 3, 7, 1, "triangleBottomLeftShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_3", 1, 3, 3, 3, "triangleBottomLeftShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_3", 1, 3, 7, 3, "triangleTopRightShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_3", 1, 3, 1, 4, "triangleTopRightShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_3", 1, 3, 1, 5, "left"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_3", 1, 3, 3, 5, "triangleTopLeftShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_1_3", 1, 3, 4, 5})

    --SWITCHES
    table.insert(shapeArrayParameters,{"switch","switch1_1_1", 1, 1, 5, 2, { {"slide","autoFan2_1_1"},{"door-open","door1_1_1"} }, "one-way" })
    ...
    table.insert(shapeArrayParameters,{"gem","purple", 1, 3, 6, 1, "purple"})
    ...
    table.insert(shapeArrayParameters,{"gem","blueCoin", 1, 3, 1, 1, "blueCoin"})
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 1, 2, 5, 2, "purpleCoin"})
    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 4, 3, 330})
    table.insert(shapeArrayParameters,{"item","coins", 1, 3, 5, 4, 405})
    table.insert(shapeArrayParameters,{"item","small-present", 1, 2, 1, 4, {}})
    table.insert(shapeArrayParameters,{"item","small-present", 1, 3, 2, 3, {}})
    table.insert(shapeArrayParameters,{"item","characterSpecial", 1, 3, 3, 4, {}})
    table.insert(shapeArrayParameters,{"item","hook", 1, 1, 4, 3, {}})
