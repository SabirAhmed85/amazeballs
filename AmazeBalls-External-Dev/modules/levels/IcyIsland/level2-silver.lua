...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"shape","triangle3_1_1", 1, 1, 3, 3, "triangleBottomLeftShape", 1, _, "breakable"})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle5_1_1", 1, 1, 5, 5, "triangleTopLeftShape", 1, _, "icy"})

    --SCREEN 1-2
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 1, 2, 4, 1, "triangleBottomRightShape"})
    table.insert(shapeArrayParameters,{"spitter","spitter1_1_2", 1, 2, 7, 1, "none","none","none","left"})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_2", 1, 2, 1, 2, "triangleBottomRightShape"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 1, 2, 5, 2, "triangleTopLeftShape", 1, 11, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_2", 1, 2, 5, 3, "triangleBottomLeftShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle5_1_2", 1, 2, 1, 4, "triangleTopRightShape"})
    table.insert(shapeArrayParameters,{"shape","triangle6_1_2", 1, 2, 5, 4, "triangleTopLeftShape", 1, 5, "breakable"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_2", 1, 2, 2, 5, "left"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"autoFan1_1_2"},{"slide"},{},{1},{1},{1,2,2,5},{"*"},{1,2,2,4},{2},{1,2,4,4}})
    table.insert(shapeArrayParameters,{"spitter","spitter2_1_2", 1, 2, 4, 5, "none","right","none","none"})
    table.insert(shapeArrayParameters,{"door","door1_1_2", 1, 2, 5, 5, "down"})
    table.insert(shapeArrayParameters,{"shape","triangle7_1_2", 1, 2, 7, 5, "triangleTopLeftShape"})

    --SCREEN 1-3
    table.insert(shapeArrayParameters,{"shape","triangle1_1_3", 1, 3, 2, 1, "triangleBottomRightShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_3", 1, 3, 6, 1, "triangleTopRightShape", 1, 16})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_3", 1, 3, 7, 1, "triangleBottomLeftShape"})
    table.insert(shapeArrayParameters,{"spitter","spitter1_1_3", 1, 3, 6, 2, "up","none","none","none"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"spitter1_1_3"},{"slide"},{},{2},{1},{1,3,5,2},{2},{1,3,6,2}})
    table.insert(shapeArrayParameters,{"spitter","spitter2_1_3", 1, 3, 2, 3, "up","none","down","none"})
    table.insert(shapeArrayParameters,{"spitter","spitter3_1_3", 1, 3, 6, 4, "none","none","down","none"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"spitter3_1_3"},{"slide"},{},{2},{1},{1,3,5,4},{2},{1,3,6,4}})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_3", 1, 3, 2, 5, "triangleTopRightShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_3", 1, 3, 5, 5, "up"})
    ...
    table.insert(shapeArrayParameters,{"gem","blueCoin", 1, 3, 4, 1, "blueCoin"})
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 1, 1, 4, 5, "purpleCoin"})

    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 2, 1, 220})
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 5, 5, 90})
    table.insert(shapeArrayParameters,{"item","coins", 1, 3, 6, 3, 340})
    ...
    table.insert(shapeArrayParameters,{"item","small-present", 1, 3, 3, 1, {}})
    table.insert(shapeArrayParameters,{"item","hook", 1, 1, 1, 4, {}})
    table.insert(shapeArrayParameters,{"item","characterSpecial", 1, 2, 4, 2, {}})
    table.insert(shapeArrayParameters,{"item","dummyBall", 1, 3, 4, 5, {}})
