...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle2_1_1"},{"slide"},{},{1},{1},{1,1,5,1},{"*"},{1,1,5,2},{2},{1,1,6,2}})
    ...
    addToTransitionArray(ta,{{"triangle1_2_1"},{"slide"},{},{1},{1},{2,1,2,1},{2},{2,1,2,2}})
    addToShapeArray(sp, "shape","triangle2_2_1", {2, 1, 7, 1}, "triangleBottomRightShape", {1, 3})
    addToTransitionArray(ta,{{"triangle2_2_1"},{"slide"},{},{3},{1},{2,1,3,3},{2},{2,1,4,2},{"*"},{2,1,4,1},{3},{2,1,7,1}})
    ...
    addToTransitionArray(ta,{{"triangle7_2_1"},{"slide"},{},{2},{1},{2,1,7,3},{2},{2,1,7,5}})
