...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle4_2_1"},{"slide"},{},{1},{1},{2,1,5,3},{2},{2,1,7,3},{3},{2,1,7,1}})
    addToShapeArray(sp, "door","door2_2_1", {2, 1, 1, 4}, "left")
    addToShapeArray(sp, "autoFan","autoFan2_2_1", {2, 1, 3, 4}, "left")
    addToTransitionArray(ta,{{"autoFan2_2_1"},{"slide"},{},{1},{1},{2,1,3,4},{2},{2,1,4,4}})
    addToShapeArray(sp, "simple","simple1_2_1", {2, 1, 6, 4})
    addToTransitionArray(ta,{{"simple1_2_1"},{"slide"},{},{1},{1},{2,1,6,4},{2},{2,1,7,4}})
