...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_1", 1, 1, 6, 1, "left"})
    ...
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_1", 1, 1, 5, 4, "left"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan2_1_1", 1, 1, 4, 5, "up"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"autoFan1_1_1"},{"slide"},{},{2},{1},{1,1,4,4},{2},{1,1,4,5}})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_1", 1, 1, 2, 5, "triangleTopRightShape", 1, _, "breakable"})

    --SCREEN 1-2
    table.insert(shapeArrayParameters,{"door","door1_1_2", 1, 2, 1, 1, "up"})
    table.insert(shapeArrayParameters,{"shape","bar1_1_2", 1, 2, 5, 1, "bar", "vert", 3})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 1, 2, 1, 2, "triangleBottomLeftShape", 1, 2, "breakable"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_2", 1, 2, 6, 2, "down"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"manualFan1_1_2"},{"slide"},{},{2},{1},{1,2,5,2},{2},{1,2,6,2}})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_2", 1, 2, 5, 3, "triangleTopRightShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"door","door1_1_2", 1, 2, 7, 3, "right"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 1, 2, 1, 4, "triangleBottomLeftShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"shape","bar2_1_2", 1, 2, 2, 4, "bar", "horz", 3})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_2", 1, 2, 4, 5, "up"})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle1_2_2", 2, 2, 6, 1, "triangleBottomRightShape", 1, 9, "breakable"})
    table.insert(shapeArrayParameters,{"item","map", 2, 2, 4, 3})
    table.insert(shapeArrayParameters,{"door","door1_2_2", 2, 2, 1, 4, "left"})
    table.insert(shapeArrayParameters,{"shape","bar1_2_2", 2, 2, 3, 4, "bar", "horz", 3})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar1_2_2"},{"slide"},{},{3},{1},{2,2,3,1},{2},{2,2,3,2},{3},{2,2,3,4}})
    table.insert(shapeArrayParameters,{"shape","triangle2_2_2", 2, 2, 6, 4, "triangleTopRightShape", 1, _, "breakable"})
    ...
    table.insert(shapeArrayParameters,{"gem","blueCoin", 2, 2, 7, 4, "blueCoin"})
    ...
    table.insert(shapeArrayParameters,{"item","big-present", 1, 1, 7, 5, {}})
    table.insert(shapeArrayParameters,{"item","small-present", 2, 2, 7, 1, {}})
