...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"manualFan","manualFan2_1_1", 1, 1, 3, 1, "down"})
    ...
    table.insert(shapeArrayParameters,{"shape","bar1_1_1", 1, 1, 8, 2, "bar", "horz", 2})
    table.insert(shapeArrayParameters,{"autoFan","autoFan3_1_1", 1, 1, 2, 3, "right"})
    table.insert(shapeArrayParameters,{"shape","bar2_1_1", 1, 1, 8, 3, "bar", "horz", 2})
    table.insert(shapeArrayParameters,{"autoFan","autoFan4_1_1", 1, 1, 3, 4, "right"})
    table.insert(shapeArrayParameters,{"shape","bar3_1_1", 1, 1, 8, 4, "bar", "horz", 2})
    table.insert(shapeArrayParameters,{"autoFan","autoFan5_1_1", 1, 1, 4, 5, "right"})
    table.insert(shapeArrayParameters,{"shape","bar4_1_1", 1, 1, 8, 5, "bar", "horz", 2})
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_1_1", 1, 1, 4, 2})
    table.insert(shapeArrayParameters,{"autoFan","autoFan6_1_1", 1, 1, 7, 5, "up"})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 1, 2, 2, 4, "triangleTopLeftShape", 1, 6, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_2", 1, 2, 4, 4, "triangleTopRightShape", 1, 13, "breakable"})

    --SCREEN 1-3
    table.insert(shapeArrayParameters,{"door","door1_1_3", 1, 3, 3, 1, "up"})
    table.insert(shapeArrayParameters,{"spitter","spitter1_1_3", 1, 3, 3, 1, "up","none","down","none"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"spitter1_1_3"},{"switchSlide"},{},{1},{1},{1,3,3,1},{2},{1,3,4,1}})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_3", 1, 3, 4, 2, "right"})
    table.insert(shapeArrayParameters,{"shape","bar1_1_3", 1, 3, 6, 2, "bar", "horz", 2})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar1_1_3"},{"slide"},{},{1},{1},{1,3,6,2},{2},{1,3,6,4}})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_3", 1, 3, 6, 2, "down"})
    --table.insert(shapeArrayParameters,{"item","coins", 1, 3, 6, 4, 250})
    table.insert(shapeArrayParameters,{"autoFan","autoFan2_1_3", 1, 3, 4, 4, "up"})
    table.insert(shapeArrayParameters,{"shape","bar2_1_3", 1, 3, 6, 4, "bar", "vert", 4})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar2_1_3"},{"slide"},{},{2},{1},{1,3,4,4},{2},{1,3,6,4}})
    table.insert(shapeArrayParameters,{"manualFan","manualFan2_1_3", 1, 3, 6, 4, "left"})
    table.insert(shapeArrayParameters,{"gem","purple1", 1, 3, 4, 5, "purple"})
    table.insert(shapeArrayParameters,{"shape","bar3_1_3", 1, 3, 6, 5, "bar", "vert", 2})

    --SWITCHES
    table.insert(shapeArrayParameters,{"switch","switch1_1_3", 1, 3, 5, 2, { {"slide","spitter1_1_3"} } })
    ...
    table.insert(shapeArrayParameters,{"gem","redCoin", 1, 1, 3, 3, "redCoin"})
    table.insert(shapeArrayParameters,{"gem","blueCoin", 1, 3, 3, 4, "blueCoin"})
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 1, 2, 7, 2, "purpleCoin"})
    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 2, 2, 270})
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 3, 1, 85})
    table.insert(shapeArrayParameters,{"item","coins", 1, 3, 3, 2, 50})
    table.insert(shapeArrayParameters,{"item","big-present", 1, 2, 2, 5, {}})
    table.insert(shapeArrayParameters,{"item","small-present", 1, 2, 7, 3, {}})
    table.insert(shapeArrayParameters,{"item","dummyBall", 1, 2, 1, 5, {}})
