...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle1_1_1"},{"slide"},{},{3},{1},{1,1,6,3},{2},{1,1,6,2},{3},{1,1,7,1}})
    ...
    addToTransitionArray(ta,{{"autoFan4_1_1"},{"slide"},{},{2},{1},{1,1,5,3},{2},{1,1,5,5}})
    ...
    addToTransitionArray(ta,{{"triangle2_2_1"},{"slide"},{},{3},{1},{2,1,3,4},{2},{2,1,4,4},{3},{2,1,5,4}})
    ...
    addToTransitionArray(ta,{{"autoFan1_3_1"},{"autoSlide"},{timePerSquare = 480, pauseTime = 0},{2},{1},{3,1,5,3},{2},{3,1,5,5}})
