...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","bar1_1_1", {1, 1, 6, 1}, "bar", {"vert", 3}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_1_1", {1, 1, 4, 4, "triangleBottomLeftShape"}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_1_1"},{"slide"},{},{1},{1},{1,1,4,4},{2},{1,1,5,4}})
    table.insert(shapeArrayParameters, getShapeArray("shape","bar3_1_1", {1, 1, 5, 3}, "bar", {"vert", 3}))
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan1_1_1", {1, 1, 7, 4}, "up"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("item","map", {1, 1, 6, 5}))
    table.insert(shapeArrayParameters, getShapeArray("spitter","spitter1_1_1", {1, 1, 5, 5, "up", "none", "none", "none"}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("simple","simple1_1_2", {1, 2, 6, 2}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"simple1_1_2"},{"switchSlide"},{},{2},{1},{1,2,5,2},{2},{1,2,6,2}})
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan1_1_2", {1, 2, 5, 3}, "up"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_1_2", {1, 2, 3, 4}, "triangleBottomRightShape", {1, _, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_1_2", {1, 2, 5, 4}, "triangleBottomLeftShape", {1, 4, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_1_2", {1, 2, 6, 4}, "triangleBottomRightShape", {1, 3, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("door","door2_1_2", {1, 2, 7, 4}, "right"))

    --SCREEN 2-2
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_2_2", {2, 2, 1, 2}, "triangleBottomRightShape", {1, _, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","bar1_2_2", {2, 2, 4, 2}, "bar", {"horz", 4}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar1_2_2"},{"slide"},{},{1},{1},{2,2,4,2},{2},{2,2,4,3}})
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_2_2", {2, 2, 5, 2}, "triangleBottomLeftShape", {1, _, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","bar2_2_2", {2, 2, 6, 2}, "bar", {"horz", 3}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_2_2", {2, 2, 7, 2, "triangleBottomLeftShape"}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle3_2_2"},{"slide"},{},{1},{1},{2,2,7,2},{2},{2,2,7,3}})
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle4_2_2", {2, 2, 2, 3}, "triangleTopRightShape", {1, _, "icy"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","bar3_2_2", {2, 2, 1, 4}, "bar", {"horz", 2}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar3_2_2"},{"switchSlide"},{},{2},{1},{2,2,1,2},{2},{2,2,1,4}})
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_2_2", {2, 2, 1, 4}, "up"))
    table.insert(shapeArrayParameters, getShapeArray("endPoint","endPoint1_2_2", {2, 2, 2, 4}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle5_2_2", {2, 2, 5, 5}, "triangleTopRightShape", {1, _, "icy"}))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan2_2_2", {2, 2, 7, 5}, "up"))

    --SWITCHES
    table.insert(shapeArrayParameters, getShapeArray("switch","switch1_1_1", {1, 1, 5, 1, { {"slide","simple1_1_2"},{"slide","manualFan1_1_2"},{"door-open","door1_1_1"},{"slide","bar3_2_2"} }, "one-way" })
    ...
    table.insert(shapeArrayParameters, getShapeArray("gem","redCoin", {2, 2, 4, 2}, "redCoin"))
    table.insert(shapeArrayParameters, getShapeArray("gem","blueCoin", {1, 1, 5, 3}, "blueCoin"))
    table.insert(shapeArrayParameters, getShapeArray("gem","purpleCoin", {1, 2, 3, 3}, "purpleCoin"))
    --ITEMS
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {1, 1, 1, 5}, 220))
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {2, 2, 2, 2}, 130))
    table.insert(shapeArrayParameters, getShapeArray("item","big-present", 1, 2, 3, 2, {}})
    table.insert(shapeArrayParameters, getShapeArray("item","small-present", {1, 1, 7, 1, {}})
    table.insert(shapeArrayParameters, getShapeArray("item","dummyBall", 1, 2, 1, 4, {}})
    table.insert(shapeArrayParameters, getShapeArray("item","bomb", 1, 1, 4, 5, {}})
end
