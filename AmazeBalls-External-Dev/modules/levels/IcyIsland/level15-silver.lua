...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","bar2_1_1", {1, 1, 1, 2}, "bar", {"horz"}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_1_1", {1, 1, 5, 3}, "triangleTopRightShape"))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_1_1"},{"flip-horizontal"}})
    table.insert(shapeArrayParameters, getShapeArray("shape","bar4_1_1", {1, 1, 4, 4}, "bar", {"vert", 4}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_1_1", {1, 1, 7, 5}, "triangleBottomRightShape", {1, 3, "breakable"}))

    --SCREEN 1-2
    table.insert(shapeArrayParameters, getShapeArray("spitter","spitter1_1_2", {1, 2, 3, 1}, {"none", "none", "down", "none"}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"spitter1_1_2"},{"slide"},{},{2},{1},{1,2,2,1},{2},{1,2,3,1}})
    table.insert(shapeArrayParameters, getShapeArray("spitter","spitter2_1_2", {1, 2, 4, 2}, {"none", "none", "down", "none"}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"spitter2_1_2"},{"slide"},{},{1},{1},{1,2,4,2},{2},{1,2,5,2}})
    table.insert(shapeArrayParameters, getShapeArray("shape","bar1_1_2", {1, 2, 3, 3}, "bar", {"vert", 4}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar1_1_2"},{"autoSlide"},{},{2},{1},{1,2,2,3},{2},{1,2,3,3}})
    table.insert(shapeArrayParameters, getShapeArray("shape","bar2_1_2", {1, 2, 5, 4}, "bar", {"vert", 2}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("spitter","spitter3_1_2", {1, 2, 5, 5, "up", "none", "none", "none"}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"spitter3_1_2"},{"slide"},{},{2},{1},{1,2,3,5},{2},{1,2,5,5}})


    --SWITCHES
    table.insert(shapeArrayParameters, getShapeArray("switch","switch1_1_1", {1, 1, 6, 5}, { {"slide","manualFan1_1_1"} }))
    ...
    --ITEMS
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {1, 1, 2, 3}, 50))
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {1, 1, 7, 1}, 500))
    table.insert(shapeArrayParameters, getShapeArray("item","small-present", {1, 1, 1, 4}, {}))

    table.insert(shapeArrayParameters, getShapeArray("item","big-present", {1, 2, 2, 4}, {}))
