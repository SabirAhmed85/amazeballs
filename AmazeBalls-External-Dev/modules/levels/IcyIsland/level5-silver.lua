...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_1_1", {1, 1, 4, 1}, "up"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_1_1", {1, 1, 3, 2}, "triangleBottomLeftShape", {1, _, "breakable"}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("spitter","spitter1_1_1", {1, 1, 7, 3}, {"none","none","none","left"}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"spitter1_1_1"},{"slide"},{},{3},{1},{1,1,7,1},{2},{1,1,7,2},{3},{1,1,7,3}})
    table.insert(shapeArrayParameters, getShapeArray("backFire","backFire1_1_1", {1, 1, 2, 4}, "up"))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"backFire1_1_1"},{"slide"},{},{3},{1},{1,1,1,2},{2},{1,1,2,3},{3},{1,1,2,4}})
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan2_1_1", {1, 1, 3, 4}, "right"))
    table.insert(shapeArrayParameters, getShapeArray("shape","bar2_1_1", {1, 1, 4, 4}, "bar", {"vert", 4}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar2_1_1"},{"switchSlide"},{},{2},{1},{1,1,3,4},{2},{1,1,4,4}})
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_1_1", {1, 1, 5, 4}, "triangleBottomLeftShape", {1, 3, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan3_1_1", {1, 1, 6, 4}, "down"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_1_1", {1, 1, 7, 4}, "triangleTopLeftShape", {1, 3}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle2_1_1"},{"slide"},{},{1},{1},{1,1,7,4},{2},{1,1,7,5}})
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan4_1_1", {1, 1, 3, 5}, "right"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_2_1", {2, 1, 3, 3}, "triangleBottomLeftShape", {1, 4, "breakable"}))

    --SCREEN 1-2
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_1_2", {1, 2, 2, 1}, "triangleBottomLeftShape", {1, 4, "breakable"}))
    ...
    --SWITCHES
    table.insert(shapeArrayParameters, getShapeArray("switch","switch1_1_1", {1, 1, 3, 3}, { {"slide","bar1_1_1"},{"slide","bar2_1_1"} }))
    ...
    table.insert(shapeArrayParameters, getShapeArray("gem","blueCoin", {1, 2, 2, 5}, "blueCoin"))
    table.insert(shapeArrayParameters, getShapeArray("gem","purpleCoin", {1, 1, 1, 5}, "purpleCoin"))

    --ITEMS
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {1, 1, 1, 4, 235}))
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {1, 2, 4, 1}, 170))
    ...
    table.insert(shapeArrayParameters, getShapeArray("item","hook", {2, 1, 6, 3}, {}))
    table.insert(shapeArrayParameters, getShapeArray("item","dummyBall", {1, 2, 2, 2}, {}))
