...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle1_1_1"},{"slide"},{},{2},{1},{1,1,3,1},{2},{1,1,3,2}})
    addToShapeArray(sp, "shape","triangle2_1_1", {1, 1, 7, 3}, "triangleBottomRightShape")
    addToTransitionArray(ta,{{"triangle2_1_1"},{"slide"},{},{1},{1},{1,1,7,3},{2},{1,1,7,4}})
    ...
    addToTransitionArray(ta,{{"triangle1_1_2"},{"slide"},{},{1},{1},{1,2,1,1},{2},{1,2,1,2}})
    ...
    addToTransitionArray(ta,{{"autoFan1_1_1"},{"slide"},{},{1},{1},{1,2,1,4},{2},{1,2,2,4}})
    addToShapeArray(sp, "autoFan","autoFan2_1_2", {1, 2, 5, 4}, "right")
    addToTransitionArray(ta,{{"autoFan2_1_1"},{"slide"},{},{2},{1},{1,2,4,5},{"*"},{1,2,4,4},{2},{1,2,5,4},{3},{1,2,6,2}})
