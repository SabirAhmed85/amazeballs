...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters, getShapeArray("shape","bar1_1_1", {1, 1, 2, 1}, "bar", {"horz", 2}))
    table.insert(shapeArrayParameters, getShapeArray("endPoint","endPoint1_1_2", 1, 1, 2, 1}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("backFire","backFire1_1_1", {1, 1, 7, 3}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_1_1", {1, 1, 4, 5}, "triangleTopRightShape", {1, _, "fire"}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","bar2_1_1", {1, 1, 2, 6}, "bar", {"vert", 2}))

    --SCREEN 2-1
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan1_2_1", {2, 1, 2, 1}, "left"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_2_1", {2, 1, 3, 1}, "triangleBottomRightShape", {1, _, "icy"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","bar1_2_1", {2, 1, 2, 2}, "bar", {"vert", 2}))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_2_1", {2, 1, 3, 2}, "right"))
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan2_2_1", {2, 1, 5, 2}, "up"))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan2_2_1", {2, 1, 6, 2}, "down"))
    table.insert(shapeArrayParameters, getShapeArray("door","door1_2_1", {2, 1, 1, 3}, "left"))
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan3_2_1", {2, 1, 4, 3}, "left"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_2_1", {2, 1, 3, 4}, "triangleBottomRightShape"))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle2_2_1"},{"slide"},{},{1},{1},{2,1,3,4},{2},{2,1,5,5}})
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan3_2_1", {2, 1, 6, 4}, "right"))
    table.insert(shapeArrayParameters, getShapeArray("door","door1_2_1", {2, 1, 7, 4}, "right"))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan4_2_1", {2, 1, 2, 5}, "down"))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan5_2_1", {2, 1, 4, 5}, "down"))

    --SCREEN 2-2
    table.insert(shapeArrayParameters, getShapeArray("door","door1_2_2", 3, 1, 1, 1}, "left"))
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan1_2_2", 3, 1, 3, 1}, "down"))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_2_2", 3, 1, 7, 1}, "left"))
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan2_2_2", 3, 1, 1, 2}, "down"))
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan3_2_2", 3, 1, 4, 2}, "left"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_2_2", 3, 1, 5, 2}, "triangleBottomRightShape"))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_2_2"},{"slide"},{},{3},{1},{3,1,4,4},{"*"},{3,1,4,3},{2},{3,1,5,3},{3},{3,1,5,2}})
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan2_2_2", 3, 1, 6, 2}, "up"))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"autoFan2_2_2"},{"slide"},{},{1},{1},{3,1,6,2},{"*"},{3,1,6,3},{2},{3,1,7,3}})
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan3_2_2", 3, 1, 3, 3}, "left"))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan4_2_2", 3, 1, 7, 4}, "up"))
    table.insert(shapeArrayParameters, getShapeArray("door","door2_2_2", 3, 1, 1, 5}, "left"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_2_2", 3, 1, 1, 5}, "triangleTopLeftShape"))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan5_2_2", 3, 1, 5, 5}, "left"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("gem","purple", {3, 1, 7, 5}, "purple"))
    table.insert(shapeArrayParameters, getShapeArray("gem","redCoin", {2, 1, 1, 1}, "redCoin"))
    table.insert(shapeArrayParameters, getShapeArray("gem","blueCoin", {1, 1, 1, 1}, "blueCoin"))
    table.insert(shapeArrayParameters, getShapeArray("gem","purpleCoin", {3, 1, 2, 3}, "purpleCoin"))
    --ITEMS
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {1, 1, 3, 5, 120})
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {2, 1, 5, 3, 140})
    table.insert(shapeArrayParameters, getShapeArray("item","small-present", {3, 1, 1, 4, {}})
    table.insert(shapeArrayParameters, getShapeArray("item","clock", 1, 1, 4, 2, {}})
