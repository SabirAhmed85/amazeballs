...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    newShape("manualFan","manualFan1_3_1", {3, 1, 3, 1}, "down")
    newShape("autoFan","autoFan1_3_1", {3, 1, 7, 1}, "left")
    newShape("manualFan","manualFan2_3_1", {3, 1, 1, 2}, "down")
    newShape("manualFan","manualFan3_3_1", {3, 1, 4, 2}, "left")
    newShape("shape","triangle1_3_1", {3, 1, 5, 2}, "triangleBottomRightShape")
    newTransition("triangle1_2_2", "slide", {}, {{3,1,4,4},{3,1,4,3,"*"},{3,1,5,3},{3,1,5,2}})
    newShape("autoFan","autoFan2_3_1", {3, 1, 6, 2}, "up")
    newTransition("autoFan2_2_2", "slide", {}, {{3,1,6,2},{3,1,6,3,"*"},{3,1,7,3}})
    newShape("autoFan","autoFan3_3_1", {3, 1, 3, 3}, "left")
    newShape("autoFan","autoFan4_3_1", {3, 1, 7, 4}, "up")
    newShape("door","door2_3_1", {3, 1, 1, 5}, "left")
    newShape("shape","triangle2_3_1", {3, 1, 1, 5}, "triangleTopLeftShape")
    newShape("autoFan","autoFan5_3_1", {3, 1, 5, 5}, "left")
