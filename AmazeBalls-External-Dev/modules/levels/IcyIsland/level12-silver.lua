...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"triangle1_1_1"},{"slide"},{},{1},{1},{1,1,1,1},{2},{1,1,1,2}})
    ...
    addToTransitionArray(ta,{{"bar1_1_1"},{"slide"},{},{2},{1},{1,1,5,2},{2},{1,1,6,2}})
    addToShapeArray(sp, "autoFan","autoFan2_1_1", {1, 1, 7, 2}, "down")
    addToTransitionArray(ta,{{"autoFan2_1_1"},{"slide"},{},{1},{1},{1,1,7,1},{2},{1,1,7,2}})
    ...
    addToTransitionArray(ta,{{"bar2_1_1"},{"slide"},{},{2},{1},{1,1,3,2},{2},{1,1,3,4}})
    ...
    addToTransitionArray(ta,{{"bar1_1_2"},{"slide"},{},{2},{1},{1,2,4,3},{2},{1,2,4,4}})
