...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"tunnel1_1_1"},{"slide"},{},{2},{1},{1,1,1,2},{2},{1,1,3,1}})
    ...
    addToTransitionArray(ta,{{"tunnel2_1_1"},{"slide"},{},{2},{1},{1,1,1,3},{2},{1,1,2,3}})
    ...
    addToTransitionArray(ta,{{"tunnel3_1_1"},{"slide"},{},{2},{1},{1,1,1,4},{2},{1,1,3,4}})
    ...
    addToTransitionArray(ta,{{"triangle3_1_1"},{"flip-vertical"}})
    addToShapeArray(sp, "manualFan","manualFan3_1_1", {1, 1, 2, 5}, "down")
    addToTransitionArray(ta,{{"manualFan3_1_1"},{"slide"},{},{1},{1},{1,1,2,5},{2},{1,1,4,5}})
    ...
    addToTransitionArray(ta,{{"triangle2_2_1"},{"slide"},{},{1},{1},{2,1,5,2},{2},{2,1,7,1}})
    ...
    addToTransitionArray(ta,{{"manualFan4_2_1"},{"slide"},{},{2},{1},{2,1,6,5},{2},{2,1,7,5}})
