...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 1, 2, "triangleBottomRightShape"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_1_1"},{"slide"},{},{2},{1},{1,1,1,1},{2},{1,1,1,2}})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_1", 1, 1, 3, 2, "up"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"autoFan1_1_1"},{"slide"},{},{2},{1},{1,1,3,1},{2},{1,1,3,2}})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 1, 3, "triangleTopRightShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_1", 1, 1, 3, 3, "triangleBottomRightShape", 1, 9})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle3_1_1"},{"slide"},{},{1},{1},{1,1,3,3},{2},{1,1,3,4}})
    table.insert(shapeArrayParameters,{"spitter","spitter1_1_1", 1, 1, 4, 3, "up","none","none","left"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_1", 1, 1, 6, 3, "down"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"manualFan1_1_1"},{"slide"},{},{2},{1},{1,1,6,1},{2},{1,1,6,3},{3},{1,1,7,4}})
    table.insert(shapeArrayParameters,{"shape","bar1_1_1", 1, 1, 2, 4, "bar", "horz", 2})
    table.insert(shapeArrayParameters,{"door","door1_1_1", 1, 1, 7, 5, "down"})

    --SCREEN 1-2
    table.insert(shapeArrayParameters,{"shape","bar1_1_2", 1, 2, 4, 2, "bar", "horz", 2})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 1, 2, 5, 2, "triangleBottomLeftShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 1, 2, 3, 5, "triangleTopLeftShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 1, 2, 4, 5, "triangleTopRightShape", 1, 10, "breakable"})
    table.insert(shapeArrayParameters,{"door","door1_1_2", 1, 2, 5, 5, "down"})

    --SCREEN 1-3
    table.insert(shapeArrayParameters,{"shape","triangle1_1_3", 1, 3, 2, 1, "triangleBottomRightShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"shape","bar1_1_3", 1, 3, 4, 1, "bar", "horz", 2})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar1_1_3"},{"slide"},{},{1},{1},{1,3,4,1},{2},{1,3,4,5}})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_3", 1, 3, 6, 1, "triangleTopRightShape", 1, 16, "icy"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_3", 1, 3, 7, 1, "triangleBottomLeftShape", 1, _, "icy"})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle4_1_3", 1, 3, 2, 5, "triangleTopRightShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_3", 1, 3, 5, 5, "up"})
    table.insert(shapeArrayParameters,{"shape","bar2_1_3", 1, 3, 6, 5, "bar", "vert", 2})
    ...
    table.insert(shapeArrayParameters,{"gem","blueCoin", 1, 3, 6, 3, "blueCoin"})
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 1, 2, 4, 2, "purpleCoin"})

    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 6, 4, 375})
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 2, 5, 130})
    table.insert(shapeArrayParameters,{"item","coins", 1, 3, 4, 5, 85})
    table.insert(shapeArrayParameters,{"item","small-present", 1, 1, 2, 2, {} })
    table.insert(shapeArrayParameters,{"item","small-present", 1, 2, 2, 2, {} })
