...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 4, 1, "triangleLeftAndRightShape", 2})
    table.insert(shapeArrayParameters,{"shape","bar1_1_1", 1, 1, 1, 2, "bar", "horz", 3})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 5, 2, "triangleBottomRightShape"})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle2_2_1", 2, 1, 7, 2, "triangleTopRightShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"shape","bar2_2_1", 2, 1, 8, 2, "bar", "horz"})
    table.insert(shapeArrayParameters,{"spitter","spitter1_2_1", 2, 1, 3, 3, "none", "right", "none", "left"})
    ...
    --table.insert(shapeArrayParameters,{"item","coins", 2, 1, 6, 4, 100})
    table.insert(shapeArrayParameters,{"shape","triangle2_2_1", 2, 1, 2, 5, "triangleTopRightShape", 1, 1, "breakable"})
    ...
    table.insert(shapeArrayParameters,{"spitter","spitter1_2_2", 2, 2, 7, 4, "up", "right", "none", "none"})


    --SWITCHES
    table.insert(shapeArrayParameters,{"switch","switch1_1_1", 1, 1, 7, 4, { {"door-open","door1_2_1"} } })
    ...
    table.insert(shapeArrayParameters,{"gem","redCoin", 2, 1, 6, 4, "redCoin"})
    table.insert(shapeArrayParameters,{"gem","blueCoin", 2, 1, 2, 1, "blueCoin"})
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 2, 2, 5, 4, "purpleCoin"})

    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 7, 3, 445})
    ...
    table.insert(shapeArrayParameters,{"item","small-present", 2, 2, 4, 4, {}})
    table.insert(shapeArrayParameters,{"item","characterSpecial", 2, 2, 7, 1, {}})
    table.insert(shapeArrayParameters,{"item","hook", 2, 1, 5, 3, {}})
