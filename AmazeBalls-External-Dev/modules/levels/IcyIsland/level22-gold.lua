...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters,{"shape","bar1_1_1", 1, 1, 1, 1, "bar", "vert", 3})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_1", 1, 1, 1, 1, "left"})
    table.insert(shapeArrayParameters,{"shape","bar1_1_1", 1, 1, 4, 1, "bar", "vert"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan2_1_1", 1, 1, 4, 1, "right"})
    table.insert(shapeArrayParameters,{"tunnel","tunnel1_1_1", 1, 1, 6, 1, 1, 1, 2, 4, "none"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan3_1_1", 1, 1, 1, 3, "up"})
    table.insert(shapeArrayParameters,{"shape","bar1_1_1", 1, 1, 2, 3, "bar", "horz"})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 4, 3, "triangleTopRightShape"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan4_1_1", 1, 1, 6, 3, "up"})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle1_2_1", 2, 1, 4, 1, "triangleBottomRightShape", 1, 3})
    ...
    table.insert(shapeArrayParameters,{"shape","bar1_2_1", 2, 1, 2, 2, "bar", "vert", 4})
    table.insert(shapeArrayParameters,{"shape","bar2_2_1", 2, 1, 3, 2, "bar", "vert", 4})
    table.insert(shapeArrayParameters,{"backFire","backFire1_2_1", 2, 1, 3, 2})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"backFire1_2_1"},{"slide"},{},{2},{1},{2,1,2,2},{2},{2,1,3,2}})
    table.insert(shapeArrayParameters,{"autoFan","autoFan2_2_1", 2, 1, 7, 2, "right"})
    ...
    table.insert(shapeArrayParameters,{"simple","simple3_2_1", 2, 1, 3, 5})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"simple3_2_1"},{"slide"},{},{1},{1},{2,1,3,5},{2},{2,1,5,5}})

    --SCREEN 1-2
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 1, 2, 2, 1, "triangleBottomLeftShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_2", 1, 2, 3, 1, "down"})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_2", 1, 2, 6, 1, "triangleBottomRightShape", 1, _, "fire"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 1, 2, 4, 2, "triangleTopRightShape", 1, _, "fire"})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_2", 1, 2, 7, 2, "triangleBottomLeftShape", 1, _, "fire"})
    table.insert(shapeArrayParameters,{"shape","bar1_1_2", 1, 2, 1, 3, "bar", "horz"})
    table.insert(shapeArrayParameters,{"spitter","spitter1_1_2", 1, 2, 2, 3, "up", "right", "down", "none"})
    table.insert(shapeArrayParameters,{"door","door1_1_2", 1, 2, 7, 3, "right"})
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_1_2", 1, 2, 4, 4})
    table.insert(shapeArrayParameters,{"simple","simple1_1_2", 1, 2, 6, 4})
    table.insert(shapeArrayParameters,{"shape","triangle5_1_2", 1, 2, 2, 5, "triangleTopLeftShape"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_2", 1, 2, 3, 5, "up"})
    table.insert(shapeArrayParameters,{"shape","triangle6_1_2", 1, 2, 7, 5, "triangleBottomLeftShape", 1, 4})
    ...
    table.insert(shapeArrayParameters,{"manualFan","manualFan2_2_2", 2, 2, 5, 1, "down"})
    table.insert(shapeArrayParameters,{"shape","bar1_2_2", 2, 2, 6, 1, "bar", "horz", 2})
    table.insert(shapeArrayParameters,{"manualFan","manualFan3_2_2", 2, 2, 7, 1, "right"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan4_2_2", 2, 2, 2, 2, "up"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan5_2_2", 2, 2, 3, 2, "left"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan6_2_2", 2, 2, 6, 2, "down"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"manualFan6_2_2"},{"slide"},{},{1},{1},{2,2,6,2},{2},{2,2,6,3}})
    table.insert(shapeArrayParameters,{"door","door2_2_2", 2, 2, 1, 3, "left", "disabled"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan7_2_2", 2, 2, 1, 3, "left"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan8_2_2", 2, 2, 3, 3, "up"})
    table.insert(shapeArrayParameters,{"shape","triangle1_2_2", 2, 2, 2, 4, "triangleTopRightShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan9_2_2", 2, 2, 3, 4, "up"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan10_2_2", 2, 2, 5, 4, "right"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan11_2_2", 2, 2, 7, 4, "up"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_2_2", 2, 2, 1, 5, "up"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan12_2_2", 2, 2, 4, 5, "up"})
    table.insert(shapeArrayParameters,{"shape","bar2_2_2", 2, 2, 5, 6, "bar", "vert", 2})
    table.insert(shapeArrayParameters,{"manualFan","manualFan13_2_2", 2, 2, 6, 5, "left"})

    --SWITCHES
    table.insert(shapeArrayParameters,{"switch","switch1_2_1", 2, 1, 2, 3, { {"slide","bar4_2_1"} } })

    table.insert(shapeArrayParameters,{"switch","switch1_2_2", 2, 2, 1, 1, { {"door-open","door2_2_2"} } })
    ...
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 2, 1, 1, 2, "purpleCoin"})
    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 6, 2, 200})
    table.insert(shapeArrayParameters,{"item","coins", 2, 2, 4, 1, 245})
    table.insert(shapeArrayParameters,{"item","coins", 2, 1, 7, 4, 290})
    table.insert(shapeArrayParameters,{"item","big-present", 2, 1, 1, 5, {}})
    table.insert(shapeArrayParameters,{"item","small-present", 1, 2, 6, 5, {}})
    table.insert(shapeArrayParameters,{"item","small-present", 1, 1, 1, 2, {}})
    table.insert(shapeArrayParameters,{"item","fireCape", 1, 2, 4, 3, {}})
    table.insert(shapeArrayParameters,{"item","iceCape", 2, 2, 1, 4, {}})
