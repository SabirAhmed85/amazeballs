...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters,{"spitter","spitter1_1_1", 1, 1, 2, 1, "none","right","none","none"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"spitter1_1_1"},{"slide"},{"lightBlue"},{1},{1},{1,1,2,1},{2},{1,1,2,3}})
    table.insert(shapeArrayParameters,{"spitter","spitter2_1_1", 1, 1, 4, 2, "none","none","down","none"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"spitter2_1_1"},{"slide"},{"lightBlue"},{2},{1},{1,1,4,1},{2},{1,1,4,2}})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 4, 5, "triangleTopRightShape"})
    table.insert(shapeArrayParameters,{"door","door1_1_1", 1, 1, 7, 5, "right"})

    --SCREEN 2-1
    table.insert(shapeArrayParameters,{"endPoint","endPoint1_2_1", 2, 1, 6, 1})
    table.insert(shapeArrayParameters,{"shape","triangle1_2_1", 2, 1, 6, 2, "triangleTopLeftShape", 1, 11, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle_2_1", 2, 1, 6, 3, "triangleBottomRightShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle3_2_1", 2, 1, 3, 4, "triangleTopRightShape", 1, 10, "breakable"})
    table.insert(shapeArrayParameters,{"spitter","spitter1_2_1", 2, 1, 1, 5, "none","right","none","none"})
    table.insert(shapeArrayParameters,{"shape","triangle4_2_1", 2, 1, 3, 5, "triangleBottomLeftShape", 1, _, "breakable"})
    ...
    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 6, 5, 85})
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 4, 3, 50})
    table.insert(shapeArrayParameters,{"item","coins", 2, 1, 3, 2, 105})
