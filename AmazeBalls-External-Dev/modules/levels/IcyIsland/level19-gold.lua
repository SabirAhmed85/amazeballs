...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 4, 2, "triangleBottomRightShape", 1, _, "hyroll"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_1", 1, 1, 7, 2, "triangleBottomLeftShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_1", 1, 1, 7, 3, "triangleTopRightShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"door","door1_1_1", 1, 1, 7, 3, "right"})
    table.insert(shapeArrayParameters,{"shape","triangle5_1_1", 1, 1, 2, 4, "triangleBottomRightShape", 1, _, "hyroll"})
    table.insert(shapeArrayParameters,{"shape","triangle6_1_1", 1, 1, 4, 4, "triangleTopLeftShape", 1, 5, "breakable"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_1", 1, 1, 2, 5, "up"})

    --SCREEN 2-1
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_2_1", 2, 1, 3, 1, "right"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"manualFan1_2_1"},{"slide"},{},{2},{1},{2,1,1,1},{2},{2,1,3,1},{3},{2,1,4,1}})
    table.insert(shapeArrayParameters,{"shape","triangle1_2_1", 2, 1, 1, 2, "triangleTopRightShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"shape","triangle2_2_1", 2, 1, 2, 2, "triangleBottomLeftShape", 1, 3, "breakable"})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle3_2_1", 2, 1, 2, 3, "triangleTopRightShape", 1, 3, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle4_2_1", 2, 1, 3, 3, "triangleTopLeftShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"characterChangePoint","characterChangePoint1_2_1", 2, 1, 4, 3})
    ...
    table.insert(shapeArrayParameters,{"manualFan","manualFan2_2_1", 2, 1, 1, 5, "down"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan3_2_1", 2, 1, 4, 5, "up"})
    table.insert(shapeArrayParameters,{"shape","triangle6_2_1", 2, 1, 6, 5, "triangleTopLeftShape", 1, _, "icy"})

    --SWITCHES
    table.insert(shapeArrayParameters,{"switch","switch1_1_1", 1, 1, 7, 1, { {"door-open","door1_2_1"} } })
    ...
    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 3, 2, 100})
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 1, 3, 70})
