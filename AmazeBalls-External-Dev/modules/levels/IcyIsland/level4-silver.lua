...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"autoFan","autoFan2_1_1", 1, 1, 6, 4, "down"})
    ...
    table.insert(shapeArrayParameters,{"autoFan","autoFan2_2_1", 2, 1, 3, 1, "left"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan3_2_1", 2, 1, 5, 1, "down"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan4_2_1", 2, 1, 7, 1, "left"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan5_2_1", 2, 1, 2, 2, "down"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan6_2_1", 2, 1, 4, 2, "left"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"autoFan6_2_1"},{"slide"},{},{1},{1},{2,1,4,2},{2},{2,1,5,2}})
    table.insert(shapeArrayParameters,{"autoFan","autoFan7_2_1", 2, 1, 6, 2, "up"})
    ...
    table.insert(shapeArrayParameters,{"autoFan","autoFan8_2_1", 2, 1, 5, 3, "right"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan9_2_1", 2, 1, 7, 3, "up"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan10_2_1", 2, 1, 1, 4, "right"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan11_2_1", 2, 1, 3, 4, "up"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan12_2_1", 2, 1, 6, 4, "left"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"autoFan12_2_1"},{"slide"},{},{2},{1},{2,1,6,3},{2},{2,1,6,4}})
    table.insert(shapeArrayParameters,{"autoFan","autoFan13_2_1", 2, 1, 2, 5, "right"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan14_2_1", 2, 1, 4, 5, "up"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_2_1", 2, 1, 5, 5, "left"})
    ...
    --SCREEN 2-2
    table.insert(shapeArrayParameters,{"spitter","spitter1_2_2", 2, 2, 2, 1, "none","right","none","none"})
    ...
    table.insert(shapeArrayParameters,{"spitter","spitter2_2_2", 2, 2, 5, 2, "none","none","none","left"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"spitter2_2_2"},{"slide"},{},{3},{1},{2,2,5,1},{2},{2,2,5,2},{3},{2,2,5,4}})
    table.insert(shapeArrayParameters,{"shape","triangle2_2_2", 2, 2, 4, 3, "triangleBottomLeftShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle2_2_2", 2, 2, 4, 5, "triangleBottomRightShape", 1, 14, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle2_2_2", 2, 2, 7, 5, "triangleTopLeftShape", 1, _, "breakable"})
    ...
    table.insert(shapeArrayParameters,{"gem","blueCoin", 2, 1, 1, 2, "blueCoin"})
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 2, 2, 1, 5, "purpleCoin"})

    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 2, 1, 270})
    table.insert(shapeArrayParameters,{"item","coins", 2, 2, 6, 1, 135})
    table.insert(shapeArrayParameters,{"item","coins", 2, 2, 4, 4, 80})
    ...
    table.insert(shapeArrayParameters,{"item","hook", 2, 1, 7, 2, {}})
    table.insert(shapeArrayParameters,{"item","clock", 2, 2, 6, 5, {}})
