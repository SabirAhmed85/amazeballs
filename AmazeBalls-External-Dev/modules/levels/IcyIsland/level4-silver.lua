...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"autoFan6_2_1"},{"slide"},{},{1},{1},{2,1,4,2},{2},{2,1,5,2}})
    addToShapeArray(sp, "autoFan","autoFan7_2_1", {2, 1, 6, 2}, "up")
    addToTransitionArray(ta,{{"autoFan7_2_1"},{"slide"},{},{2},{1},{2,1,6,1},{2},{2,1,6,2}})
    ...
    addToTransitionArray(ta,{{"autoFan12_2_1"},{"slide"},{},{2},{1},{2,1,6,3},{2},{2,1,6,4}})
    ...
    addToTransitionArray(ta,{{"manualFan1_2_1"},{"slide"},{},{3},{1},{2,1,3,3},{"*"},{2,1,4,3},{"*"},{2,1,4,4},{2},{2,1,5,4},{3},{2,1,5,5}})

    --SCREEN 2-2
    addToShapeArray(sp, "spitter","spitter1_2_2", {2, 2, 2, 1}, {"none","right","none","none"})
    addToTransitionArray(ta,{{"spitter1_2_2"},{"slide"},{},{3},{1},{2,2,2,1},{2},{2,2,2,3},{3},{2,2,2,5}})
    addToShapeArray(sp, "door","door1_2_2", {2, 2, 7, 1}, "up")
    addToShapeArray(sp, "spitter","spitter2_2_2", {2, 2, 5, 2}, {"none","none","none","left"})
    addToTransitionArray(ta,{{"spitter2_2_2"},{"slide"},{},{3},{1},{2,2,5,1},{2},{2,2,5,2},{3},{2,2,5,4}})
