...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle5_3_1", {3, 1, 1, 4}, "triangleTopRightShape", {1, 10})
    ...
    --ITEMS
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {1, 1, 4, 2, 580})
