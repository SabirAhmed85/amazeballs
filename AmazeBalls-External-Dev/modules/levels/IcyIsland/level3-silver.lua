...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_1_1", {1, 1, 6, 1}, "down"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_1_1", {1, 1, 4, 4}, "triangleTopRightShape", {1, 1, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("door","door1_1_1", {1, 1, 4, 5}, "down"))
    table.insert(shapeArrayParameters, getShapeArray("spitter","spitter1_1_1", {1, 1, 7, 5, "up","none","none","left"}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_1_2", {1, 2, 2, 2}, "down"))
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan3_1_2", {1, 2, 3, 2}, "left"))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan2_1_2", {1, 2, 6, 2}, "left"))
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan4_1_2", {1, 2, 3, 3}, "right"))
    table.insert(shapeArrayParameters, getShapeArray("shape","bar1_1_2", {1, 2, 5, 3}, "bar", {"horz"}))
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan5_1_2", {1, 2, 5, 3}, "right"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_1_2", {1, 2, 7, 3}, "triangleTopLeftShape", {1, 6}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan7_1_2", {1, 2, 2, 5}, "right"))
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan8_1_2", {1, 2, 5, 5}, "up"))
    ...
    --ITEMS
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {1, 1, 3, 4, 290})
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {1, 2, 3, 1, 40})
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {1, 2, 4, 3, 200})
