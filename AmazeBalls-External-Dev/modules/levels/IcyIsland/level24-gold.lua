...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"bar5_1_1"},{"switchSlide"},{},{2},{1},{1,1,3,3},{2},{1,1,3,4}})
    addToShapeArray(sp, "backFire","backFire1_1_1", {1, 1, 6, 4})
    addToTransitionArray(ta,{{"backFire1_1_1"},{"slide"},{},{2},{1},{1,1,6,5},{2},{1,1,6,4},{3},{1,1,7,4}})
    ...
    addToTransitionArray(ta,{{"bar6_1_1"},{"switchSlide"},{},{2},{1},{1,1,1,6},{2},{1,1,2,6}})
    ...
    addToTransitionArray(ta,{{"spitter1_1_2"},{"slide"},{},{2},{1},{1,2,2,2},{2},{1,2,3,2}})
    ...
    addToTransitionArray(ta,{{"spitter2_1_2"},{"slide"},{},{2},{1},{1,2,2,4},{2},{1,2,5,4},{3},{1,2,7,4}})
    ...
    addToTransitionArray(ta,{{"backFire1_2_2"},{"slide"},{},{1},{1},{2,2,1,1},{2},{2,2,1,2},{3},{2,2,2,2},{4},{2,2,2,3}})
    addToShapeArray(sp, "shape","bar2_2_2", {2, 2, 4, 1}, "bar", {"horz", 4})
    addToTransitionArray(ta,{{"bar2_2_2"},{"slide"},{},{2},{1},{2,2,4,1},{2},{2,2,4,2}})
    ...
    addToTransitionArray(ta,{{"triangle1_2_2"},{"slide"},{},{3},{1},{2,2,5,2},{2},{2,2,7,2},{3},{2,2,7,1}})
    ...
    addToTransitionArray(ta,{{"simple1_2_2"},{"slide"},{},{3},{1},{2,2,3,4},{2},{2,2,5,4},{3},{2,2,6,3}})
    addToShapeArray(sp, "shape","bar6_2_2", {2, 2, 8, 3}, "bar", {"horz", 2})
    addToShapeArray(sp, "shape","bar7_2_2", {2, 2, 2, 5}, "bar", {"vert", 3})
    addToTransitionArray(ta,{{"bar7_2_2"},{"switchSlide"},{},{1},{1},{2,2,2,5},{2},{2,2,7,5}})
    addToShapeArray(sp, "backFire","backFire2_2_2", {2, 2, 3, 5})
    addToTransitionArray(ta,{{"backFire2_2_2"},{"slide"},{},{2},{1},{2,2,1,5},{2},{2,2,3,5}})
    addToShapeArray(sp, "door","door2_2_2", {2, 2, 4, 5}, "down")
    addToShapeArray(sp, "autoFan","autoFan1_2_2", {2, 2, 5, 5}, "down")
    addToTransitionArray(ta,{{"autoFan1_2_2"},{"switchSlide"},{},{2},{1},{2,2,4,5},{2},{2,2,5,5}})
    ...
    addToTransitionArray(ta,{{"triangle3_1_3"},{"switchSlide"},{},{1},{1},{1,3,5,3},{2},{1,3,6,3}})
    ...
    addToTransitionArray(ta,{{"bar1_1_3"},{"switchSlide"},{},{2},{1},{1,3,5,4},{2},{1,3,6,4}})
    ...
    addToTransitionArray(ta,{{"bar1_1_3"},{"slide"},{},{2},{1},{2,3,2,2},{2},{2,3,3,2}})
    ...
    addToTransitionArray(ta,{{"spitter1_2_3"},{"slide"},{},{2},{1},{2,3,2,3},{2},{2,3,2,4}})
    addToShapeArray(sp, "spitter","spitter2_2_3", {2, 3, 6, 4, "up","none","none","none"})
    addToTransitionArray(ta,{{"spitter2_2_3"},{"slide"},{},{2},{1},{2,3,6,3},{2},{2,3,6,4}})
    --addToShapeArray(sp, "item","coins", {2, 3, 7, 4}, 250)
    addToShapeArray(sp, "simple","simple1_2_3", {2, 3, 3, 5})
    addToTransitionArray(ta,{{"simple1_2_3"},{"slide"},{},{2},{1},{2,3,1,5},{2},{2,3,3,5},{3},{2,3,4,5}})
    addToShapeArray(sp, "shape","bar4_2_3", {2, 3, 5, 5}, "bar", {"vert"})
    addToTransitionArray(ta,{{"bar4_2_3"},{"slide"},{},{1},{1},{2,3,5,5},{2},{2,3,6,5}})
    ...
    addToTransitionArray(ta,{{"spitter1_1_4"},{"switchSlide"},{},{1},{1},{1,4,1,1},{2},{1,4,3,1}})
    ...
    addToTransitionArray(ta,{{"spitter2_1_4"},{"switchSlide"},{},{2},{1},{1,4,6,1},{2},{1,4,7,1}})
    addToShapeArray(sp, "spitter","spitter3_1_4", {1, 4, 1, 2, "up","none","none","none"})
    addToTransitionArray(ta,{{"spitter3_1_4"},{"switchSlide"},{},{1},{1},{1,4,1,2},{2},{1,4,3,2}})
    addToShapeArray(sp, "spitter","spitter4_1_4", {1, 4, 7, 2}, {"none","none","none","left"})
    addToTransitionArray(ta,{{"spitter4_1_4"},{"switchSlide"},{l},{2},{1},{1,4,5,2},{2},{1,4,7,2}})
    addToShapeArray(sp, "spitter","spitter5_1_4", {1, 4, 2, 3, "up","right","none","none"})
    addToTransitionArray(ta,{{"spitter5_1_4"},{"slide"},{},{1},{1},{1,4,2,3},{2},{1,4,3,3}})
    addToShapeArray(sp, "spitter","spitter6_1_4", {1, 4, 7, 3}, {"none","none","down","none"})
    addToTransitionArray(ta,{{"spitter6_1_4"},{"switchSlide"},{},{2},{1},{1,4,6,3},{2},{1,4,7,3}})
    ...
    addToTransitionArray(ta,{{"spitter8_1_4"},{"slide"},{},{2},{1},{1,4,4,4},{2},{1,4,5,4}})
    addToShapeArray(sp, "spitter","spitter9_1_4", {1, 4, 7, 4}, {"none","right","none","none"})
    addToTransitionArray(ta,{{"spitter9_1_4"},{"switchSlide"},{},{2},{1},{1,4,6,4},{2},{1,4,7,4}})
    addToShapeArray(sp, "spitter","spitter10_1_4", {1, 4, 1, 5}, {"none","right","none","none"})
    addToTransitionArray(ta,{{"spitter10_1_4"},{"switchSlide"},{},{1},{1},{1,4,1,5},{2},{1,4,2,5}})
    addToShapeArray(sp, "endPoint","endPoint1_1_4", {1, 4, 3, 5})
    addToShapeArray(sp, "spitter","spitter11_1_4", {1, 4, 7, 5}, {"none","none","none","left"})
    addToTransitionArray(ta,{{"spitter11_1_4"},{"switchSlide"},{},{2},{1},{1,4,6,5},{2},{1,4,7,5}})
    ...
    addToTransitionArray(ta,{{"bar1_2_4"},{"slide"},{},{2},{1},{2,4,4,1},{2},{2,4,4,2}})
    ...
    addToTransitionArray(ta,{{"triangle1_2_5"},{"flip-vertical"}})
