...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    --SCREEN 1-1
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 5, 1, "triangleBottomRightShape", 1, 9})
    ...
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_1", 1, 1, 7, 2, "down"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"manualFan1_1_1"},{"slide"},{},{2},{1},{1,1,7,1},{2},{1,1,7,2}})
    table.insert(shapeArrayParameters,{"shape","bar1_1_1", 1, 1, 2, 3, "bar", "vert", 3})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar1_1_1"},{"switchSlide"},{},{1},{1},{1,1,2,3},{2},{1,1,3,3}})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_1", 1, 1, 3, 3, "triangleBottomRightShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_1", 1, 1, 7, 3, "triangleTopLeftShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"shape","bar2_1_1", 1, 1, 3, 4, "bar", "vert", 3})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar2_1_1"},{"switchSlide"},{},{1},{1},{1,1,3,4},{2},{1,1,4,4}})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_1", 1, 1, 2, 5, "triangleTopRightShape", 1, 1})
    ...
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_2", 1, 2, 7, 1, "up"})
    table.insert(shapeArrayParameters,{"shape","bar1_1_2", 1, 2, 3, 2, "bar", "horz", 3})
    table.insert(shapeArrayParameters,{"item","map", 1, 2, 3, 2})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 1, 2, 7, 2, "triangleBottomLeftShape", 1, 4, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_2", 1, 2, 2, 4, "triangleTopLeftShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 1, 2, 4, 4, "triangleTopLeftShape", 1, 11, "breakable"})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_2", 1, 2, 5, 5, "triangleTopLeftShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"item","compass", 1, 2, 7, 5})

    --SWITCHES
    table.insert(shapeArrayParameters,{"switch","switch1_1_1", 1, 1, 1, 1, { {"slide","bar2_1_1"} }, "one-way" })
    table.insert(shapeArrayParameters,{"switch","switch1_1_2", 1, 2, 3, 4, { {"slide","bar1_1_1"} }, "one-way" })
    ...
    table.insert(shapeArrayParameters,{"gem","blueCoin", 1, 2, 1, 5, "blueCoin"})
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 1, 1, 4, 5, "purpleCoin"})

    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 2, 1, 45})
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 6, 5, 250})
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 2, 2, 70})
    table.insert(shapeArrayParameters,{"item","small-present", 1, 2, 1, 4, {} })
    table.insert(shapeArrayParameters,{"item","big-present", 1, 1, 2, 3, {} })
