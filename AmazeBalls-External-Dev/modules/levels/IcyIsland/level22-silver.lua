...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_1_1", {1, 1, 6, 1}, "triangleBottomLeftShape", {1, _, "icy"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_1_1", {1, 1, 6, 3, "triangleBottomLeftShape"}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle5_1_1", {1, 1, 2, 5}, "triangleBottomLeftShape", {1, 4, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("door","door1_1_1", {1, 1, 2, 5}, "down"))

    --SCREEN 1-2
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_1_2", {1, 2, 3, 2}, "triangleBottomRightShape", {1, _, "icy"}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_1_2", {1, 2, 2, 4}, "right"))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan2_1_2", {1, 2, 6, 4}, "up"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_1_2", {1, 2, 3, 5}, "triangleBottomRightShape", {1, 3}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle4_1_2", {1, 2, 7, 5}, "triangleBottomRightShape"))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle4_1_2"},{"flip-horizontal"}})

    --SCREEN 1-3
    table.insert(shapeArrayParameters, getShapeArray("item","mystery-block", 1, 3, 3, 2, {
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_1_3", {1, 3, 5, 2, "triangleBottomLeftShape"}))
    table.insert(shapeArrayParameters, getShapeArray("item","mystery-block", 1, 3, 7, 2, {
        {name = "triangle", properties = {shape = {"triangleTopLeftShape"} } },
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","bar1_1_3", {1, 3, 4, 3}, "bar", {"vert", 3}))
    table.insert(shapeArrayParameters, getShapeArray("simple","simple1_1_3", {1, 3, 4, 4}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"simple1_1_3"},{"slide"},{},{1},{1},{1,3,4,4},{2},{1,3,6,4},{3},{1,3,7,4}})
    table.insert(shapeArrayParameters, getShapeArray("simple","simple2_1_3", {1, 3, 3, 5}))
    table.insert(shapeArrayParameters, getShapeArray("endPoint","endPoint1_1_3", {1, 3, 5, 5}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_1_3", {1, 3, 6, 5}, "triangleTopRightShape"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("gem","redCoin", {1, 3, 7, 5}, "redCoin"))
    table.insert(shapeArrayParameters, getShapeArray("gem","blueCoin", {1, 2, 7, 4}, "blueCoin"))
    table.insert(shapeArrayParameters, getShapeArray("gem","purpleCoin", {1, 1, 4, 5}, "purpleCoin"))
    --ITEMS
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {1, 2, 1, 5}, 135)))
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {1, 3, 6, 1, 260})
    table.insert(shapeArrayParameters, getShapeArray("item","big-present", 1, 3, 6, 2, {}})
    table.insert(shapeArrayParameters, getShapeArray("item","small-present", {1, 2, 2, 1, {}})
    table.insert(shapeArrayParameters, getShapeArray("item","small-present", {1, 3, 5, 1, {}})
    table.insert(shapeArrayParameters, getShapeArray("item","dummyBall", 1, 1, 7, 2, {}})
    table.insert(shapeArrayParameters, getShapeArray("item","hook", 1, 3, 1, 2, {}})
