...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters,{"shape","triangle1_1_1", 1, 1, 1, 3, "triangleTopRightShape"})
    table.insert(shapeArrayParameters,{"item","map", 1, 1, 3, 3})
    table.insert(shapeArrayParameters,{"spitter","spitter1_1_1", 1, 1, 4, 3, "none","right","none","none"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_1", 1, 1, 6, 3, "up"})
    ...
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_1", 1, 1, 2, 5, "up"})
    table.insert(shapeArrayParameters,{"spitter","spitter2_1_1", 1, 1, 5, 5, "none","none","none","left"})
    ...
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_1_1", 1, 1, 6, 5, "right"})
    table.insert(shapeArrayParameters,{"door","door1_1_1", 1, 1, 7, 5, "right"})

    --SCREEN 2-1
    table.insert(shapeArrayParameters,{"autoFan","autoFan1_2_1", 2, 1, 1, 1, "right"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_2_1", 2, 1, 4, 1, "down"})
    table.insert(shapeArrayParameters,{"shape","triangle1_2_1", 2, 1, 5, 1, "triangleBottomRightShape", 1, 9})
    table.insert(shapeArrayParameters,{"manualFan","manualFan2_2_1", 2, 1, 5, 2, "down"})
    table.insert(shapeArrayParameters,{"shape","bar1_2_1", 2, 1, 6, 2, "bar", "horz", 2})
    table.insert(shapeArrayParameters,{"autoFan","autoFan2_2_1", 2, 1, 2, 3, "right"})
    table.insert(shapeArrayParameters,{"autoFan","autoFan3_2_1", 2, 1, 4, 3, "down"})
    table.insert(shapeArrayParameters,{"shape","triangle2_2_1", 2, 1, 7, 3, "triangleBottomLeftShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan3_2_1", 2, 1, 3, 4, "up"})
    ...
    table.insert(shapeArrayParameters,{"shape","triangle3_2_1", 2, 1, 2, 5, "triangleTopLeftShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"door","door1_2_1", 2, 1, 4, 5, "down"})
    table.insert(shapeArrayParameters,{"shape","triangle4_2_1", 2, 1, 7, 5, "triangleTopLeftShape", 1, _, "icy"})

    --SCREEN 1-2
    table.insert(shapeArrayParameters,{"door","door1_1_2", 1, 2, 1, 1, "up"})
    table.insert(shapeArrayParameters,{"door","door2_1_2", 1, 2, 4, 1, "up"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_2", 1, 2, 4, 1, "up"})
    table.insert(shapeArrayParameters,{"shape","bar1_1_2", 1, 2, 6, 1, "bar", "horz", 3})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar1_1_2"},{"switchSlide"},{},{1},{1},{1,2,6,1},{2},{1,2,6,2}})
    table.insert(shapeArrayParameters,{"shape","triangle1_1_2", 1, 2, 7, 1, "triangleTopLeftShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"shape","bar2_1_2", 1, 2, 4, 2, "bar", "vert", 3})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar2_1_2"},{"switchSlide"},{},{1},{1},{1,2,3,2},{2},{1,2,4,2}})
    table.insert(shapeArrayParameters,{"shape","triangle2_1_2", 1, 2, 5, 2, "triangleBottomRightShape"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle4_1_2"},{"slide"},{},{1},{1},{1,2,5,2},{2},{1,2,5,3}})
    table.insert(shapeArrayParameters,{"shape","bar3_1_2", 1, 2, 2, 3, "bar", "horz", 3})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_2", 1, 2, 2, 3, "right"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_2", 1, 2, 4, 3, "up"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_2", 1, 2, 7, 3, "up"})
    table.insert(shapeArrayParameters,{"shape","triangle3_1_2", 1, 2, 6, 4, "triangleTopRightShape"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle3_1_2"},{"flip-horizontal"}})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_1_2", 1, 2, 7, 4, "down"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"manualFan1_1_2"},{"slide"},{},{1},{1},{1,2,7,4},{2},{1,2,7,5}})
    table.insert(shapeArrayParameters,{"shape","triangle4_1_2", 1, 2, 1, 5, "triangleTopRightShape", 1, _, "breakable"})
    table.insert(shapeArrayParameters,{"shape","bar4_1_2", 1, 2, 5, 5, "bar", "horz", 2})

    --SCREEN 2-2
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_2_2", 2, 2, 5, 1, "right"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"manualFan1_2_2"},{"slide"},{},{1},{1},{2,2,4,1},{2},{2,2,5,1}})
    table.insert(shapeArrayParameters,{"shape","triangle1_2_2", 2, 2, 7, 1, "triangleBottomLeftShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"door","door1_2_2", 2, 2, 1, 3, "left"})
    table.insert(shapeArrayParameters,{"spitter","spitter1_2_2", 2, 2, 4, 3, "none","none","none","left"})
    table.insert(shapeArrayParameters,{"shape","triangle2_2_2", 2, 2, 6, 3, "triangleBottomLeftShape", 1, _, "icy"})
    table.insert(shapeArrayParameters,{"manualFan","manualFan1_2_2", 2, 2, 1, 4, "right"})
    table.insert(shapeArrayParameters,{"shape","triangle3_2_2", 2, 2, 2, 4, "triangleBottomRightShape"})
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle3_2_2"},{"slide"},{},{2},{1},{2,2,1,3},{2},{2,2,2,4}})
    table.insert(shapeArrayParameters,{"item","compass", 2, 2, 5, 4})
    table.insert(shapeArrayParameters,{"simple", "simple1_2_2", 2, 2, 1, 5})
    table.insert(shapeArrayParameters,{"shape","triangle4_2_2", 2, 2, 6, 5, "triangleBottomLeftShape", 1, _, "breakable"})

    --SWITCHES
    table.insert(shapeArrayParameters,{"switch","switch1_2_1", 2, 1, 3, 5, { {"slide","bar1_1_2"} }, "one-way" })

    table.insert(shapeArrayParameters,{"switch","switch1_1_2", 1, 2, 6, 1, { {"slide","spitter2_1_1"} }, "one-way", "not-labelled" })
    ...
    table.insert(shapeArrayParameters,{"gem","redCoin", 2, 1, 2, 1, "redCoin"})
    table.insert(shapeArrayParameters,{"gem","blueCoin", 2, 2, 7, 3, "blueCoin"})
    table.insert(shapeArrayParameters,{"gem","purpleCoin", 1, 2, 4, 5, "purpleCoin"})
    --ITEMS
    table.insert(shapeArrayParameters,{"item","coins", 1, 1, 2, 1, 210})
    table.insert(shapeArrayParameters,{"item","coins", 1, 2, 3, 5, 260})
    table.insert(shapeArrayParameters,{"item","coins", 2, 2, 2, 2, 180})
    table.insert(shapeArrayParameters,{"item","big-present", 2, 1, 1, 2, {}})
    table.insert(shapeArrayParameters,{"item","small-present", 1, 2, 5, 1, {}})
    table.insert(shapeArrayParameters,{"item","iceCape", 2, 2, 2, 1, {}})
    table.insert(shapeArrayParameters,{"item","dummyBall", 2, 1, 5, 5, {}})
