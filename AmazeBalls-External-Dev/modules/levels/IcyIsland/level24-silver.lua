...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    addToTransitionArray(ta,{{"bar1_1_1"},{"autoSlide"},{},{1},{1},{1,1,1,3},{2},{1,1,2,3}})
    ...
    addToTransitionArray(ta,{{"spitter2_1_1"},{"switchSlide"},{labelled = false},{2},{1},{1,1,4,5},{2},{1,1,5,5}})
    ...
    addToTransitionArray(ta,{{"manualFan2_2_1"},{"slide"},{},{3},{1},{2,1,1,3},{"*"},{2,1,1,4},{2},{2,1,2,4},{2},{2,1,3,4}})
    ...
    addToTransitionArray(ta,{{"bar1_1_2"},{"switchSlide"},{},{1},{1},{1,2,6,1},{2},{1,2,6,2}})
    ...
    addToTransitionArray(ta,{{"bar2_1_2"},{"switchSlide"},{},{1},{1},{1,2,3,2},{2},{1,2,4,2}})
    addToShapeArray(sp, "shape","triangle2_1_2", {1, 2, 5, 2}, "triangleBottomRightShape")
    addToTransitionArray(ta,{{"triangle4_1_2"},{"slide"},{},{1},{1},{1,2,5,2},{2},{1,2,5,3}})
    ...
    addToTransitionArray(ta,{{"triangle3_1_2"},{"flip-horizontal"}})
    addToShapeArray(sp, "manualFan","manualFan1_1_2", {1, 2, 7, 4}, "down")
    addToTransitionArray(ta,{{"manualFan1_1_2"},{"slide"},{},{1},{1},{1,2,7,4},{2},{1,2,7,5}})
    ...
    addToTransitionArray(ta,{{"manualFan1_2_2"},{"slide"},{},{1},{1},{2,2,4,1},{2},{2,2,5,1}})
    ...
    addToTransitionArray(ta,{{"triangle3_2_2"},{"slide"},{},{2},{1},{2,2,1,3},{2},{2,2,2,4}})
