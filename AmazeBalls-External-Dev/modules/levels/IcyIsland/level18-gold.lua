...
local createLevelObjects = function (mainFunc, shapeArrayParameters)
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_1_1", {1, 1, 3, 3}, "triangleBottomLeftShape", {1, 7, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_1_1", {1, 1, 7, 3}, "triangleBottomRightShape", {1, 9, "breakable"}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_1_2", {1, 2, 5, 1}, "up"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_1_2", {1, 2, 3, 2}, "triangleTopLeftShape", {1, _, "icy"}))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan2_1_2", {1, 2, 6, 2}, "right"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_1_2", {1, 2, 1, 3}, "triangleTopLeftShape", {1, 15}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle3_1_2"},{"flip-horizontal"}})
    table.insert(shapeArrayParameters, getShapeArray("shape","bar1_1_2", {1, 2, 3, 2}, "bar", {"horz", 4}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"bar1_1_2"},{"slide"},{},{1},{1},{1,2,3,2},{2},{1,2,3,3}})
    table.insert(shapeArrayParameters, getShapeArray("backFire","backFire1_1_2", {1, 2, 4, 3}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"backFire1_1_2"},{"slide"},{},{2},{1},{1,2,4,1},{2},{1,2,4,3},{3},{1,2,4,4}})
    table.insert(shapeArrayParameters, getShapeArray("shape","bar2_1_2", {1, 2, 2, 4}, "bar", {"vert", 3}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle4_1_2", {1, 2, 2, 4}, "triangleBottomRightShape"))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle4_1_2"},{"slide"},{},{1},{1},{1,2,2,4},{2},{1,2,3,5}})
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle5_1_2", {1, 2, 6, 4}, "triangleTopLeftShape", {1, _, "icy"}))
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan1_1_2", {1, 2, 2, 5}, "up"))
    table.insert(shapeArrayParameters, getShapeArray("spitter","spitter1_1_2", {1, 2, 4, 5, "up","none","none","none"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle6_1_2", {1, 2, 5, 5}, "triangleBottomLeftShape", {1, _, "icy"}))

    --SCREEN 2-2
    table.insert(shapeArrayParameters, getShapeArray("door","door1_2_2", {2, 2, 1, 3}, "left"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_2_2", {2, 2, 5, 3}, "triangleBottomLeftShape", {1, _, "breakable"}))
    --table.insert(shapeArrayParameters, getShapeArray("item","coins", {2, 2, 2, 5}, 250))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_2_2", {2, 2, 3, 5}, "triangleTopLeftShape", {1, _, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_2_2", {2, 2, 4, 5}, "triangleTopRightShape", {1, 10, "breakable"}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("gem","redCoin", {2, 2, 3, 1}, "redCoin"))
    table.insert(shapeArrayParameters, getShapeArray("gem","blueCoin", {1, 1, 5, 3}, "blueCoin"))
    table.insert(shapeArrayParameters, getShapeArray("gem","purpleCoin", {1, 2, 1, 1}, "purpleCoin"))
    --ITEMS
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {1, 2, 1, 2, 300})
    table.insert(shapeArrayParameters, getShapeArray("item","coins", {2, 2, 6, 3, 280})
    table.insert(shapeArrayParameters, getShapeArray("item","big-present", 1, 2, 1, 5, {}})
    table.insert(shapeArrayParameters, getShapeArray("item","small-present", {1, 1, 2, 4, {}})
    table.insert(shapeArrayParameters, getShapeArray("item","small-present", {2, 2, 5, 2, {}})
    table.insert(shapeArrayParameters, getShapeArray("item","clock", 2, 2, 6, 4, {}})
    table.insert(shapeArrayParameters, getShapeArray("item","superDummy", 1, 2, 2, 1, {}})
