    ...
    addToTransitionArray(ta,{{"simple1_1_2"},{"slide"},{"lightBlue"},{4},{1},{1,2,2,2},{2},{1,2,4,2},{3},{1,2,6,2},{4},{1,2,7,2}})
    ...
    addToTransitionArray(ta,{{"simple2_1_2"},{"slide"},{"lightBlue"},{1},{1},{1,2,3,4},{2},{1,2,5,4}})
    ...
    addToTransitionArray(ta,{{"triangle1_1_3"},{"slide"},{"green"},{1},{1},{1,3,1,1},{2},{1,3,1,2}})
    ...
    addToTransitionArray(ta,{{"triangle2_1_3"},{"slide"},{"green"},{2},{1},{1,3,4,2},{2},{1,3,4,3},{3},{1,3,4,5}})
    ...
    addToTransitionArray(ta,{{"triangle2_1_2"},{"slide"},{"green"},{2},{1},{1,2,5,1},{2},{1,2,7,3}})
    ...
    addToTransitionArray(ta,{{"simple1_1_1"},{"slide"},{"lightBlue"},{1},{1},{1,1,4,1},{2},{1,1,5,2},{3},{1,1,5,4},{4},{1,1,5,5}})
    ...
    addToTransitionArray(ta,{{"backFire1_1_2"},{"slide"},{"lightDarkBlue"},{1},{1},{1,2,1,1},{2},{1,2,2,1}})

    addToShapeArray(sp, "simple","simple2_1_2", {1, 2, 3, 1})
    addToShapeArray(sp, "shape","triangle1_1_2", {1, 2, 1, 2}, "triangleTopLeftShape", {1})
    addToTransitionArray(ta,{{"triangle1_1_2"},{"slide"},{"green"},{1},{1},{1,2,1,2},{2},{1,2,2,2}})
    ...
    addToTransitionArray(ta,{{"simple1_4_1"},{"slide"},{"lightBlue"},{2},{1},{4,1,3,1},{2},{4,1,6,1}})

    addToShapeArray(sp, "endPoint","endPoint1_4_1", {4, 1, 7, 1})

    addToShapeArray(sp, "simple","simple2_4_1", {4, 1, 3, 3})
    addToTransitionArray(ta,{{"simple2_4_1"},{"slide"},{"lightBlue"},{1},{1},{4,1,3,3},{2},{4,1,4,3}})
