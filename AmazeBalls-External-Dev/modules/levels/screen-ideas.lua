    ...
    table.insert(shapeArrayParameters, getShapeArray("gem","purple2_1_2", {1, 2, 7, 4}, "purple"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_1_3", {1, 3, 1, 1}, "triangleTopRightShape", {1}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_1_3"},{"slide"},{"green"},{1},{1},{1,3,1,1},{2},{1,3,1,2}})
    table.insert(shapeArrayParameters, getShapeArray("gem","purple1_1_3", {1, 3, 4, 1}, "purple"))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"triangle1_1_3"},{"slide"},{"green"},{1},{1},{1,3,1,1},{2},{1,3,1,2}})
    ...
    table.insert(shapeArrayParameters, getShapeArray("gem","blueCoin", {1, 3, 2, 5}, "blueCoin"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle4_1_3", {1, 3, 5, 5}, "triangleTopRightShape", {1}))

    -- lEV 2

    --SCREEN 1-2
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_1_2", {1, 2, 1, 1}, "triangleBottomRightShape", {1}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("gem","purple2", 1, 2, 1, 3}, "purple"))
    table.insert(shapeArrayParameters, getShapeArray("gem","purple3", 1, 2, 3, 3}, "purple"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_1_2", {1, 2, 1, 5}, "triangleTopRightShape", {1}))
    table.insert(shapeArrayParameters, getShapeArray("gem","purple4", 1, 2, 2, 5}, "purple"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan3_1_2", {1, 2, 7, 5}, "left")

    -- Lev 3
    --SCREEN 1-1
    table.insert(shapeArrayParameters, getShapeArray("gem","purple1", 1, 1, 1, 1}, "purple"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("gem","purple2", 1, 1, 6, 2}, "purple"))
    ...
    table.insert(shapeArrayParameters, getShapeArray("simple","simple2_1_2", {1, 2, 3, 1}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_1_2", {1, 2, 1, 2}, "triangleTopLeftShape", {1}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_1_2", {1, 2, 2, 4}, "triangleBottomLeftShape", {1}))
    table.insert(shapeArrayParameters, getShapeArray("manualFan","manualFan1_1_2", {1, 2, 3, 4}, "up"))
    table.insert(shapeArrayParameters, getShapeArray("autoFan","autoFan1_1_2", {1, 2, 4, 4}, "left"))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle4_1_2", {1, 2, 5, 4}, "triangleTopRightShape", {1, _, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("shape","triangle5_1_2", {1, 2, 6, 4}, "triangleBottomLeftShape", {1, _, "breakable"}))
    table.insert(shapeArrayParameters, getShapeArray("door","door1_1_2", {1, 2, 3, 5}, "down"))

    -- Old Woody Level 14 Silver, screen 4-1
    table.insert(shapeArrayParameters, getShapeArray("simple","simple1_4_1", {4, 1, 6, 1}))
    ...
    table.insert(shapeArrayParameters, getShapeArray("simple","simple2_4_1", {4, 1, 3, 3}))
    table.insert(mainFunc.allLevelSettings.transitionArrayIndex,{{"simple2_4_1"},{"slide"},{"lightBlue"},{1},{1},{4,1,3,3},{2},{4,1,4,3}})

    table.insert(shapeArrayParameters, getShapeArray("shape","triangle1_4_1", {4, 1, 4, 5}, "triangleBottomRightShape", {1}))

    table.insert(shapeArrayParameters, getShapeArray("shape","triangle2_4_1", {4, 1, 4, 4}, "triangleTopLeftShape", {1}))

    table.insert(shapeArrayParameters, getShapeArray("shape","triangle3_4_1", {4, 1, 5, 4}, "triangleBottomRightShape", {1}))

    table.insert(shapeArrayParameters, getShapeArray("shape","triangle4_4_1", {4, 1, 5, 3}, "triangleTopLeftShape", {1}))

    table.insert(shapeArrayParameters, getShapeArray("shape","triangle5_4_1", {4, 1, 6, 3}, "triangleBottomRightShape", {1}))

    table.insert(shapeArrayParameters, getShapeArray("shape","triangle6_4_1", {4, 1, 6, 2}, "triangleTopLeftShape", {1}))

    table.insert(shapeArrayParameters, getShapeArray("shape","triangle7_4_1", {4, 1, 7, 2}, "triangleBottomRightShape", {1}))

    table.insert(shapeArrayParameters, getShapeArray("simple","simple3_4_1", {4, 1, 6, 5}))

    table.insert(shapeArrayParameters, getShapeArray("simple","simple3_4_1", {4, 1, 6, 4}))
